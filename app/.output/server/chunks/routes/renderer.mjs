...
import { m as buildAssetsURL, u as useRuntimeConfig, M as defineRenderHandler, L as publicAssetsURL, N as getQuery, x as createError, O as getRouteRules, P as useNitroApp, Q as getResponseStatusText, R as getResponseStatus } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Temukan pekerjaan impianmu di Karir Traspac"},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"Karir Traspac","titleTemplate":"%s - Karir Traspac","htmlAttrs":{"lang":"en"}};
