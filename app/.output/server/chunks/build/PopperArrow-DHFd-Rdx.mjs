...
import { N as N$1, T as T$1, n } from './useForwardPropsEmits-nQnKVeqj.mjs';
...
const [Ye, Xe] = T$1("PopperContent"), je = Wt.defineComponent({ inheritAttrs: false, __name: "PopperContent", props: Wt.mergeDefaults({ side: {}, sideOffset: {}, align: {}, alignOffset: {}, avoidCollisions: { type: Boolean }, collisionBoundary: {}, collisionPadding: {}, arrowPadding: {}, sticky: {}, hideWhenDetached: { type: Boolean }, positionStrategy: {}, updatePositionStrategy: {}, disableUpdateOnLayoutShift: { type: Boolean }, prioritizePosition: { type: Boolean }, reference: {}, asChild: { type: Boolean }, as: {} }, { side: "bottom", sideOffset: 0, align: "center", alignOffset: 0, arrowPadding: 0, avoidCollisions: true, collisionBoundary: () => [], collisionPadding: 0, sticky: "partial", hideWhenDetached: false, positionStrategy: "fixed", updatePositionStrategy: "optimized", prioritizePosition: false }), emits: ["placed"], setup(n2, { emit: i2 }) {
  ...
  return Xe({ placedSide: C2, onArrowChange: (e2) => d2.value = e2, arrowX: E2, arrowY: O2, shouldHideArrow: B2 }), (n3, o2) => {
    var r2, i3, l3;
...
} }), Ie = { top: "bottom", right: "left", bottom: "top", left: "right" }, Ne = Wt.defineComponent({ inheritAttrs: false, __name: "PopperArrow", props: { width: {}, height: {}, rounded: { type: Boolean }, asChild: { type: Boolean }, as: { default: "svg" } }, setup(t2) {
  const { forwardRef: n2 } = N$1(), r2 = Ye(), i2 = Wt.computed(() => Ie[r2.placedSide.value]);
  return (t3, o2) => {
    var a2, l2, s2, c2;
...
export { $e as $, He as H, Ne as N, je as j };
//# sourceMappingURL=PopperArrow-DHFd-Rdx.mjs.map
