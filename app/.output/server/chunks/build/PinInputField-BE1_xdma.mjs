import { v as Wt, s as pm, u as da, r as Bm, e as sg, t as Ky, S as mg, P as _m } from './server.mjs';
import { F, N, C, T } from './useForwardPropsEmits-nQnKVeqj.mjs';
import { n } from './VisuallyHiddenInput-BYeJtXaU.mjs';
...
const [h, b] = T("PinInputRoot"), y = Wt.defineComponent({ inheritAttrs: false, __name: "PinInputRoot", props: { modelValue: {}, defaultValue: {}, placeholder: { default: "" }, mask: { type: Boolean }, otp: { type: Boolean }, type: { default: "text" }, dir: {}, disabled: { type: Boolean }, id: {}, asChild: { type: Boolean }, as: {}, name: {}, required: { type: Boolean } }, emits: ["update:modelValue", "complete"], setup(i2, { emit: r2 }) {
  var _a;
  const a2 = i2, l2 = r2, { mask: n2, otp: o2, placeholder: d2, type: p2, disabled: f2, dir: v2 } = Wt.toRefs(a2), { forwardRef: g2 } = N(), h2 = e(v2), y2 = C(a2, "modelValue", l2, { defaultValue: (_a = a2.defaultValue) != null ? _a : [], passive: void 0 === a2.modelValue }), x2 = Wt.computed(() => Array.isArray(y2.value) ? [...y2.value] : []), k2 = Wt.ref(/* @__PURE__ */ new Set());
  const V2 = Wt.computed(() => "number" === a2.type), S2 = Wt.computed(() => x2.value.filter((e2) => !!e2 || V2.value && 0 === e2).length === k2.value.size);
  return Wt.watch(y2, () => {
    S2.value && l2("complete", y2.value);
  }, { deep: true }), b({ modelValue: y2, currentModelValue: x2, mask: n2, otp: o2, placeholder: d2, type: p2, dir: h2, disabled: f2, isCompleted: S2, inputElements: k2, onInputElementChange: function(e2) {
    k2.value.add(e2);
  }, isNumericMode: V2 }), (i3, r3) => (Wt.openBlock(), Wt.createBlock(Wt.unref(_m), Wt.mergeProps(i3.$attrs, { ref: Wt.unref(g2), dir: Wt.unref(h2), "data-complete": S2.value ? "" : void 0, "data-disabled": Wt.unref(f2) ? "" : void 0 }), { default: Wt.withCtx(() => {
    var _a2;
    return [Wt.renderSlot(i3.$slots, "default", { modelValue: Wt.unref(y2) }), Wt.createVNode(n, { id: i3.id, as: "input", feature: "focusable", tabindex: "-1", value: x2.value.join(""), name: (_a2 = i3.name) != null ? _a2 : "", disabled: Wt.unref(f2), required: i3.required, onFocus: r3[0] || (r3[0] = (e2) => {
      var t2, i4;
  ...
  const r2 = i2, a2 = h(), l2 = Wt.computed(() => Array.from(a2.inputElements.value)), n2 = Wt.computed(() => a2.currentModelValue.value[r2.index]), o2 = Wt.computed(() => r2.disabled || a2.disabled.value), s2 = Wt.computed(() => a2.otp.value), u2 = Wt.computed(() => a2.mask.value), { primitiveElement: d2, currentElement: p2 } = t();
  function c2() {
    const t2 = p2.value;
    Wt.nextTick(() => {
  ...
  function b2(e2) {
    e2.preventDefault();
    if (e2.target.value) _2(r2.index, "");
    else {
      const e3 = l2.value[r2.index - 1];
      e3 && (e3.focus(), _2(r2.index - 1, ""));
    }
  }
  function y2(e2) {
    "Delete" === e2.key && (e2.preventDefault(), _2(r2.index, ""));
  }
  function x2(e2) {
    const t2 = e2.target;
  ...
  return Wt.watch(n2, () => {
    ...
    var t2;
    const i4 = e3.target;
    if (((_a = null == (t2 = e3.data) ? void 0 : t2.length) != null ? _a : 0) > 1) return void S2(i4.value);
    if (a2.isNumericMode.value && !/^\d*$/.test(i4.value)) return void (i4.value = i4.value.replace(/\D/g, ""));
    i4.value = i4.value.slice(-1), _2(r2.index, i4.value);
  ...
  const d2 = t2, c2 = u2, m2 = da(), f2 = F(Bm(d2, "defaultValue", "disabled", "id", "mask", "modelValue", "name", "otp", "required", "type"), c2), { emitFormInput: v2, emitFormFocus: g2, emitFormChange: h2, emitFormBlur: b2, size: V2, color: S2, id: _2, name: B2, highlight: R, disabled: q, ariaAttrs: w } = sg(d2), I = Wt.computed(() => {
    var e2;
    return Ky({ extend: Ky(k), ...(null == (e2 = m2.ui) ? void 0 : e2.pinInput) || {} })({ color: S2.value, variant: d2.variant, size: V2.value, highlight: R.value });
  }), j = Wt.ref([]), C = Wt.ref(false);
  function E(e2) {
    const t3 = new Event("change", { target: { value: e2 } });
    c2("change", t3), h2();
  }
  function D(e2) {
    e2.relatedTarget && !C.value || (c2("blur", e2), b2());
  }
  return s2({ inputsRef: j }), (i2, r2, a2, l2) => {
    var s3;
    r2(pm.ssrRenderComponent(Wt.unref(y), Wt.mergeProps({ ...Wt.unref(f2), ...Wt.unref(w) }, { id: Wt.unref(_2), name: Wt.unref(B2), placeholder: t2.placeholder, class: I.value.root({ class: [null == (s3 = d2.ui) ? void 0 : s3.root, d2.class] }), "onUpdate:modelValue": (t3) => Wt.unref(v2)(), onComplete: E }, l2), { default: Wt.withCtx((t3, i3, r3, a3) => {
      if (!i3) return [(Wt.openBlock(true), Wt.createBlock(Wt.Fragment, null, Wt.renderList(Wt.unref(mg)(d2.length), (t4, i4) => {
        var r4;
        return Wt.openBlock(), Wt.createBlock(Wt.unref(x), { key: t4, ref_for: true, ref: (e2) => j.value[i4] = e2, index: i4, class: I.value.base({ class: null == (r4 = d2.ui) ? void 0 : r4.base }), disabled: Wt.unref(q), onBlur: D, onFocus: Wt.unref(g2) }, null, 8, ["index", "class", "disabled", "onFocus"]);
      }), 128))];
      i3("<!--[-->"), pm.ssrRenderList(Wt.unref(mg)(d2.length), (t4, l3) => {
        var o2;
        i3(pm.ssrRenderComponent(Wt.unref(x), { key: t4, ref_for: true, ref: (e2) => j.value[l3] = e2, index: l3, class: I.value.base({ class: null == (o2 = d2.ui) ? void 0 : o2.base }), disabled: Wt.unref(q), onBlur: D, onFocus: Wt.unref(g2) }, null, r3, a3));
      }), i3("<!--]-->");
    }), _: 1 }, a2));
  };
} }, S = V.setup;
...
_.setup = (t2, i2) => {
  const r2 = Wt.useSSRContext();
  return (r2.modules || (r2.modules = /* @__PURE__ */ new Set())).add("components/ui/PinInputField.vue"), B ? B(t2, i2) : void 0;
};

export { _ as default };
//# sourceMappingURL=PinInputField-BE1_xdma.mjs.map
