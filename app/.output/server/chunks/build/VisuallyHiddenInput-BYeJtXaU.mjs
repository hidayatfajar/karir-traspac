...
const l = Wt.defineComponent({ inheritAttrs: false, __name: "VisuallyHiddenInputBubble", props: { name: {}, value: {}, checked: { type: Boolean, default: void 0 }, required: { type: Boolean }, disabled: { type: Boolean }, feature: { default: "fully-hidden" } }, setup(l2) {
  const n2 = l2, { primitiveElement: r, currentElement: u } = t(), o = Wt.computed(() => {
    var _a;
    return (_a = n2.checked) != null ? _a : n2.value;
  });
  return Wt.watch(o, (e2, a2) => {
    if (!u.value) return;
    const t2 = u.value, l3 = (void 0).HTMLInputElement.prototype, n3 = Object.getOwnPropertyDescriptor(l3, "value").set;
    if (n3 && e2 !== a2) {
  ...
  return (a3, u) => n2.value ? (Wt.openBlock(), Wt.createBlock(l, Wt.mergeProps({ key: a3.name }, { ...t2, ...a3.$attrs }, { name: a3.name, value: a3.value }), null, 16, ["name", "value"])) : (Wt.openBlock(true), Wt.createElementBlock(Wt.Fragment, { key: 1 }, Wt.renderList(r.value, (n3) => (Wt.openBlock(), Wt.createBlock(l, Wt.mergeProps({ key: n3.name, ref_for: true }, { ...t2, ...a3.$attrs }, { name: n3.name, value: n3.value }), null, 16, ["name", "value"]))), 128));
} });

export { n };
//# sourceMappingURL=VisuallyHiddenInput-BYeJtXaU.mjs.map
