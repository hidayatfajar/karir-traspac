import { v as Wt, u as da, r as Bm, t as Ky, s as pm, _ as Ob } from './server.mjs';
import { l } from './useLocale-DRieL7bI.mjs';
import { i } from './usePortal-B0EwXMSu.mjs';
import { F } from './useForwardPropsEmits-nQnKVeqj.mjs';
import { B as B$1, b, P, w, h, D, k, C as C$1 } from './DialogPortal-DWaqTrjw.mjs';
...
const x = { slots: { overlay: "fixed inset-0 bg-elevated/75", content: "fixed bg-default divide-y divide-default flex flex-col focus:outline-none", header: "flex items-center gap-1.5 p-4 sm:px-6 min-h-16", wrapper: "", body: "flex-1 overflow-y-auto p-4 sm:p-6", footer: "flex items-center gap-1.5 p-4 sm:px-6", title: "text-highlighted font-semibold", description: "mt-1 text-muted text-sm", close: "absolute top-4 end-4" }, variants: { transition: { true: { overlay: "data-[state=open]:animate-[fade-in_200ms_ease-out] data-[state=closed]:animate-[fade-out_200ms_ease-in]", content: "data-[state=open]:animate-[scale-in_200ms_ease-out] data-[state=closed]:animate-[scale-out_200ms_ease-in]" } }, fullscreen: { true: { content: "inset-0" }, false: { content: "top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[calc(100vw-2rem)] max-w-lg max-h-[calc(100dvh-2rem)] sm:max-h-[calc(100dvh-4rem)] rounded-lg shadow-lg ring ring-default overflow-hidden" } } } }, C = { __name: "Modal", __ssrInlineRender: true, props: { title: { type: String, required: false }, description: { type: String, required: false }, content: { type: Object, required: false }, overlay: { type: Boolean, required: false, default: true }, transition: { type: Boolean, required: false, default: true }, fullscreen: { type: Boolean, required: false }, portal: { type: [Boolean, String], required: false, skipCheck: true, default: true }, close: { type: [Boolean, Object], required: false, default: true }, closeIcon: { type: String, required: false }, dismissible: { type: Boolean, required: false, default: true }, class: { type: null, required: false }, ui: { type: null, required: false }, open: { type: Boolean, required: false }, defaultOpen: { type: Boolean, required: false }, modal: { type: Boolean, required: false, default: true } }, emits: ["after:leave", "after:enter", "close:prevent", "update:open"], setup(C2, { emit: B2 }) {
  const S = C2, h$1 = B2, $ = Wt.useSlots(), { t: V } = l(), N = da(), w$1 = F(Bm(S, "open", "defaultOpen", "modal"), h$1), _ = i(Wt.toRef(() => S.portal)), g = Wt.toRef(() => S.content), b$1 = Wt.computed(() => {
    ...
    var e2;
    return Ky({ extend: Ky(x), ...(null == (e2 = N.ui) ? void 0 : e2.modal) || {} })({ transition: S.transition, fullscreen: S.fullscreen });
  });
  return (t2, o2, l2, n2) => {
    o2(pm.ssrRenderComponent(Wt.unref(B$1), Wt.mergeProps(Wt.unref(w$1), n2), { default: Wt.withCtx(({ open: o3, close: l3 }, n3, a2, c2) => {
      ...
      $.default ? n3(pm.ssrRenderComponent(Wt.unref(b), { "as-child": "", class: S.class }, { default: Wt.withCtx((l4, r2, n4, a3) => {
        if (!r2) return [Wt.renderSlot(t2.$slots, "default", { open: o3 })];
        pm.ssrRenderSlot(t2.$slots, "default", { open: o3 }, null, r2, n4, a3);
      }), _: 2 }, a2, c2)) : n3("<!---->"), n3(pm.ssrRenderComponent(Wt.unref(P), Wt.unref(_), { default: Wt.withCtx((o4, n4, a3, c3) => {
        var i2, d2, u2, x2;
        ...
        C2.overlay ? n4(pm.ssrRenderComponent(Wt.unref(w), { class: R.value.overlay({ class: null == (i2 = S.ui) ? void 0 : i2.overlay }) }, null, a3, c3)) : n4("<!---->"), n4(pm.ssrRenderComponent(Wt.unref(h), Wt.mergeProps({ class: R.value.content({ class: [!$.default && S.class, null == (d2 = S.ui) ? void 0 : d2.content] }) }, g.value, { onAfterEnter: (e2) => h$1("after:enter"), onAfterLeave: (e2) => h$1("after:leave") }, Wt.toHandlers(b$1.value)), { default: Wt.withCtx((o5, n5, a4, c4) => {
          ...
          $.content && (C2.title || $.title || C2.description || $.description) ? n5(pm.ssrRenderComponent(Wt.unref(d), null, { default: Wt.withCtx((o6, l4, r2, n6) => {
            if (!l4) return [C2.title || $.title ? (Wt.openBlock(), Wt.createBlock(Wt.unref(D), { key: 0 }, { default: Wt.withCtx(() => [Wt.renderSlot(t2.$slots, "title", {}, () => [Wt.createTextVNode(Wt.toDisplayString(C2.title), 1)])]), _: 3 })) : Wt.createCommentVNode("", true), C2.description || $.description ? (Wt.openBlock(), Wt.createBlock(Wt.unref(k), { key: 1 }, { default: Wt.withCtx(() => [Wt.renderSlot(t2.$slots, "description", {}, () => [Wt.createTextVNode(Wt.toDisplayString(C2.description), 1)])]), _: 3 })) : Wt.createCommentVNode("", true)];
            C2.title || $.title ? l4(pm.ssrRenderComponent(Wt.unref(D), null, { default: Wt.withCtx((o7, l5, r3, n7) => {
              ...
              pm.ssrRenderSlot(t2.$slots, "title", {}, () => {
                l5(`${pm.ssrInterpolate(C2.title)}`);
              }, l5, r3, n7);
            }), _: 2 }, r2, n6)) : l4("<!---->"), C2.description || $.description ? l4(pm.ssrRenderComponent(Wt.unref(k), null, { default: Wt.withCtx((o7, l5, r3, n7) => {
              ...
              pm.ssrRenderSlot(t2.$slots, "description", {}, () => {
                l5(`${pm.ssrInterpolate(C2.description)}`);
              }, l5, r3, n7);
            }), _: 2 }, r2, n6)) : l4("<!---->");
          }), _: 2 }, a4, c4)) : n5("<!---->"), pm.ssrRenderSlot(t2.$slots, "content", { close: l3 }, () => {
            var o6, i3, d3;
            $.header || C2.title || $.title || C2.description || $.description || S.close || $.close ? (n5(`<div class="${pm.ssrRenderClass(R.value.header({ class: null == (o6 = S.ui) ? void 0 : o6.header }))}"${c4}>`), pm.ssrRenderSlot(t2.$slots, "header", { close: l3 }, () => {
              var o7, i4, d4;
              n5(`<div class="${pm.ssrRenderClass(R.value.wrapper({ class: null == (o7 = S.ui) ? void 0 : o7.wrapper }))}"${c4}>`), C2.title || $.title ? n5(pm.ssrRenderComponent(Wt.unref(D), { class: R.value.title({ class: null == (i4 = S.ui) ? void 0 : i4.title }) }, { default: Wt.withCtx((o8, l4, r2, n6) => {
                if (!l4) return [Wt.renderSlot(t2.$slots, "title", {}, () => [Wt.createTextVNode(Wt.toDisplayString(C2.title), 1)])];
                pm.ssrRenderSlot(t2.$slots, "title", {}, () => {
                  l4(`${pm.ssrInterpolate(C2.title)}`);
                }, l4, r2, n6);
              }), _: 2 }, a4, c4)) : n5("<!---->"), C2.description || $.description ? n5(pm.ssrRenderComponent(Wt.unref(k), { class: R.value.description({ class: null == (d4 = S.ui) ? void 0 : d4.description }) }, { default: Wt.withCtx((o8, l4, r2, n6) => {
                if (!l4) return [Wt.renderSlot(t2.$slots, "description", {}, () => [Wt.createTextVNode(Wt.toDisplayString(C2.description), 1)])];
                pm.ssrRenderSlot(t2.$slots, "description", {}, () => {
                  l4(`${pm.ssrInterpolate(C2.description)}`);
                }, l4, r2, n6);
              }), _: 2 }, a4, c4)) : n5("<!---->"), n5("</div>"), pm.ssrRenderSlot(t2.$slots, "actions", {}, null, n5, a4, c4), S.close || $.close ? n5(pm.ssrRenderComponent(Wt.unref(C$1), { "as-child": "" }, { default: Wt.withCtx((o8, n6, a5, c5) => {
                ...
                pm.ssrRenderSlot(t2.$slots, "close", { close: l3, ui: R.value }, () => {
                  var t3;
                  S.close ? n6(pm.ssrRenderComponent(Ob, Wt.mergeProps({ icon: C2.closeIcon || Wt.unref(N).ui.icons.close, color: "neutral", variant: "ghost", "aria-label": Wt.unref(V)("modal.close") }, "object" == typeof S.close ? S.close : {}, { class: R.value.close({ class: null == (t3 = S.ui) ? void 0 : t3.close }) }), null, a5, c5)) : n6("<!---->");
                }, n6, a5, c5);
              }), _: 2 }, a4, c4)) : n5("<!---->");
            }, n5, a4, c4), n5("</div>")) : n5("<!---->"), $.body ? (n5(`<div class="${pm.ssrRenderClass(R.value.body({ class: null == (i3 = S.ui) ? void 0 : i3.body }))}"${c4}>`), pm.ssrRenderSlot(t2.$slots, "body", { close: l3 }, null, n5, a4, c4), n5("</div>")) : n5("<!---->"), $.footer ? (n5(`<div class="${pm.ssrRenderClass(R.value.footer({ class: null == (d3 = S.ui) ? void 0 : d3.footer }))}"${c4}>`), pm.ssrRenderSlot(t2.$slots, "footer", { close: l3 }, null, n5, a4, c4), n5("</div>")) : n5("<!---->");
          }, n5, a4, c4);
        }), _: 2 }, a3, c3));
      }), _: 2 }, a2, c2));
    }), _: 3 }, l2));
...
export { C };
//# sourceMappingURL=Modal-bUaxdKZe.mjs.map
