import { v as Wt, u as da, r as Bm, e as sg, m as Am, q as Pm, t as Ky, i as yg, j as fg, E as gg, s as pm, c as yb, d as Tb, F as wb, P as _m, a as Tm } from './server.mjs';
import { k as defu, j as isEqual } from '../_/nitro.mjs';
import { v } from './index-CVudU8ow.mjs';
import { l } from './useLocale-BTFVrGyI.mjs';
import { O, c as c$1, h, f, b } from './usePortal-DtLtCtVs.mjs';
import { c } from './Input-DfRex13n.mjs';
import { F, T, C, r, N, m } from './useForwardPropsEmits-WwvTsoLV.mjs';
import { $ as $e, H as He, q as qe, I as Ie$1 } from './PopperArrow-DcWSYcLt.mjs';
import { o, n } from './usePrimitiveElement-DSug4YUi.mjs';
import { l as l$1 } from './Collection-BWpNbfJs.mjs';
import { e as e$2 } from './utils-B3GHb33t.mjs';
import { r as r$1 } from './useTypeahead-B73O3JTr.mjs';
...
import { E, N as N$1, T as T$1 } from './useBodyScrollLock-Fz4_gHfe.mjs';

const W = Wt.defineComponent({ __name: "ComboboxAnchor", props: { reference: {}, asChild: { type: Boolean }, as: {} }, setup(a2) {
  const { forwardRef: t2 } = N();
  return (a3, i2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(He), { "as-child": "", reference: a3.reference }, { default: Wt.withCtx(() => [Wt.createVNode(Wt.unref(_m), Wt.mergeProps({ ref: Wt.unref(t2), "as-child": a3.asChild, as: a3.as }, a3.$attrs), { default: Wt.withCtx(() => [Wt.renderSlot(a3.$slots, "default")]), _: 3 }, 16, ["as-child", "as"])]), _: 3 }, 8, ["reference"]));
} });
function Q(l2) {
...
const [X, Y] = T("ListboxRoot"), Z = Wt.defineComponent({ __name: "ListboxRoot", props: { modelValue: {}, defaultValue: {}, multiple: { type: Boolean }, orientation: { default: "vertical" }, dir: {}, disabled: { type: Boolean }, selectionBehavior: { default: "toggle" }, highlightOnHover: { type: Boolean }, by: {}, asChild: { type: Boolean }, as: {}, name: {}, required: { type: Boolean } }, emits: ["update:modelValue", "highlight", "entryFocus", "leave"], setup(a2, { expose: t2, emit: i2 }) {
  var _a;
  ...
  const S2 = Wt.ref(null), w2 = Wt.ref(null), V2 = Wt.ref(false), z2 = Wt.ref(false), _2 = r(), N2 = r(), T2 = r();
  function $2() {
  ...
  function H2(e2) {
    const l2 = S2.value;
    (null == l2 ? void 0 : l2.isConnected) && (w2.value = l2), S2.value = null, o2("leave", e2);
  }
  function U2(e2) {
    ...
    if (S2.value) {
      ...
      !function(e3, l3) {
        var a4;
        if (V2.value || "replace" !== n2.selectionBehavior || !r2.value || !Array.isArray(C2.value)) return;
    ...
    return V2.value ? N2.trigger(e2) : void 0;
  }
  async function G2(l2) {
    if (await Wt.nextTick(), V2.value) _2.trigger(l2);
    else {
  ...
  return Wt.watch(C2, () => {
    ...
    if (V2.value) T2.trigger(e2);
    else {
      const l2 = p2().find((l3) => J(l3.value, e2, n2.by));
      l2 && (S2.value = l2.ref, A2(l2.ref));
    }
  }, highlightFirstItem: j2, highlightSelected: G2, getItems: p2 }), Y({ modelValue: C2, onValueChange: function(e2) {
    if (x2.value = true, n2.multiple) {
      const l2 = Array.isArray(C2.value) ? [...C2.value] : [], a3 = l2.findIndex((l3) => J(l3, e2, n2.by));
      "toggle" === n2.selectionBehavior ? (-1 === a3 ? l2.push(e2) : l2.splice(a3, 1), C2.value = l2) : (C2.value = [e2], k2.value = e2);
    } else "toggle" === n2.selectionBehavior && J(C2.value, e2, n2.by) ? C2.value = void 0 : C2.value = e2;
    setTimeout(() => {
      x2.value = false;
    }, 1);
  }, multiple: r2, orientation: u2, dir: y2, disabled: d2, highlightOnHover: s2, highlightedElement: S2, isVirtual: V2, virtualFocusHook: _2, virtualKeydownHook: N2, virtualHighlightHook: T2, by: n2.by, firstValue: k2, selectionBehavior: c2, focusable: B2, onLeave: H2, onEnter: function(e2) {
    var l2, a3;
    const t3 = new CustomEvent("listbox.entryFocus", { bubbles: false, cancelable: true });
    if (null == (l2 = e2.currentTarget) || l2.dispatchEvent(t3), o2("entryFocus", t3), !t3.defaultPrevented) if (w2.value) A2(w2.value);
    else {
    ...
    if (B2.value) {
      if (x2.value = true, V2.value) N2.trigger(e2);
      else {
  ...
  }, highlightFirstItem: j2 }), (a3, t3) => (Wt.openBlock(), Wt.createBlock(Wt.unref(_m), { ref_key: "primitiveElement", ref: f2, as: a3.as, "as-child": a3.asChild, dir: Wt.unref(y2), "data-disabled": Wt.unref(d2) ? "" : void 0, onPointerleave: H2, onFocusout: t3[0] || (t3[0] = async (l2) => {
  ...
  }), w2 = Wt.ref(/* @__PURE__ */ new Map()), V2 = Wt.ref(/* @__PURE__ */ new Map()), { contains: z2 } = Q({ sensitivity: "base" }), _2 = Wt.reactive({ search: "", filtered: { count: 0, items: /* @__PURE__ */ new Map(), groups: /* @__PURE__ */ new Set() } });
  function N2() {
    if (!_2.search || r2.ignoreFilter || x2.value) return void (_2.filtered.count = w2.value.size);
    _2.filtered.groups = /* @__PURE__ */ new Set();
    let e2 = 0;
    for (const [l3, a3] of w2.value) {
      const t3 = z2(a3, _2.search);
      _2.filtered.items.set(l3, t3 ? 1 : 0), t3 && e2++;
    }
    for (const [l3, a3] of V2.value) for (const e3 of a3) if (_2.filtered.items.get(e3) > 0) {
      _2.filtered.groups.add(l3);
      break;
    }
    _2.filtered.count = e2;
  }
  return Wt.watch([() => _2.search, () => w2.value.size], () => {
    N2();
  ...
  const d2 = Wt.computed(() => "popper" === n2.position ? n2 : {}), c2 = Tm(d2.value), v2 = { boxSizing: "border-box", "--reka-combobox-content-transform-origin": "var(--reka-popper-transform-origin)", "--reka-combobox-content-available-width": "var(--reka-popper-available-width)", "--reka-combobox-content-available-height": "var(--reka-popper-available-height)", "--reka-combobox-trigger-width": "var(--reka-popper-anchor-width)", "--reka-combobox-trigger-height": "var(--reka-popper-anchor-height)" };
  return ne({ position: r2 }), Wt.ref(false), (a2, t3) => (Wt.openBlock(), Wt.createBlock(Wt.unref(te), { "as-child": "" }, { default: Wt.withCtx(() => [Wt.createVNode(Wt.unref(b), { "as-child": "", "disable-outside-pointer-events": a2.disableOutsidePointerEvents, onDismiss: t3[0] || (t3[0] = (l2) => Wt.unref(s2).onOpenChange(false)), onFocusOutside: t3[1] || (t3[1] = (l2) => {
    var a3;
  ...
  }) }, { default: Wt.withCtx(() => [(Wt.openBlock(), Wt.createBlock(Wt.resolveDynamicComponent("popper" === Wt.unref(r2) ? Wt.unref(Ie$1) : Wt.unref(_m)), Wt.mergeProps({ ...a2.$attrs, ...Wt.unref(c2) }, { id: Wt.unref(s2).contentId, ref: Wt.unref(u2), "data-state": Wt.unref(s2).open.value ? "open" : "closed", style: { display: "flex", flexDirection: "column", outline: "none", ..."popper" === Wt.unref(r2) ? v2 : {} } }), { default: Wt.withCtx(() => [Wt.renderSlot(a2.$slots, "default")]), _: 3 }, 16, ["id", "data-state", "style"]))]), _: 3 }, 8, ["disable-outside-pointer-events"])]), _: 3 }));
  ...
  return (a3, i3) => n2.value ? (Wt.openBlock(), Wt.createBlock(Wt.unref(_m), Wt.normalizeProps(Wt.mergeProps({ key: 0 }, t2)), { default: Wt.withCtx(() => [Wt.renderSlot(a3.$slots, "default", {}, () => [i3[0] || (i3[0] = Wt.createTextVNode("No options"))])]), _: 3 }, 16)) : Wt.createCommentVNode("", true);
  ...
  return ce({ id: i2 }), (a3, n2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(_m), Wt.mergeProps({ role: "group" }, t2, { "aria-labelledby": Wt.unref(i2) }), { default: Wt.withCtx(() => [Wt.renderSlot(a3.$slots, "default")]), _: 3 }, 16, ["aria-labelledby"]));
  ...
  const t2 = l2, i2 = a2, n2 = ee(), o2 = X(), { primitiveElement: r2 } = o(), s2 = C(t2, "modelValue", i2, { passive: void 0 === t2.modelValue });
  function u2(e2) {
  ...
  const i2 = a2, n2 = t2, o2 = c$1(void 0, "reka-listbox-item"), { CollectionItem: r2 } = l$1(), { forwardRef: s2, currentElement: u2 } = N(), d2 = X(), c2 = Wt.computed(() => u2.value === d2.highlightedElement.value), v2 = Wt.computed(() => {
    return e2 = d2.modelValue.value, l2 = i2.value, a3 = d2.by, void 0 !== e2 && (Array.isArray(e2) ? e2.some((e3) => J(e3, l2, a3)) : J(e2, l2, a3));
    var e2, l2, a3;
  ...
  N();
  const i2 = ye();
  return (a3, n2) => Wt.unref(i2).isSelected.value ? (Wt.openBlock(), Wt.createBlock(Wt.unref(_m), Wt.mergeProps({ key: 0, "aria-hidden": "true" }, t2), { default: Wt.withCtx(() => [Wt.renderSlot(a3.$slots, "default")]), _: 3 }, 16)) : Wt.createCommentVNode("", true);
  ...
  return i2.labelId || (i2.labelId = c$1(void 0, "reka-combobox-group-label")), (a3, n2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(_m), Wt.mergeProps(t2, { id: Wt.unref(i2).labelId }), { default: Wt.withCtx(() => [Wt.renderSlot(a3.$slots, "default")]), _: 3 }, 16, ["id"]));
} }), we = Wt.defineComponent({ __name: "ComboboxPortal", props: { to: {}, disabled: { type: Boolean }, defer: { type: Boolean }, forceMount: { type: Boolean } }, setup(l2) {
  const a2 = l2;
  return (l3, t2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(h), Wt.normalizeProps(Wt.guardReactiveProps(a2)), { default: Wt.withCtx(() => [Wt.renderSlot(l3.$slots, "default")]), _: 3 }, 16));
} }), Ve = Wt.defineComponent({ __name: "ComboboxSeparator", props: { asChild: { type: Boolean }, as: {} }, setup(a2) {
  const t2 = a2;
  return N(), (a3, i2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(_m), Wt.mergeProps(t2, { "aria-hidden": "true" }), { default: Wt.withCtx(() => [Wt.renderSlot(a3.$slots, "default")]), _: 3 }, 16));
  ...
  return (a3, r2) => {
    var _a;
    return Wt.openBlock(), Wt.createBlock(Wt.unref(_m), Wt.mergeProps(t2, { ref: Wt.unref(i2), type: "button" === a3.as ? "button" : void 0, tabindex: "-1", "aria-label": "Show popup", "aria-haspopup": "listbox", "aria-expanded": Wt.unref(n2).open.value, "aria-controls": Wt.unref(n2).contentId, "data-state": Wt.unref(n2).open.value ? "open" : "closed", disabled: o2.value, "data-disabled": o2.value ? "" : void 0, "aria-disabled": (_a = o2.value) != null ? _a : void 0, onClick: r2[0] || (r2[0] = (l2) => Wt.unref(n2).onOpenChange(!Wt.unref(n2).open.value)) }), { default: Wt.withCtx(() => [Wt.renderSlot(a3.$slots, "default")]), _: 3 }, 16, ["type", "aria-expanded", "aria-controls", "data-state", "disabled", "data-disabled", "aria-disabled"]);
  };
  ...
  const k2 = l2, x2 = b2, B2 = Wt.useSlots(), w2 = Wt.useModel(l2, "searchTerm", { type: String, default: "" }), { t: V2 } = l(), L2 = da(), { contains: I2 } = Q({ sensitivity: "base" }), z2 = F(Bm(k2, "modelValue", "defaultValue", "open", "defaultOpen", "required", "multiple", "resetSearchTermOnBlur", "resetSearchTermOnSelect", "highlightOnHover"), x2), N2 = O(Wt.toRef(() => k2.portal)), T2 = Wt.toRef(() => defu(k2.content, { side: "bottom", sideOffset: 8, collisionPadding: 8, position: "popper" })), $2 = Wt.toRef(() => k2.arrow), A2 = Wt.toRef(() => defu(k2.searchInput, { placeholder: V2("selectMenu.search"), variant: "none" })), { emitFormBlur: R2, emitFormFocus: P2, emitFormInput: K2, emitFormChange: F2, size: E2, color: O2, id: D2, name: q2, highlight: M2, disabled: j2, ariaAttrs: H2 } = sg(k2), { orientation: U2, size: J2 } = Am(k2), { isLeading: X2, isTrailing: Y2, leadingIconName: Z2, trailingIconName: ee2 } = Pm(Wt.toRef(() => defu(k2, { trailingIcon: L2.ui.icons.chevronDown }))), le2 = Wt.computed(() => J2.value || E2.value), [te2, ie2] = v(), ne2 = Wt.computed(() => {
    var e2;
    return Ky({ extend: Ky(Ie), ...(null == (e2 = L2.ui) ? void 0 : e2.selectMenu) || {} })({ color: O2.value, variant: k2.variant, size: null == le2 ? void 0 : le2.value, loading: k2.loading, highlight: M2.value, leading: X2.value || !!k2.avatar || !!B2.leading, trailing: Y2.value || !!B2.trailing, buttonGroup: U2.value });
  });
  function oe2(e2) {
    ...
    if (!k2.valueKey) return e2 && ("object" == typeof e2 ? fg(e2, k2.labelKey) : e2);
    const l3 = ce2.value.find((l4) => gg("object" == typeof l4 ? fg(l4, k2.valueKey) : l4, e2));
    return l3 && ("object" == typeof l3 ? fg(l3, k2.labelKey) : l3);
  }
  const de2 = Wt.computed(() => {
    var e2;
    return (null == (e2 = k2.items) ? void 0 : e2.length) ? yg(k2.items) ? k2.items : [k2.items] : [];
  }), ce2 = Wt.computed(() => de2.value.flatMap((e2) => e2)), ve2 = Wt.computed(() => {
    if (k2.ignoreFilter || !w2.value) return de2.value;
    const e2 = Array.isArray(k2.filterFields) ? k2.filterFields : [k2.labelKey];
    return de2.value.map((l3) => l3.filter((l4) => "object" != typeof l4 || null === l4 ? I2(String(l4), w2.value) : !(!l4.type || !["label", "separator"].includes(l4.type)) || e2.some((e3) => I2(fg(l4, e3), w2.value)))).filter((e3) => e3.filter((e4) => !ze2(e4) || !e4.type || !["label", "separator"].includes(e4.type)).length > 0);
  }), pe2 = Wt.computed(() => ve2.value.flatMap((e2) => e2)), me2 = Wt.computed(() => {
    if (!k2.createItem || !w2.value) return false;
    const e2 = k2.valueKey ? { [k2.valueKey]: w2.value } : w2.value;
    return "object" == typeof k2.createItem && "always" === k2.createItem.when || "always" === k2.createItem ? !pe2.value.find((l3) => gg(l3, e2, k2.valueKey)) : !pe2.value.length;
  ...
  function be2(l3) {
    ...
    x2("change", a3), F2(), K2(), k2.resetSearchTermOnSelect && (w2.value = "");
  }
  function ke2(e2) {
    let l3;
    if (e2) {
  ...
  return a2({ triggerRef: ye2 }), (a3, t2, i2, n2) => {
    t2("<!--[-->"), t2(pm.ssrRenderComponent(Wt.unref(te2), null, { default: Wt.withCtx((l3, t3, i3, n3) => {
      var o2, r2;
      if (!t3) return [Wt.createVNode(Wt.unref(fe), { class: ne2.value.group({ class: null == (r2 = k2.ui) ? void 0 : r2.group }) }, { default: Wt.withCtx(() => {
        var l4;
        return [Wt.createVNode(Wt.unref(xe), { class: ne2.value.item({ class: null == (l4 = k2.ui) ? void 0 : l4.item }), value: w2.value, onSelect: Wt.withModifiers((e2) => x2("create", w2.value), ["prevent"]) }, { default: Wt.withCtx(() => {
          var l5;
          return [Wt.createVNode("span", { class: ne2.value.itemLabel({ class: null == (l5 = k2.ui) ? void 0 : l5.itemLabel }) }, [Wt.renderSlot(a3.$slots, "create-item-label", { item: w2.value }, () => [Wt.createTextVNode(Wt.toDisplayString(Wt.unref(V2)("selectMenu.create", { label: w2.value })), 1)])], 2)];
        }), _: 3 }, 8, ["class", "value", "onSelect"])];
      }), _: 3 }, 8, ["class"])];
      t3(pm.ssrRenderComponent(Wt.unref(fe), { class: ne2.value.group({ class: null == (o2 = k2.ui) ? void 0 : o2.group }) }, { default: Wt.withCtx((l4, t4, i4, n4) => {
        var o3, r3;
        if (!t4) return [Wt.createVNode(Wt.unref(xe), { class: ne2.value.item({ class: null == (r3 = k2.ui) ? void 0 : r3.item }), value: w2.value, onSelect: Wt.withModifiers((e2) => x2("create", w2.value), ["prevent"]) }, { default: Wt.withCtx(() => {
          var l5;
          return [Wt.createVNode("span", { class: ne2.value.itemLabel({ class: null == (l5 = k2.ui) ? void 0 : l5.itemLabel }) }, [Wt.renderSlot(a3.$slots, "create-item-label", { item: w2.value }, () => [Wt.createTextVNode(Wt.toDisplayString(Wt.unref(V2)("selectMenu.create", { label: w2.value })), 1)])], 2)];
        }), _: 3 }, 8, ["class", "value", "onSelect"])];
        t4(pm.ssrRenderComponent(Wt.unref(xe), { class: ne2.value.item({ class: null == (o3 = k2.ui) ? void 0 : o3.item }), value: w2.value, onSelect: (e2) => x2("create", w2.value) }, { default: Wt.withCtx((l5, t5, i5, n5) => {
          var o4, r4;
          if (!t5) return [Wt.createVNode("span", { class: ne2.value.itemLabel({ class: null == (r4 = k2.ui) ? void 0 : r4.itemLabel }) }, [Wt.renderSlot(a3.$slots, "create-item-label", { item: w2.value }, () => [Wt.createTextVNode(Wt.toDisplayString(Wt.unref(V2)("selectMenu.create", { label: w2.value })), 1)])], 2)];
          t5(`<span class="${pm.ssrRenderClass(ne2.value.itemLabel({ class: null == (o4 = k2.ui) ? void 0 : o4.itemLabel }))}"${n5}>`), pm.ssrRenderSlot(a3.$slots, "create-item-label", { item: w2.value }, () => {
            t5(`${pm.ssrInterpolate(Wt.unref(V2)("selectMenu.create", { label: w2.value }))}`);
          }, t5, i5, n5), t5("</span>");
        }), _: 3 }, i4, n4));
      }), _: 3 }, i3, n3));
    }), _: 3 }, i2)), t2(pm.ssrRenderComponent(Wt.unref(ae), Wt.mergeProps({ id: Wt.unref(D2) }, { ...Wt.unref(z2), ...a3.$attrs, ...Wt.unref(H2) }, { "ignore-filter": "", "as-child": "", name: Wt.unref(q2), disabled: Wt.unref(j2), "onUpdate:modelValue": be2, "onUpdate:open": ke2 }), { default: Wt.withCtx(({ modelValue: t3, open: i3 }, n3, o2, r2) => {
      if (!n3) return [Wt.createVNode(Wt.unref(W), { "as-child": "" }, { default: Wt.withCtx(() => {
        ...
        return [Wt.createVNode(Wt.unref(Le), { ref_key: "triggerRef", ref: ye2, class: ne2.value.base({ class: [null == (n4 = k2.ui) ? void 0 : n4.base, k2.class] }), tabindex: "0" }, { default: Wt.withCtx(() => {
          var n5, o3;
          return [Wt.unref(X2) || l2.avatar || B2.leading ? (Wt.openBlock(), Wt.createBlock("span", { key: 0, class: ne2.value.leading({ class: null == (n5 = k2.ui) ? void 0 : n5.leading }) }, [Wt.renderSlot(a3.$slots, "leading", { modelValue: t3, open: i3, ui: ne2.value }, () => {
            var a4, t4, i4;
            return [Wt.unref(X2) && Wt.unref(Z2) ? (Wt.openBlock(), Wt.createBlock(yb, { key: 0, name: Wt.unref(Z2), class: ne2.value.leadingIcon({ class: null == (a4 = k2.ui) ? void 0 : a4.leadingIcon }) }, null, 8, ["name", "class"])) : l2.avatar ? (Wt.openBlock(), Wt.createBlock(Tb, Wt.mergeProps({ key: 1, size: (null == (t4 = k2.ui) ? void 0 : t4.itemLeadingAvatarSize) || ne2.value.itemLeadingAvatarSize() }, l2.avatar, { class: ne2.value.itemLeadingAvatar({ class: null == (i4 = k2.ui) ? void 0 : i4.itemLeadingAvatar }) }), null, 16, ["size", "class"])) : Wt.createCommentVNode("", true)];
          ...
          }), 128))]), Wt.unref(Y2) || B2.trailing ? (Wt.openBlock(), Wt.createBlock("span", { key: 1, class: ne2.value.trailing({ class: null == (o3 = k2.ui) ? void 0 : o3.trailing }) }, [Wt.renderSlot(a3.$slots, "trailing", { modelValue: t3, open: i3, ui: ne2.value }, () => {
            var l3;
            return [Wt.unref(ee2) ? (Wt.openBlock(), Wt.createBlock(yb, { key: 0, name: Wt.unref(ee2), class: ne2.value.trailingIcon({ class: null == (l3 = k2.ui) ? void 0 : l3.trailingIcon }) }, null, 8, ["name", "class"])) : Wt.createCommentVNode("", true)];
          })], 2)) : Wt.createCommentVNode("", true)];
        }), _: 2 }, 1032, ["class"])];
      }), _: 2 }, 1024), Wt.createVNode(Wt.unref(we), Wt.unref(N2), { default: Wt.withCtx(() => {
        var t4;
        return [Wt.createVNode(Wt.unref(se), Wt.mergeProps({ class: ne2.value.content({ class: null == (t4 = k2.ui) ? void 0 : t4.content }) }, T2.value), { default: Wt.withCtx(() => {
          ...
          return [Wt.createVNode(Wt.unref(E), { trapped: "", class: ne2.value.focusScope({ class: null == (t5 = k2.ui) ? void 0 : t5.focusScope }) }, { default: Wt.withCtx(() => {
            var t6, i5;
            return [Wt.renderSlot(a3.$slots, "content-top"), l2.searchInput ? (Wt.openBlock(), Wt.createBlock(Wt.unref(he), { key: 0, modelValue: w2.value, "onUpdate:modelValue": (e2) => w2.value = e2, "display-value": () => w2.value, "as-child": "" }, { default: Wt.withCtx(() => {
              var a4;
            ...
            }), _: 1 }, 8, ["modelValue", "onUpdate:modelValue", "display-value"])) : Wt.createCommentVNode("", true), Wt.createVNode(Wt.unref(ue), { class: ne2.value.empty({ class: null == (t6 = k2.ui) ? void 0 : t6.empty }) }, { default: Wt.withCtx(() => [Wt.renderSlot(a3.$slots, "empty", { searchTerm: w2.value }, () => [Wt.createTextVNode(Wt.toDisplayString(w2.value ? Wt.unref(V2)("selectMenu.noMatch", { searchTerm: w2.value }) : Wt.unref(V2)("selectMenu.noData")), 1)])]), _: 3 }, 8, ["class"]), Wt.createVNode("div", { role: "presentation", class: ne2.value.viewport({ class: null == (i5 = k2.ui) ? void 0 : i5.viewport }) }, [me2.value && "top" === ge2.value ? (Wt.openBlock(), Wt.createBlock(Wt.unref(ie2), { key: 0 })) : Wt.createCommentVNode("", true), (Wt.openBlock(true), Wt.createBlock(Wt.Fragment, null, Wt.renderList(ve2.value, (t7, i6) => {
              var n4;
              return Wt.openBlock(), Wt.createBlock(Wt.unref(fe), { key: `group-${i6}`, class: ne2.value.group({ class: null == (n4 = k2.ui) ? void 0 : n4.group }) }, { default: Wt.withCtx(() => [(Wt.openBlock(true), Wt.createBlock(Wt.Fragment, null, Wt.renderList(t7, (t8, n5) => {
                ...
                return Wt.openBlock(), Wt.createBlock(Wt.Fragment, { key: `group-${i6}-${n5}` }, [ze2(t8) && "label" === t8.type ? (Wt.openBlock(), Wt.createBlock(Wt.unref(Se), { key: 0, class: ne2.value.label({ class: [null == (o3 = k2.ui) ? void 0 : o3.label, null == (r3 = t8.ui) ? void 0 : r3.label, t8.class] }) }, { default: Wt.withCtx(() => [Wt.createTextVNode(Wt.toDisplayString(Wt.unref(fg)(t8, k2.labelKey)), 1)]), _: 2 }, 1032, ["class"])) : ze2(t8) && "separator" === t8.type ? (Wt.openBlock(), Wt.createBlock(Wt.unref(Ve), { key: 1, class: ne2.value.separator({ class: [null == (s2 = k2.ui) ? void 0 : s2.separator, null == (u2 = t8.ui) ? void 0 : u2.separator, t8.class] }) }, null, 8, ["class"])) : (Wt.openBlock(), Wt.createBlock(Wt.unref(xe), { key: 2, class: ne2.value.item({ class: [null == (c2 = k2.ui) ? void 0 : c2.item, ze2(t8) && (null == (v2 = t8.ui) ? void 0 : v2.item), ze2(t8) && t8.class] }), disabled: ze2(t8) && t8.disabled, value: k2.valueKey && ze2(t8) ? Wt.unref(fg)(t8, k2.valueKey) : t8, onSelect: (e2) => Be2(e2, t8) }, { default: Wt.withCtx(() => [Wt.renderSlot(a3.$slots, "item", { item: t8, index: n5 }, () => {
                  var i7, o4, r4, s3;
                  return [Wt.renderSlot(a3.$slots, "item-leading", { item: t8, index: n5 }, () => {
                    var l3, a4, i8, n6, o5, r5, s4, u3, d2;
                    return [ze2(t8) && t8.icon ? (Wt.openBlock(), Wt.createBlock(yb, { key: 0, name: t8.icon, class: ne2.value.itemLeadingIcon({ class: [null == (l3 = k2.ui) ? void 0 : l3.itemLeadingIcon, null == (a4 = t8.ui) ? void 0 : a4.itemLeadingIcon] }) }, null, 8, ["name", "class"])) : ze2(t8) && t8.avatar ? (Wt.openBlock(), Wt.createBlock(Tb, Wt.mergeProps({ key: 1, size: (null == (i8 = t8.ui) ? void 0 : i8.itemLeadingAvatarSize) || (null == (n6 = k2.ui) ? void 0 : n6.itemLeadingAvatarSize) || ne2.value.itemLeadingAvatarSize() }, { ref_for: true }, t8.avatar, { class: ne2.value.itemLeadingAvatar({ class: [null == (o5 = k2.ui) ? void 0 : o5.itemLeadingAvatar, null == (r5 = t8.ui) ? void 0 : r5.itemLeadingAvatar] }) }), null, 16, ["size", "class"])) : ze2(t8) && t8.chip ? (Wt.openBlock(), Wt.createBlock(wb, Wt.mergeProps({ key: 2, size: (null == (s4 = k2.ui) ? void 0 : s4.itemLeadingChipSize) || ne2.value.itemLeadingChipSize(), inset: "", standalone: "" }, { ref_for: true }, t8.chip, { class: ne2.value.itemLeadingChip({ class: [null == (u3 = k2.ui) ? void 0 : u3.itemLeadingChip, null == (d2 = t8.ui) ? void 0 : d2.itemLeadingChip] }) }), null, 16, ["size", "class"])) : Wt.createCommentVNode("", true)];
                  }), Wt.createVNode("span", { class: ne2.value.itemLabel({ class: [null == (i7 = k2.ui) ? void 0 : i7.itemLabel, ze2(t8) && (null == (o4 = t8.ui) ? void 0 : o4.itemLabel)] }) }, [Wt.renderSlot(a3.$slots, "item-label", { item: t8, index: n5 }, () => [Wt.createTextVNode(Wt.toDisplayString(ze2(t8) ? Wt.unref(fg)(t8, k2.labelKey) : t8), 1)])], 2), Wt.createVNode("span", { class: ne2.value.itemTrailing({ class: [null == (r4 = k2.ui) ? void 0 : r4.itemTrailing, ze2(t8) && (null == (s3 = t8.ui) ? void 0 : s3.itemTrailing)] }) }, [Wt.renderSlot(a3.$slots, "item-trailing", { item: t8, index: n5 }), Wt.createVNode(Wt.unref(Ce), { "as-child": "" }, { default: Wt.withCtx(() => {
                    var a4, i8;
                    return [Wt.createVNode(yb, { name: l2.selectedIcon || Wt.unref(L2).ui.icons.check, class: ne2.value.itemTrailingIcon({ class: [null == (a4 = k2.ui) ? void 0 : a4.itemTrailingIcon, ze2(t8) && (null == (i8 = t8.ui) ? void 0 : i8.itemTrailingIcon)] }) }, null, 8, ["name", "class"])];
                  }), _: 2 }, 1024)], 2)];
      ...
      n3(pm.ssrRenderComponent(Wt.unref(W), { "as-child": "" }, { default: Wt.withCtx((n4, o3, r3, s2) => {
        var u2, d2;
        if (!o3) return [Wt.createVNode(Wt.unref(Le), { ref_key: "triggerRef", ref: ye2, class: ne2.value.base({ class: [null == (d2 = k2.ui) ? void 0 : d2.base, k2.class] }), tabindex: "0" }, { default: Wt.withCtx(() => {
          ...
          return [Wt.unref(X2) || l2.avatar || B2.leading ? (Wt.openBlock(), Wt.createBlock("span", { key: 0, class: ne2.value.leading({ class: null == (n5 = k2.ui) ? void 0 : n5.leading }) }, [Wt.renderSlot(a3.$slots, "leading", { modelValue: t3, open: i3, ui: ne2.value }, () => {
            ...
            var t4, i4;
            return Wt.openBlock(), Wt.createBlock(Wt.Fragment, { key: a4 }, [null != a4 ? (Wt.openBlock(), Wt.createBlock("span", { key: 0, class: ne2.value.value({ class: null == (t4 = k2.ui) ? void 0 : t4.value }) }, Wt.toDisplayString(a4), 3)) : (Wt.openBlock(), Wt.createBlock("span", { key: 1, class: ne2.value.placeholder({ class: null == (i4 = k2.ui) ? void 0 : i4.placeholder }) }, Wt.toDisplayString((_a = l2.placeholder) != null ? _a : "\xA0"), 3))], 64);
          }), 128))]), Wt.unref(Y2) || B2.trailing ? (Wt.openBlock(), Wt.createBlock("span", { key: 1, class: ne2.value.trailing({ class: null == (o4 = k2.ui) ? void 0 : o4.trailing }) }, [Wt.renderSlot(a3.$slots, "trailing", { modelValue: t3, open: i3, ui: ne2.value }, () => {
            var l3;
            return [Wt.unref(ee2) ? (Wt.openBlock(), Wt.createBlock(yb, { key: 0, name: Wt.unref(ee2), class: ne2.value.trailingIcon({ class: null == (l3 = k2.ui) ? void 0 : l3.trailingIcon }) }, null, 8, ["name", "class"])) : Wt.createCommentVNode("", true)];
          })], 2)) : Wt.createCommentVNode("", true)];
        }), _: 2 }, 1032, ["class"])];
        o3(pm.ssrRenderComponent(Wt.unref(Le), { ref_key: "triggerRef", ref: ye2, class: ne2.value.base({ class: [null == (u2 = k2.ui) ? void 0 : u2.base, k2.class] }), tabindex: "0" }, { default: Wt.withCtx((n5, o4, r4, s3) => {
          var u3, d3, c2, f2;
          if (!o4) return [Wt.unref(X2) || l2.avatar || B2.leading ? (Wt.openBlock(), Wt.createBlock("span", { key: 0, class: ne2.value.leading({ class: null == (c2 = k2.ui) ? void 0 : c2.leading }) }, [Wt.renderSlot(a3.$slots, "leading", { modelValue: t3, open: i3, ui: ne2.value }, () => {
            var a4, t4, i4;
            return [Wt.unref(X2) && Wt.unref(Z2) ? (Wt.openBlock(), Wt.createBlock(yb, { key: 0, name: Wt.unref(Z2), class: ne2.value.leadingIcon({ class: null == (a4 = k2.ui) ? void 0 : a4.leadingIcon }) }, null, 8, ["name", "class"])) : l2.avatar ? (Wt.openBlock(), Wt.createBlock(Tb, Wt.mergeProps({ key: 1, size: (null == (t4 = k2.ui) ? void 0 : t4.itemLeadingAvatarSize) || ne2.value.itemLeadingAvatarSize() }, l2.avatar, { class: ne2.value.itemLeadingAvatar({ class: null == (i4 = k2.ui) ? void 0 : i4.itemLeadingAvatar }) }), null, 16, ["size", "class"])) : Wt.createCommentVNode("", true)];
          })], 2)) : Wt.createCommentVNode("", true), Wt.renderSlot(a3.$slots, "default", { modelValue: t3, open: i3 }, () => [(Wt.openBlock(true), Wt.createBlock(Wt.Fragment, null, Wt.renderList([oe2(t3)], (a4) => {
            var _a;
            var t4, i4;
            return Wt.openBlock(), Wt.createBlock(Wt.Fragment, { key: a4 }, [null != a4 ? (Wt.openBlock(), Wt.createBlock("span", { key: 0, class: ne2.value.value({ class: null == (t4 = k2.ui) ? void 0 : t4.value }) }, Wt.toDisplayString(a4), 3)) : (Wt.openBlock(), Wt.createBlock("span", { key: 1, class: ne2.value.placeholder({ class: null == (i4 = k2.ui) ? void 0 : i4.placeholder }) }, Wt.toDisplayString((_a = l2.placeholder) != null ? _a : "\xA0"), 3))], 64);
          }), 128))]), Wt.unref(Y2) || B2.trailing ? (Wt.openBlock(), Wt.createBlock("span", { key: 1, class: ne2.value.trailing({ class: null == (f2 = k2.ui) ? void 0 : f2.trailing }) }, [Wt.renderSlot(a3.$slots, "trailing", { modelValue: t3, open: i3, ui: ne2.value }, () => {
            var l3;
            return [Wt.unref(ee2) ? (Wt.openBlock(), Wt.createBlock(yb, { key: 0, name: Wt.unref(ee2), class: ne2.value.trailingIcon({ class: null == (l3 = k2.ui) ? void 0 : l3.trailingIcon }) }, null, 8, ["name", "class"])) : Wt.createCommentVNode("", true)];
          })], 2)) : Wt.createCommentVNode("", true)];
          Wt.unref(X2) || l2.avatar || B2.leading ? (o4(`<span class="${pm.ssrRenderClass(ne2.value.leading({ class: null == (u3 = k2.ui) ? void 0 : u3.leading }))}"${s3}>`), pm.ssrRenderSlot(a3.$slots, "leading", { modelValue: t3, open: i3, ui: ne2.value }, () => {
            var a4, t4, i4;
            Wt.unref(X2) && Wt.unref(Z2) ? o4(pm.ssrRenderComponent(yb, { name: Wt.unref(Z2), class: ne2.value.leadingIcon({ class: null == (a4 = k2.ui) ? void 0 : a4.leadingIcon }) }, null, r4, s3)) : l2.avatar ? o4(pm.ssrRenderComponent(Tb, Wt.mergeProps({ size: (null == (t4 = k2.ui) ? void 0 : t4.itemLeadingAvatarSize) || ne2.value.itemLeadingAvatarSize() }, l2.avatar, { class: ne2.value.itemLeadingAvatar({ class: null == (i4 = k2.ui) ? void 0 : i4.itemLeadingAvatar }) }), null, r4, s3)) : o4("<!---->");
          }, o4, r4, s3), o4("</span>")) : o4("<!---->"), pm.ssrRenderSlot(a3.$slots, "default", { modelValue: t3, open: i3 }, () => {
            o4("<!--[-->"), pm.ssrRenderList([oe2(t3)], (e2) => {
              var _a;
              var a4, t4;
              o4("<!--[-->"), o4(null != e2 ? `<span class="${pm.ssrRenderClass(ne2.value.value({ class: null == (a4 = k2.ui) ? void 0 : a4.value }))}"${s3}>${pm.ssrInterpolate(e2)}</span>` : `<span class="${pm.ssrRenderClass(ne2.value.placeholder({ class: null == (t4 = k2.ui) ? void 0 : t4.placeholder }))}"${s3}>${pm.ssrInterpolate((_a = l2.placeholder) != null ? _a : "\xA0")}</span>`), o4("<!--]-->");
            }), o4("<!--]-->");
          }, o4, r4, s3), Wt.unref(Y2) || B2.trailing ? (o4(`<span class="${pm.ssrRenderClass(ne2.value.trailing({ class: null == (d3 = k2.ui) ? void 0 : d3.trailing }))}"${s3}>`), pm.ssrRenderSlot(a3.$slots, "trailing", { modelValue: t3, open: i3, ui: ne2.value }, () => {
            var l3;
            Wt.unref(ee2) ? o4(pm.ssrRenderComponent(yb, { name: Wt.unref(ee2), class: ne2.value.trailingIcon({ class: null == (l3 = k2.ui) ? void 0 : l3.trailingIcon }) }, null, r4, s3)) : o4("<!---->");
          }, o4, r4, s3), o4("</span>")) : o4("<!---->");
        }), _: 2 }, r3, s2));
      }), _: 2 }, o2, r2)), n3(pm.ssrRenderComponent(Wt.unref(we), Wt.unref(N2), { default: Wt.withCtx((t4, i4, n4, o3) => {
        var r3, s2;
        if (!i4) return [Wt.createVNode(Wt.unref(se), Wt.mergeProps({ class: ne2.value.content({ class: null == (s2 = k2.ui) ? void 0 : s2.content }) }, T2.value), { default: Wt.withCtx(() => {
          ...
          return [Wt.createVNode(Wt.unref(E), { trapped: "", class: ne2.value.focusScope({ class: null == (t5 = k2.ui) ? void 0 : t5.focusScope }) }, { default: Wt.withCtx(() => {
            ...
            return [Wt.renderSlot(a3.$slots, "content-top"), l2.searchInput ? (Wt.openBlock(), Wt.createBlock(Wt.unref(he), { key: 0, modelValue: w2.value, "onUpdate:modelValue": (e2) => w2.value = e2, "display-value": () => w2.value, "as-child": "" }, { default: Wt.withCtx(() => {
              var a4;
              return [Wt.createVNode(c, Wt.mergeProps({ autofocus: "", autocomplete: "off", size: l2.size }, A2.value, { class: ne2.value.input({ class: null == (a4 = k2.ui) ? void 0 : a4.input }) }), null, 16, ["size", "class"])];
            }), _: 1 }, 8, ["modelValue", "onUpdate:modelValue", "display-value"])) : Wt.createCommentVNode("", true), Wt.createVNode(Wt.unref(ue), { class: ne2.value.empty({ class: null == (t6 = k2.ui) ? void 0 : t6.empty }) }, { default: Wt.withCtx(() => [Wt.renderSlot(a3.$slots, "empty", { searchTerm: w2.value }, () => [Wt.createTextVNode(Wt.toDisplayString(w2.value ? Wt.unref(V2)("selectMenu.noMatch", { searchTerm: w2.value }) : Wt.unref(V2)("selectMenu.noData")), 1)])]), _: 3 }, 8, ["class"]), Wt.createVNode("div", { role: "presentation", class: ne2.value.viewport({ class: null == (i6 = k2.ui) ? void 0 : i6.viewport }) }, [me2.value && "top" === ge2.value ? (Wt.openBlock(), Wt.createBlock(Wt.unref(ie2), { key: 0 })) : Wt.createCommentVNode("", true), (Wt.openBlock(true), Wt.createBlock(Wt.Fragment, null, Wt.renderList(ve2.value, (t7, i7) => {
              var n5;
        ...
        i4(pm.ssrRenderComponent(Wt.unref(se), Wt.mergeProps({ class: ne2.value.content({ class: null == (r3 = k2.ui) ? void 0 : r3.content }) }, T2.value), { default: Wt.withCtx((t5, i5, n5, o4) => {
          var r4, s3, u2, c2;
          ...
          i5(pm.ssrRenderComponent(Wt.unref(E), { trapped: "", class: ne2.value.focusScope({ class: null == (r4 = k2.ui) ? void 0 : r4.focusScope }) }, { default: Wt.withCtx((t6, i6, n6, o5) => {
            var r5, s4, u3, c3;
            if (!i6) return [Wt.renderSlot(a3.$slots, "content-top"), l2.searchInput ? (Wt.openBlock(), Wt.createBlock(Wt.unref(he), { key: 0, modelValue: w2.value, "onUpdate:modelValue": (e2) => w2.value = e2, "display-value": () => w2.value, "as-child": "" }, { default: Wt.withCtx(() => {
              var a4;
              return [Wt.createVNode(c, Wt.mergeProps({ autofocus: "", autocomplete: "off", size: l2.size }, A2.value, { class: ne2.value.input({ class: null == (a4 = k2.ui) ? void 0 : a4.input }) }), null, 16, ["size", "class"])];
            }), _: 1 }, 8, ["modelValue", "onUpdate:modelValue", "display-value"])) : Wt.createCommentVNode("", true), Wt.createVNode(Wt.unref(ue), { class: ne2.value.empty({ class: null == (u3 = k2.ui) ? void 0 : u3.empty }) }, { default: Wt.withCtx(() => [Wt.renderSlot(a3.$slots, "empty", { searchTerm: w2.value }, () => [Wt.createTextVNode(Wt.toDisplayString(w2.value ? Wt.unref(V2)("selectMenu.noMatch", { searchTerm: w2.value }) : Wt.unref(V2)("selectMenu.noData")), 1)])]), _: 3 }, 8, ["class"]), Wt.createVNode("div", { role: "presentation", class: ne2.value.viewport({ class: null == (c3 = k2.ui) ? void 0 : c3.viewport }) }, [me2.value && "top" === ge2.value ? (Wt.openBlock(), Wt.createBlock(Wt.unref(ie2), { key: 0 })) : Wt.createCommentVNode("", true), (Wt.openBlock(true), Wt.createBlock(Wt.Fragment, null, Wt.renderList(ve2.value, (t7, i7) => {
              var n7;
            ...
            pm.ssrRenderSlot(a3.$slots, "content-top", {}, null, i6, n6, o5), l2.searchInput ? i6(pm.ssrRenderComponent(Wt.unref(he), { modelValue: w2.value, "onUpdate:modelValue": (e2) => w2.value = e2, "display-value": () => w2.value, "as-child": "" }, { default: Wt.withCtx((a4, t7, i7, n7) => {
              var o6, r6;
              ...
              t7(pm.ssrRenderComponent(c, Wt.mergeProps({ autofocus: "", autocomplete: "off", size: l2.size }, A2.value, { class: ne2.value.input({ class: null == (o6 = k2.ui) ? void 0 : o6.input }) }), null, i7, n7));
            }), _: 2 }, n6, o5)) : i6("<!---->"), i6(pm.ssrRenderComponent(Wt.unref(ue), { class: ne2.value.empty({ class: null == (r5 = k2.ui) ? void 0 : r5.empty }) }, { default: Wt.withCtx((l3, t7, i7, n7) => {
              if (!t7) return [Wt.renderSlot(a3.$slots, "empty", { searchTerm: w2.value }, () => [Wt.createTextVNode(Wt.toDisplayString(w2.value ? Wt.unref(V2)("selectMenu.noMatch", { searchTerm: w2.value }) : Wt.unref(V2)("selectMenu.noData")), 1)])];
              pm.ssrRenderSlot(a3.$slots, "empty", { searchTerm: w2.value }, () => {
                t7(`${pm.ssrInterpolate(w2.value ? Wt.unref(V2)("selectMenu.noMatch", { searchTerm: w2.value }) : Wt.unref(V2)("selectMenu.noData"))}`);
              }, t7, i7, n7);
            }), _: 2 }, n6, o5)), i6(`<div role="presentation" class="${pm.ssrRenderClass(ne2.value.viewport({ class: null == (s4 = k2.ui) ? void 0 : s4.viewport }))}"${o5}>`), me2.value && "top" === ge2.value ? i6(pm.ssrRenderComponent(Wt.unref(ie2), null, null, n6, o5)) : i6("<!---->"), i6("<!--[-->"), pm.ssrRenderList(ve2.value, (t7, r6) => {
              var s5;
              i6(pm.ssrRenderComponent(Wt.unref(fe), { key: `group-${r6}`, class: ne2.value.group({ class: null == (s5 = k2.ui) ? void 0 : s5.group }) }, { default: Wt.withCtx((i7, n7, o6, s6) => {
                if (!n7) return [(Wt.openBlock(true), Wt.createBlock(Wt.Fragment, null, Wt.renderList(t7, (t8, i8) => {
                  var n8, o7, s7, u4, c4, v2;
                  return Wt.openBlock(), Wt.createBlock(Wt.Fragment, { key: `group-${r6}-${i8}` }, [ze2(t8) && "label" === t8.type ? (Wt.openBlock(), Wt.createBlock(Wt.unref(Se), { key: 0, class: ne2.value.label({ class: [null == (n8 = k2.ui) ? void 0 : n8.label, null == (o7 = t8.ui) ? void 0 : o7.label, t8.class] }) }, { default: Wt.withCtx(() => [Wt.createTextVNode(Wt.toDisplayString(Wt.unref(fg)(t8, k2.labelKey)), 1)]), _: 2 }, 1032, ["class"])) : ze2(t8) && "separator" === t8.type ? (Wt.openBlock(), Wt.createBlock(Wt.unref(Ve), { key: 1, class: ne2.value.separator({ class: [null == (s7 = k2.ui) ? void 0 : s7.separator, null == (u4 = t8.ui) ? void 0 : u4.separator, t8.class] }) }, null, 8, ["class"])) : (Wt.openBlock(), Wt.createBlock(Wt.unref(xe), { key: 2, class: ne2.value.item({ class: [null == (c4 = k2.ui) ? void 0 : c4.item, ze2(t8) && (null == (v2 = t8.ui) ? void 0 : v2.item), ze2(t8) && t8.class] }), disabled: ze2(t8) && t8.disabled, value: k2.valueKey && ze2(t8) ? Wt.unref(fg)(t8, k2.valueKey) : t8, onSelect: (e2) => Be2(e2, t8) }, { default: Wt.withCtx(() => [Wt.renderSlot(a3.$slots, "item", { item: t8, index: i8 }, () => {
                    var n9, o8, r7, s8;
                    return [Wt.renderSlot(a3.$slots, "item-leading", { item: t8, index: i8 }, () => {
                      var l3, a4, i9, n10, o9, r8, s9, u5, d2;
                      return [ze2(t8) && t8.icon ? (Wt.openBlock(), Wt.createBlock(yb, { key: 0, name: t8.icon, class: ne2.value.itemLeadingIcon({ class: [null == (l3 = k2.ui) ? void 0 : l3.itemLeadingIcon, null == (a4 = t8.ui) ? void 0 : a4.itemLeadingIcon] }) }, null, 8, ["name", "class"])) : ze2(t8) && t8.avatar ? (Wt.openBlock(), Wt.createBlock(Tb, Wt.mergeProps({ key: 1, size: (null == (i9 = t8.ui) ? void 0 : i9.itemLeadingAvatarSize) || (null == (n10 = k2.ui) ? void 0 : n10.itemLeadingAvatarSize) || ne2.value.itemLeadingAvatarSize() }, { ref_for: true }, t8.avatar, { class: ne2.value.itemLeadingAvatar({ class: [null == (o9 = k2.ui) ? void 0 : o9.itemLeadingAvatar, null == (r8 = t8.ui) ? void 0 : r8.itemLeadingAvatar] }) }), null, 16, ["size", "class"])) : ze2(t8) && t8.chip ? (Wt.openBlock(), Wt.createBlock(wb, Wt.mergeProps({ key: 2, size: (null == (s9 = k2.ui) ? void 0 : s9.itemLeadingChipSize) || ne2.value.itemLeadingChipSize(), inset: "", standalone: "" }, { ref_for: true }, t8.chip, { class: ne2.value.itemLeadingChip({ class: [null == (u5 = k2.ui) ? void 0 : u5.itemLeadingChip, null == (d2 = t8.ui) ? void 0 : d2.itemLeadingChip] }) }), null, 16, ["size", "class"])) : Wt.createCommentVNode("", true)];
                    }), Wt.createVNode("span", { class: ne2.value.itemLabel({ class: [null == (n9 = k2.ui) ? void 0 : n9.itemLabel, ze2(t8) && (null == (o8 = t8.ui) ? void 0 : o8.itemLabel)] }) }, [Wt.renderSlot(a3.$slots, "item-label", { item: t8, index: i8 }, () => [Wt.createTextVNode(Wt.toDisplayString(ze2(t8) ? Wt.unref(fg)(t8, k2.labelKey) : t8), 1)])], 2), Wt.createVNode("span", { class: ne2.value.itemTrailing({ class: [null == (r7 = k2.ui) ? void 0 : r7.itemTrailing, ze2(t8) && (null == (s8 = t8.ui) ? void 0 : s8.itemTrailing)] }) }, [Wt.renderSlot(a3.$slots, "item-trailing", { item: t8, index: i8 }), Wt.createVNode(Wt.unref(Ce), { "as-child": "" }, { default: Wt.withCtx(() => {
                      var a4, i9;
                      return [Wt.createVNode(yb, { name: l2.selectedIcon || Wt.unref(L2).ui.icons.check, class: ne2.value.itemTrailingIcon({ class: [null == (a4 = k2.ui) ? void 0 : a4.itemTrailingIcon, ze2(t8) && (null == (i9 = t8.ui) ? void 0 : i9.itemTrailingIcon)] }) }, null, 8, ["name", "class"])];
                    }), _: 2 }, 1024)], 2)];
                  })]), _: 2 }, 1032, ["class", "disabled", "value", "onSelect"]))], 64);
                }), 128))];
                n7("<!--[-->"), pm.ssrRenderList(t7, (t8, i8) => {
                  var r7, u4, c4, g2, h2, y2;
                  n7("<!--[-->"), ze2(t8) && "label" === t8.type ? n7(pm.ssrRenderComponent(Wt.unref(Se), { class: ne2.value.label({ class: [null == (r7 = k2.ui) ? void 0 : r7.label, null == (u4 = t8.ui) ? void 0 : u4.label, t8.class] }) }, { default: Wt.withCtx((l3, a4, i9, n8) => {
                    if (!a4) return [Wt.createTextVNode(Wt.toDisplayString(Wt.unref(fg)(t8, k2.labelKey)), 1)];
                    a4(`${pm.ssrInterpolate(Wt.unref(fg)(t8, k2.labelKey))}`);
                  }), _: 2 }, o6, s6)) : ze2(t8) && "separator" === t8.type ? n7(pm.ssrRenderComponent(Wt.unref(Ve), { class: ne2.value.separator({ class: [null == (c4 = k2.ui) ? void 0 : c4.separator, null == (g2 = t8.ui) ? void 0 : g2.separator, t8.class] }) }, null, o6, s6)) : n7(pm.ssrRenderComponent(Wt.unref(xe), { class: ne2.value.item({ class: [null == (h2 = k2.ui) ? void 0 : h2.item, ze2(t8) && (null == (y2 = t8.ui) ? void 0 : y2.item), ze2(t8) && t8.class] }), disabled: ze2(t8) && t8.disabled, value: k2.valueKey && ze2(t8) ? Wt.unref(fg)(t8, k2.valueKey) : t8, onSelect: (e2) => Be2(e2, t8) }, { default: Wt.withCtx((n8, o7, r8, s7) => {
                    if (!o7) return [Wt.renderSlot(a3.$slots, "item", { item: t8, index: i8 }, () => {
                      var n9, o8, r9, s8;
                      return [Wt.renderSlot(a3.$slots, "item-leading", { item: t8, index: i8 }, () => {
                        var l3, a4, i9, n10, o9, r10, s9, u5, d2;
                        return [ze2(t8) && t8.icon ? (Wt.openBlock(), Wt.createBlock(yb, { key: 0, name: t8.icon, class: ne2.value.itemLeadingIcon({ class: [null == (l3 = k2.ui) ? void 0 : l3.itemLeadingIcon, null == (a4 = t8.ui) ? void 0 : a4.itemLeadingIcon] }) }, null, 8, ["name", "class"])) : ze2(t8) && t8.avatar ? (Wt.openBlock(), Wt.createBlock(Tb, Wt.mergeProps({ key: 1, size: (null == (i9 = t8.ui) ? void 0 : i9.itemLeadingAvatarSize) || (null == (n10 = k2.ui) ? void 0 : n10.itemLeadingAvatarSize) || ne2.value.itemLeadingAvatarSize() }, { ref_for: true }, t8.avatar, { class: ne2.value.itemLeadingAvatar({ class: [null == (o9 = k2.ui) ? void 0 : o9.itemLeadingAvatar, null == (r10 = t8.ui) ? void 0 : r10.itemLeadingAvatar] }) }), null, 16, ["size", "class"])) : ze2(t8) && t8.chip ? (Wt.openBlock(), Wt.createBlock(wb, Wt.mergeProps({ key: 2, size: (null == (s9 = k2.ui) ? void 0 : s9.itemLeadingChipSize) || ne2.value.itemLeadingChipSize(), inset: "", standalone: "" }, { ref_for: true }, t8.chip, { class: ne2.value.itemLeadingChip({ class: [null == (u5 = k2.ui) ? void 0 : u5.itemLeadingChip, null == (d2 = t8.ui) ? void 0 : d2.itemLeadingChip] }) }), null, 16, ["size", "class"])) : Wt.createCommentVNode("", true)];
                      }), Wt.createVNode("span", { class: ne2.value.itemLabel({ class: [null == (n9 = k2.ui) ? void 0 : n9.itemLabel, ze2(t8) && (null == (o8 = t8.ui) ? void 0 : o8.itemLabel)] }) }, [Wt.renderSlot(a3.$slots, "item-label", { item: t8, index: i8 }, () => [Wt.createTextVNode(Wt.toDisplayString(ze2(t8) ? Wt.unref(fg)(t8, k2.labelKey) : t8), 1)])], 2), Wt.createVNode("span", { class: ne2.value.itemTrailing({ class: [null == (r9 = k2.ui) ? void 0 : r9.itemTrailing, ze2(t8) && (null == (s8 = t8.ui) ? void 0 : s8.itemTrailing)] }) }, [Wt.renderSlot(a3.$slots, "item-trailing", { item: t8, index: i8 }), Wt.createVNode(Wt.unref(Ce), { "as-child": "" }, { default: Wt.withCtx(() => {
                        var a4, i9;
                        return [Wt.createVNode(yb, { name: l2.selectedIcon || Wt.unref(L2).ui.icons.check, class: ne2.value.itemTrailingIcon({ class: [null == (a4 = k2.ui) ? void 0 : a4.itemTrailingIcon, ze2(t8) && (null == (i9 = t8.ui) ? void 0 : i9.itemTrailingIcon)] }) }, null, 8, ["name", "class"])];
                      }), _: 2 }, 1024)], 2)];
                    })];
                    pm.ssrRenderSlot(a3.$slots, "item", { item: t8, index: i8 }, () => {
                      var n9, u5, c5, g3;
                      pm.ssrRenderSlot(a3.$slots, "item-leading", { item: t8, index: i8 }, () => {
                        var l3, a4, i9, n10, u6, d2, c6, g4, h3;
                        ze2(t8) && t8.icon ? o7(pm.ssrRenderComponent(yb, { name: t8.icon, class: ne2.value.itemLeadingIcon({ class: [null == (l3 = k2.ui) ? void 0 : l3.itemLeadingIcon, null == (a4 = t8.ui) ? void 0 : a4.itemLeadingIcon] }) }, null, r8, s7)) : ze2(t8) && t8.avatar ? o7(pm.ssrRenderComponent(Tb, Wt.mergeProps({ size: (null == (i9 = t8.ui) ? void 0 : i9.itemLeadingAvatarSize) || (null == (n10 = k2.ui) ? void 0 : n10.itemLeadingAvatarSize) || ne2.value.itemLeadingAvatarSize() }, { ref_for: true }, t8.avatar, { class: ne2.value.itemLeadingAvatar({ class: [null == (u6 = k2.ui) ? void 0 : u6.itemLeadingAvatar, null == (d2 = t8.ui) ? void 0 : d2.itemLeadingAvatar] }) }), null, r8, s7)) : ze2(t8) && t8.chip ? o7(pm.ssrRenderComponent(wb, Wt.mergeProps({ size: (null == (c6 = k2.ui) ? void 0 : c6.itemLeadingChipSize) || ne2.value.itemLeadingChipSize(), inset: "", standalone: "" }, { ref_for: true }, t8.chip, { class: ne2.value.itemLeadingChip({ class: [null == (g4 = k2.ui) ? void 0 : g4.itemLeadingChip, null == (h3 = t8.ui) ? void 0 : h3.itemLeadingChip] }) }), null, r8, s7)) : o7("<!---->");
                      }, o7, r8, s7), o7(`<span class="${pm.ssrRenderClass(ne2.value.itemLabel({ class: [null == (n9 = k2.ui) ? void 0 : n9.itemLabel, ze2(t8) && (null == (u5 = t8.ui) ? void 0 : u5.itemLabel)] }))}"${s7}>`), pm.ssrRenderSlot(a3.$slots, "item-label", { item: t8, index: i8 }, () => {
                        o7(`${pm.ssrInterpolate(ze2(t8) ? Wt.unref(fg)(t8, k2.labelKey) : t8)}`);
                      }, o7, r8, s7), o7(`</span><span class="${pm.ssrRenderClass(ne2.value.itemTrailing({ class: [null == (c5 = k2.ui) ? void 0 : c5.itemTrailing, ze2(t8) && (null == (g3 = t8.ui) ? void 0 : g3.itemTrailing)] }))}"${s7}>`), pm.ssrRenderSlot(a3.$slots, "item-trailing", { item: t8, index: i8 }, null, o7, r8, s7), o7(pm.ssrRenderComponent(Wt.unref(Ce), { "as-child": "" }, { default: Wt.withCtx((a4, i9, n10, o8) => {
                        var r9, s8, u6, d2;
                        if (!i9) return [Wt.createVNode(yb, { name: l2.selectedIcon || Wt.unref(L2).ui.icons.check, class: ne2.value.itemTrailingIcon({ class: [null == (u6 = k2.ui) ? void 0 : u6.itemTrailingIcon, ze2(t8) && (null == (d2 = t8.ui) ? void 0 : d2.itemTrailingIcon)] }) }, null, 8, ["name", "class"])];
                        i9(pm.ssrRenderComponent(yb, { name: l2.selectedIcon || Wt.unref(L2).ui.icons.check, class: ne2.value.itemTrailingIcon({ class: [null == (r9 = k2.ui) ? void 0 : r9.itemTrailingIcon, ze2(t8) && (null == (s8 = t8.ui) ? void 0 : s8.itemTrailingIcon)] }) }, null, n10, o8));
                      }), _: 2 }, r8, s7)), o7("</span>");
                    }, o7, r8, s7);
                  }), _: 2 }, o6, s6)), n7("<!--]-->");
                }), n7("<!--]-->");
              }), _: 2 }, n6, o5));
            }), i6("<!--]-->"), me2.value && "bottom" === ge2.value ? i6(pm.ssrRenderComponent(Wt.unref(ie2), null, null, n6, o5)) : i6("<!---->"), i6("</div>"), pm.ssrRenderSlot(a3.$slots, "content-bottom", {}, null, i6, n6, o5);
          }), _: 2 }, n5, o4)), l2.arrow ? i5(pm.ssrRenderComponent(Wt.unref(re), Wt.mergeProps($2.value, { class: ne2.value.arrow({ class: null == (s3 = k2.ui) ? void 0 : s3.arrow }) }), null, n5, o4)) : i5("<!---->");
        }), _: 2 }, n4, o3));
      }), _: 2 }, o2, r2));
    }), _: 3 }, i2)), t2("<!--]-->");
  };
...
export { Ce as C, Le as L, Q, Se as S, Ve as V, W, ae as a, fe as f, he as h, re as r, se as s, ue as u, we as w, xe as x, ze as z };
//# sourceMappingURL=SelectMenu-C9jA8Nq3.mjs.map
