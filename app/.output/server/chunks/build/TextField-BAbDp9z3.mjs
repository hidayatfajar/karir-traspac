import { v as Wt, s as om, _ as kb, c as hb, u as ua, t as Hy, G as Ym, H as Km, P as xm, r as Mm, a as Sm } from './server.mjs';
import { F as F$1, N as N$1, T as T$1, C, R } from './useForwardPropsEmits-DnSfSOTI.mjs';
import { c } from './Input-BTq7Ekjb.mjs';
import { m as defu } from '../_/nitro.mjs';
import { O as O$1, c as c$1, b, f, h } from './usePortal-DzDMWCd7.mjs';
import { d } from './Kbd-2mh2A80S.mjs';
import { $ as $e, H as He, q as qe, I as Ie } from './PopperArrow-BQDIGHqG.mjs';
...
const N = Wt.defineComponent({ __name: "Label", props: { for: {}, asChild: { type: Boolean }, as: { default: "label" } }, setup(r2) {
  const o2 = r2;
  return N$1(), (r3, l2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(xm), Wt.mergeProps(o2, { onMousedown: l2[0] || (l2[0] = (e2) => {
  ...
  const o2 = t2, l2 = r2, a2 = T(), { forwardRef: n2 } = N$1(), s2 = Wt.useSlots(), i2 = Wt.computed(() => {
    var e2;
  ...
  return (t3, r3) => (Wt.openBlock(), Wt.createBlock(Wt.unref(h), { "as-child": "", "disable-outside-pointer-events": false, onEscapeKeyDown: r3[0] || (r3[0] = (e2) => l2("escapeKeyDown", e2)), onPointerDownOutside: r3[1] || (r3[1] = (t4) => {
    var r4;
  ...
  const o2 = Sm(t2), { forwardRef: l2, currentElement: a2 } = N$1(), { trigger: n2, onClose: s2 } = T(), i2 = D(), { isPointerInTransit: u2, onPointerExit: d2 } = r(n2, a2);
  ...
  const o2 = t2, l2 = r2, a2 = T(), n2 = F$1(o2, l2), { forwardRef: s2 } = N$1();
  ...
  const r2 = t2;
  return (t3, o2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(b), Wt.normalizeProps(Wt.guardReactiveProps(r2)), { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "default")]), _: 3 }, 16));
} }), E = Wt.defineComponent({ __name: "TooltipTrigger", props: { reference: {}, asChild: { type: Boolean }, as: { default: "button" } }, setup(r2) {
  const o2 = r2, l2 = T(), a2 = D();
  ...
  return (r3, a3) => (Wt.openBlock(), Wt.createBlock(Wt.unref(He), { "as-child": "", reference: r3.reference }, { default: Wt.withCtx(() => [Wt.createVNode(Wt.unref(xm), Wt.mergeProps({ ref: Wt.unref(n2), "aria-describedby": Wt.unref(l2).open.value ? Wt.unref(l2).contentId : void 0, "data-state": Wt.unref(l2).stateAttribute.value, as: r3.as, "as-child": o2.asChild, "data-grace-area-trigger": "" }, Wt.toHandlers(u2.value)), { default: Wt.withCtx(() => [Wt.renderSlot(r3.$slots, "default")]), _: 3 }, 16, ["aria-describedby", "data-state", "as", "as-child"])]), _: 3 }, 8, ["reference"]));
  ...
  const i2 = r2, u2 = Wt.useSlots(), d2 = ua(), p2 = Wt.computed(() => {
    var e2;
    return Hy({ extend: Hy(H), ...(null == (e2 = d2.ui) ? void 0 : e2.formField) || {} })({ size: i2.size, required: i2.required });
  ...
  return Wt.provide(Ym, m2), Wt.provide(Km, Wt.computed(() => ({ error: f2.value, name: i2.name, size: i2.size, eagerValidation: i2.eagerValidation, validateOnInputDelay: i2.validateOnInputDelay, errorPattern: i2.errorPattern, hint: i2.hint, description: i2.description, help: i2.help, ariaId: v2 }))), (o2, l2, a2, n2) => {
    var d3;
    l2(om.ssrRenderComponent(Wt.unref(xm), Wt.mergeProps({ as: r2.as, class: p2.value.root({ class: [null == (d3 = i2.ui) ? void 0 : d3.root, i2.class] }) }, n2), { default: Wt.withCtx((t2, l3, a3, n3) => {
      ...
      l3(`<div class="${om.ssrRenderClass(p2.value.wrapper({ class: null == (d4 = i2.ui) ? void 0 : d4.wrapper }))}"${n3}>`), r2.label || u2.label ? (l3(`<div class="${om.ssrRenderClass(p2.value.labelWrapper({ class: null == (c3 = i2.ui) ? void 0 : c3.labelWrapper }))}"${n3}>`), l3(om.ssrRenderComponent(Wt.unref(N), { for: m2.value, class: p2.value.label({ class: null == (h2 = i2.ui) ? void 0 : h2.label }) }, { default: Wt.withCtx((t3, l4, a4, n4) => {
        if (!l4) return [Wt.renderSlot(o2.$slots, "label", { label: r2.label }, () => [Wt.createTextVNode(Wt.toDisplayString(r2.label), 1)])];
        om.ssrRenderSlot(o2.$slots, "label", { label: r2.label }, () => {
          l4(`${om.ssrInterpolate(r2.label)}`);
        }, l4, a4, n4);
      }), _: 3 }, a3, n3)), r2.hint || u2.hint ? (l3(`<span${om.ssrRenderAttr("id", `${Wt.unref(v2)}-hint`)} class="${om.ssrRenderClass(p2.value.hint({ class: null == (g2 = i2.ui) ? void 0 : g2.hint }))}"${n3}>`), om.ssrRenderSlot(o2.$slots, "hint", { hint: r2.hint }, () => {
        l3(`${om.ssrInterpolate(r2.hint)}`);
      }, l3, a3, n3), l3("</span>")) : l3("<!---->"), l3("</div>")) : l3("<!---->"), r2.description || u2.description ? (l3(`<p${om.ssrRenderAttr("id", `${Wt.unref(v2)}-description`)} class="${om.ssrRenderClass(p2.value.description({ class: null == (x2 = i2.ui) ? void 0 : x2.description }))}"${n3}>`), om.ssrRenderSlot(o2.$slots, "description", { description: r2.description }, () => {
        l3(`${om.ssrInterpolate(r2.description)}`);
      }, l3, a3, n3), l3("</p>")) : l3("<!---->"), l3(`</div><div class="${om.ssrRenderClass([(r2.label || !!u2.label || r2.description || !!u2.description) && p2.value.container({ class: null == (y2 = i2.ui) ? void 0 : y2.container })])}"${n3}>`), om.ssrRenderSlot(o2.$slots, "default", { error: f2.value }, null, l3, a3, n3), "string" == typeof f2.value && f2.value || u2.error ? (l3(`<div${om.ssrRenderAttr("id", `${Wt.unref(v2)}-error`)} class="${om.ssrRenderClass(p2.value.error({ class: null == (b2 = i2.ui) ? void 0 : b2.error }))}"${n3}>`), om.ssrRenderSlot(o2.$slots, "error", { error: f2.value }, () => {
        l3(`${om.ssrInterpolate(f2.value)}`);
      }, l3, a3, n3), l3("</div>")) : r2.help || u2.help ? (l3(`<div class="${om.ssrRenderClass(p2.value.help({ class: null == (k2 = i2.ui) ? void 0 : k2.help }))}"${n3}>`), om.ssrRenderSlot(o2.$slots, "help", { help: r2.help }, () => {
        l3(`${om.ssrInterpolate(r2.help)}`);
...
const W = { slots: { content: "flex items-center gap-1 bg-default text-highlighted shadow-sm rounded-sm ring ring-default h-6 px-2.5 py-1 text-xs select-none data-[state=delayed-open]:animate-[scale-in_100ms_ease-out] data-[state=closed]:animate-[scale-out_100ms_ease-in] origin-(--reka-tooltip-content-transform-origin) pointer-events-auto", arrow: "fill-default", text: "truncate", kbds: "hidden lg:inline-flex items-center shrink-0 gap-0.5 before:content-['\xB7'] before:me-0.5", kbdsSize: "sm" } }, U = { __name: "Tooltip", __ssrInlineRender: true, props: { text: { type: String, required: false }, kbds: { type: Array, required: false }, content: { type: Object, required: false }, arrow: { type: [Boolean, Object], required: false }, portal: { type: [Boolean, String], required: false, skipCheck: true, default: true }, class: { type: null, required: false }, ui: { type: null, required: false }, defaultOpen: { type: Boolean, required: false }, open: { type: Boolean, required: false }, delayDuration: { type: Number, required: false }, disableHoverableContent: { type: Boolean, required: false }, disableClosingTrigger: { type: Boolean, required: false }, disabled: { type: Boolean, required: false }, ignoreNonKeyboardFocus: { type: Boolean, required: false } }, emits: ["update:open"], setup(t2, { emit: r2 }) {
  const a2 = t2, n2 = r2, u2 = Wt.useSlots(), d2 = ua(), p2 = F$1(Mm(a2, "defaultOpen", "open", "delayDuration", "disableHoverableContent", "disableClosingTrigger", "disabled", "ignoreNonKeyboardFocus"), n2), c2 = O$1(Wt.toRef(() => a2.portal)), f2 = Wt.toRef(() => defu(a2.content, { side: "bottom", sideOffset: 8, collisionPadding: 8 })), m2 = Wt.toRef(() => a2.arrow), h2 = Wt.computed(() => {
    var e2;
    return Hy({ extend: Hy(W), ...(null == (e2 = d2.ui) ? void 0 : e2.tooltip) || {} })({ side: f2.value.side });
  });
  return (r3, o2, l2, n3) => {
    o2(om.ssrRenderComponent(Wt.unref(O), Wt.mergeProps(Wt.unref(p2), n3), { default: Wt.withCtx(({ open: o3 }, l3, n4, i2) => {
      ...
      u2.default ? l3(om.ssrRenderComponent(Wt.unref(E), Wt.mergeProps(r3.$attrs, { "as-child": "", class: a2.class }), { default: Wt.withCtx((t3, l4, a3, n5) => {
        if (!l4) return [Wt.renderSlot(r3.$slots, "default", { open: o3 })];
        om.ssrRenderSlot(r3.$slots, "default", { open: o3 }, null, l4, a3, n5);
      }), _: 2 }, n4, i2)) : l3("<!---->"), l3(om.ssrRenderComponent(Wt.unref(j), Wt.unref(c2), { default: Wt.withCtx((o4, l4, n5, i3) => {
        var d3, p3;
        ...
        l4(om.ssrRenderComponent(Wt.unref(L), Wt.mergeProps(f2.value, { class: h2.value.content({ class: [!u2.default && a2.class, null == (d3 = a2.ui) ? void 0 : d3.content] }) }), { default: Wt.withCtx((o5, l5, n6, i4) => {
          var u3, d4;
          ...
          om.ssrRenderSlot(r3.$slots, "content", {}, () => {
            var r4, o6, u4;
            t2.text ? l5(`<span class="${om.ssrRenderClass(h2.value.text({ class: null == (r4 = a2.ui) ? void 0 : r4.text }))}"${i4}>${om.ssrInterpolate(t2.text)}</span>`) : l5("<!---->"), (null == (o6 = t2.kbds) ? void 0 : o6.length) ? (l5(`<span class="${om.ssrRenderClass(h2.value.kbds({ class: null == (u4 = a2.ui) ? void 0 : u4.kbds }))}"${i4}><!--[-->`), om.ssrRenderList(t2.kbds, (t3, r5) => {
              var o7;
              l5(om.ssrRenderComponent(d, Wt.mergeProps({ key: r5, size: (null == (o7 = a2.ui) ? void 0 : o7.kbdsSize) || h2.value.kbdsSize() }, { ref_for: true }, "string" == typeof t3 ? { value: t3 } : t3), null, n6, i4));
            }), l5("<!--]--></span>")) : l5("<!---->");
          }, l5, n6, i4), t2.arrow ? l5(om.ssrRenderComponent(Wt.unref(P), Wt.mergeProps(m2.value, { class: h2.value.arrow({ class: null == (u3 = a2.ui) ? void 0 : u3.arrow }) }), null, n6, i4)) : l5("<!---->");
        }), _: 2 }, n5, i3));
      }), _: 2 }, n4, i2));
    }), _: 3 }, l2));
  };
...
const Z = Wt.defineComponent({ __name: "TextField", __ssrInlineRender: true, props: { class: { type: String, default: "" }, modelValue: [String, Number, null], type: { type: String, default: "text", validator: (e2) => ["currency", "phone", "email", "number", "password", "strong-password", "search", "text", "url"].includes(e2) }, placeholder: String, color: { type: String, default: "primary" }, variant: { type: String, default: "outline" }, size: { type: String, default: "md" }, min: { type: Number, default: void 0 }, max: { type: Number, default: void 0 }, step: { type: Number, default: 1 }, floatingLabel: { type: Boolean, default: false }, id: String, required: Boolean, errorPattern: RegExp, uiInput: Object, classInput: String, uiInputProps: Object, uiFormField: Object, name: String, label: String, description: String, help: String, error: String, hint: String, eagerValidation: Boolean, validateOnInputDelay: Number, icon: String, validateOn: { type: String, default: "blur" }, isValidate: { type: Boolean, default: true }, isCopy: { type: Boolean, default: false }, requirements: { type: Array, default: () => [{ regex: /.{8,}/, text: "At least 8 characters" }, { regex: /\d/, text: "At least 1 number" }, { regex: /[a-z]/, text: "At least 1 lowercase letter" }, { regex: /[A-Z]/, text: "At least 1 uppercase letter" }], validator: (e2) => e2.every((e3) => e3.regex instanceof RegExp && "string" == typeof e3.text) } }, emits: ["blur", "change", "focus", "update:modelValue"], setup(t2, { expose: r2, emit: o2 }) {
  ...
  function k2(e2) {
    if ("number" === m2.type) {
      ...
      t3 !== String(m2.modelValue || "") && a2("update:modelValue", t3), n2.value && (n2.value.value = "phone" === m2.type ? $2(t3) : B2(t3));
  ...
  function C2(e2) {
    ...
    if (["currency", "phone"].includes(m2.type)) {
      ...
      if (n2.value) {
        ...
        a2("update:modelValue", l3), n2.value.value = "phone" === m2.type ? $2(l3) : B2(l3), setTimeout(() => {
          var t5;
  ...
  function R2(e2) {
    if (["currency", "phone"].includes(m2.type) && n2.value) {
      ...
      n2.value.value = "phone" === m2.type ? $2(e3) : B2(e3);
    }
  ...
  return (r3, o3, l3, a3) => {
    ...
    o3(om.ssrRenderComponent(i3, Wt.mergeProps(Wt.unref(g2), a3), Wt.createSlots({ default: Wt.withCtx((o4, l4, a4, i4) => {
      ...
      l4(om.ssrRenderComponent(f3, Wt.mergeProps({ ref_key: "inputRef", ref: n2, onBlur: R2, onChange: _2, "onUpdate:modelValue": k2, onFocus: V2, onKeypress: w2, onPaste: C2 }, Wt.unref(v2), { type: Wt.unref(y2), modelValue: Wt.unref(b2), maxlength: Wt.unref(x2), color: Wt.unref(T2), "aria-invalid": Wt.unref(q2) < 4 && "strong-password" === t2.type, "aria-describedby": "password-strength" }), Wt.createSlots({ default: Wt.withCtx((t3, r4, o5, l5) => {
        ...
        m2.floatingLabel ? r4(`<label${om.ssrRenderAttr("for", m2.id)} class="${om.ssrRenderClass([["xs" === m2.size && "peer-placeholder-shown:top-1 peer-focus:-top-2.5 peer-focus:text-xs peer-placeholder-shown:text-xs text-xs -top-2.5", "sm" === m2.size && "peer-placeholder-shown:top-1 peer-focus:-top-2.5 peer-focus:text-xs peer-placeholder-shown:text-xs text-xs -top-2.5", "md" === m2.size && "peer-placeholder-shown:top-1.5 peer-focus:-top-3 peer-focus:text-sm peer-placeholder-shown:text-sm text-sm -top-3", "lg" === m2.size && "peer-placeholder-shown:top-2 peer-focus:-top-3 peer-focus:text-md peer-placeholder-shown:text-md text-md -top-3", "xl" === m2.size && "peer-placeholder-shown:top-2 peer-focus:-top-3 peer-focus:text-md peer-placeholder-shown:text-md text-md -top-3", (null == m2 ? void 0 : m2.icon) ? "xs" === m2.size ? "px-6" : "sm" === m2.size ? "px-7" : "md" === m2.size || "lg" === m2.size ? "px-8" : "xl" === m2.size ? "px-9" : "px-1.5" : "px-1.5"], "pointer-events-none absolute left-0 text-highlighted font-medium transition-all peer-focus:text-highlighted peer-focus:font-medium peer-placeholder-shown:text-dimmed peer-placeholder-shown:font-normal"])}"${l5}><span class="inline-flex bg-default px-1"${l5}>${om.ssrInterpolate(m2.placeholder || m2.label)}</span></label>`) : r4("<!---->");
      }), _: 2 }, [r3.$slots.leading ? { name: "leading", fn: Wt.withCtx((t3, o5, l5, a5) => {
        if (!o5) return [Wt.renderSlot(r3.$slots, "leading")];
        om.ssrRenderSlot(r3.$slots, "leading", {}, null, o5, l5, a5);
      }), key: "0" } : void 0, r3.$slots.default ? { name: "default", fn: Wt.withCtx((t3, o5, l5, a5) => {
        if (!o5) return [Wt.renderSlot(r3.$slots, "default")];
        om.ssrRenderSlot(r3.$slots, "default", {}, null, o5, l5, a5);
        ...
        t2.isCopy && t2.modelValue ? l5(om.ssrRenderComponent(S3, { text: "Copy to clipboard", class: "search" === t2.type || "number" === t2.type ? "mr-4" : "", popper: { placement: "right" } }, { default: Wt.withCtx((t3, r4, o6, l6) => {
          ...
          r4(om.ssrRenderComponent($3, { color: Wt.unref(c2) ? "success" : "neutral", variant: "link", size: "sm", icon: Wt.unref(c2) ? "i-lucide-check" : "i-lucide-copy", "aria-label": "Copy to clipboard", onClick: P2, class: "bg-default" }, null, o6, l6));
        }), _: 1 }, a5, n3)) : l5("<!---->"), om.ssrRenderSlot(r3.$slots, "trailing", {}, null, l5, a5, n3), "password" === t2.type || "strong-password" === t2.type ? l5(om.ssrRenderComponent($3, { color: "neutral", variant: "link", size: "sm", icon: Wt.unref(p2) ? "i-lucide-eye-off" : "i-lucide-eye", "aria-label": Wt.unref(p2) ? "Hide password" : "Show password", "aria-pressed": Wt.unref(p2), "aria-controls": "password", onClick: O2 }, null, a5, n3)) : l5("<!---->");
      }), key: "2" } : void 0]), a4, i4)), "strong-password" === t2.type ? (l4(`<div class="mt-2 space-y-2"${i4}>`), l4(om.ssrRenderComponent(B3, { color: Wt.unref(T2), indicator: Wt.unref(I2), "model-value": Wt.unref(q2), max: 4, size: "sm" }, null, a4, i4)), l4(`<p id="password-strength" class="text-sm font-medium"${i4}>${om.ssrInterpolate(Wt.unref(I2))}. Must contain: </p><ul class="space-y-1" aria-label="Password requirements"${i4}><!--[-->`), om.ssrRenderList(Wt.unref(D2), (e2, t3) => {
        l4(`<li class="${om.ssrRenderClass([e2.met ? "text-success" : "text-muted", "flex items-center gap-0.5"])}"${i4}>`), l4(om.ssrRenderComponent(N3, { name: e2.met ? "i-lucide-circle-check" : "i-lucide-circle-x", class: "size-4 shrink-0" }, null, a4, i4)), l4(`<span class="text-xs font-light"${i4}>${om.ssrInterpolate(e2.text)} <span class="sr-only"${i4}>${om.ssrInterpolate(e2.met ? " - Requirement met" : " - Requirement not met")}</span></span></li>`);
      }), l4("<!--]--></ul></div>")) : l4("<!---->");
    }), _: 2 }, [r3.$slots.label ? { name: "label", fn: Wt.withCtx(({ label: t3 }, o4, l4, a4) => {
      if (!o4) return [Wt.renderSlot(r3.$slots, "label", { label: t3 })];
      om.ssrRenderSlot(r3.$slots, "label", { label: t3 }, null, o4, l4, a4);
    }), key: "0" } : void 0, r3.$slots.hint ? { name: "hint", fn: Wt.withCtx(({ hint: t3 }, o4, l4, a4) => {
      if (!o4) return [Wt.renderSlot(r3.$slots, "hint", { hint: t3 })];
      om.ssrRenderSlot(r3.$slots, "hint", { hint: t3 }, null, o4, l4, a4);
      ...
      om.ssrRenderSlot(r3.$slots, "default", { error: t3 }, null, o4, l4, a4);
    }), key: "5" } : void 0]), l3));
  };
} }), X = Z.setup;
Z.setup = (t2, r2) => {
...
const Y = Object.freeze(Object.defineProperty({ __proto__: null, default: Z }, Symbol.toStringTag, { value: "Module" }));

export { Y as T, Z as _, N as a };
//# sourceMappingURL=TextField-BAbDp9z3.mjs.map
