import { v as Wt, T as ym, P as xm } from './server.mjs';
import { o } from './ConfigProvider-C3zU966T.mjs';
import { E, O as O$1, S, N, k } from './useForwardPropsEmits-DnSfSOTI.mjs';
...
const y = Wt.reactive({ layersRoot: /* @__PURE__ */ new Set(), layersWithOutsidePointerEventsDisabled: /* @__PURE__ */ new Set(), branches: /* @__PURE__ */ new Set() }), h = Wt.defineComponent({ __name: "DismissableLayer", props: { disableOutsidePointerEvents: { type: Boolean, default: false }, asChild: { type: Boolean }, as: {} }, emits: ["escapeKeyDown", "pointerDownOutside", "focusOutside", "interactOutside", "dismiss"], setup(t2, { emit: o2 }) {
  ...
  }(0, s2), h2 = function(t3, n2, o3 = true) {
    var _a;
    var a3;
    (_a = null == (a3 = null == n2 ? void 0 : n2.value) ? void 0 : a3.ownerDocument) != null ? _a : null == globalThis || globalThis.document;
    const l3 = Wt.ref(false);
  ...
  return k("Escape", (e2) => {
    ...
    s2.value && (a2.disableOutsidePointerEvents && (0 === y.layersWithOutsidePointerEventsDisabled.size && (b2 = d2.value.body.style.pointerEvents, d2.value.body.style.pointerEvents = "none"), y.layersWithOutsidePointerEventsDisabled.add(s2.value)), v2.value.add(s2.value), e2(() => {
      a2.disableOutsidePointerEvents && 1 === y.layersWithOutsidePointerEventsDisabled.size && (d2.value.body.style.pointerEvents = b2);
    }));
  }), Wt.watchEffect((e2) => {
    e2(() => {
      s2.value && (v2.value.delete(s2.value), y.layersWithOutsidePointerEventsDisabled.delete(s2.value));
    });
  }), (t3, o3) => (Wt.openBlock(), Wt.createBlock(Wt.unref(xm), { ref: Wt.unref(i2), "as-child": t3.asChild, as: t3.as, "data-dismissable-layer": "", style: Wt.normalizeStyle({ pointerEvents: p2.value ? m2.value ? "auto" : "none" : void 0 }), onFocusCapture: Wt.unref(h2).onFocusCapture, onBlurCapture: Wt.unref(h2).onBlurCapture, onPointerdownCapture: Wt.unref(f2).onPointerDownCapture }, { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "default")]), _: 3 }, 8, ["as-child", "as", "style", "onFocusCapture", "onBlurCapture", "onPointerdownCapture"]));
} }), b = Wt.defineComponent({ __name: "Teleport", props: { to: { default: "body" }, disabled: { type: Boolean }, defer: { type: Boolean }, forceMount: { type: Boolean } }, setup(t2) {
  const n2 = S();
...
export { O, b, c, f, h };
//# sourceMappingURL=usePortal-DzDMWCd7.mjs.map
