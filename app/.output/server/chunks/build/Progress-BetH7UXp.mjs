import { v as Wt, u as ua, r as Mm, t as Hy, s as om, P as xm } from './server.mjs';
import { l } from './useLocale-BepRiSpk.mjs';
import { F, N, C, T } from './useForwardPropsEmits-DnSfSOTI.mjs';
...
Defaulting to \`null\`.`), null);
  ...
  return N(), (a3, i2) => {
    var _a;
    var n2;
    return Wt.openBlock(), Wt.createBlock(Wt.unref(xm), Wt.mergeProps(s2, { "data-state": Wt.unref(r2).progressState.value, "data-value": (_a = null == (n2 = Wt.unref(r2).modelValue) ? void 0 : n2.value) != null ? _a : void 0, "data-max": Wt.unref(r2).max.value }), { default: Wt.withCtx(() => [Wt.renderSlot(a3.$slots, "default")]), _: 3 }, 16, ["data-state", "data-value", "data-max"]);
  };
  ...
  const u2 = l2, c2 = o2, m2 = Wt.useSlots(), { dir: v2 } = l(), p2 = ua(), x2 = F(Mm(u2, "getValueLabel", "getValueText", "modelValue"), c2), y2 = Wt.computed(() => null === x2.value.modelValue), _2 = Wt.computed(() => Array.isArray(u2.max)), b = Wt.computed(() => {
  ...
  const k = Wt.computed(() => {
    var e2;
    return Hy({ extend: Hy(h), ...(null == (e2 = p2.ui) ? void 0 : e2.progress) || {} })({ animation: u2.animation, size: u2.size, color: u2.color, orientation: u2.orientation, inverted: u2.inverted });
  });
  return (a2, s2, r2, n2) => {
    var o3;
    s2(om.ssrRenderComponent(Wt.unref(xm), Wt.mergeProps({ as: l2.as, class: k.value.root({ class: [null == (o3 = u2.ui) ? void 0 : o3.root, u2.class] }) }, n2), { default: Wt.withCtx((t2, s3, r3, n3) => {
      var o4, d2, c3, v3, p3, h2;
      if (!s3) return [y2.value || !l2.status && !m2.status ? Wt.createCommentVNode("", true) : (Wt.openBlock(), Wt.createBlock("div", { key: 0, class: k.value.status({ class: null == (v3 = u2.ui) ? void 0 : v3.status }), style: V.value }, [Wt.renderSlot(a2.$slots, "status", { percent: w.value }, () => [Wt.createTextVNode(Wt.toDisplayString(w.value) + "% ", 1)])], 6)), Wt.createVNode(Wt.unref(f), Wt.mergeProps(Wt.unref(x2), { max: b.value, class: k.value.base({ class: null == (p3 = u2.ui) ? void 0 : p3.base }), style: { transform: "translateZ(0)" } }), { default: Wt.withCtx(() => {
        var t3;
        return [Wt.createVNode(Wt.unref(g), { class: k.value.indicator({ class: null == (t3 = u2.ui) ? void 0 : t3.indicator }), style: z.value }, null, 8, ["class", "style"])];
      }), _: 1 }, 16, ["max", "class"]), _2.value ? (Wt.openBlock(), Wt.createBlock("div", { key: 1, class: k.value.steps({ class: null == (h2 = u2.ui) ? void 0 : h2.steps }) }, [(Wt.openBlock(true), Wt.createBlock(Wt.Fragment, null, Wt.renderList(l2.max, (t3, s4) => {
        var r4;
        return Wt.openBlock(), Wt.createBlock("div", { key: s4, class: k.value.step({ class: null == (r4 = u2.ui) ? void 0 : r4.step, step: N(s4) }) }, [Wt.renderSlot(a2.$slots, `step-${s4}`, { step: t3 }, () => [Wt.createTextVNode(Wt.toDisplayString(t3), 1)])], 2);
      }), 128))], 2)) : Wt.createCommentVNode("", true)];
      y2.value || !l2.status && !m2.status ? s3("<!---->") : (s3(`<div class="${om.ssrRenderClass(k.value.status({ class: null == (o4 = u2.ui) ? void 0 : o4.status }))}" style="${om.ssrRenderStyle(V.value)}"${n3}>`), om.ssrRenderSlot(a2.$slots, "status", { percent: w.value }, () => {
        s3(`${om.ssrInterpolate(w.value)}% `);
      }, s3, r3, n3), s3("</div>")), s3(om.ssrRenderComponent(Wt.unref(f), Wt.mergeProps(Wt.unref(x2), { max: b.value, class: k.value.base({ class: null == (d2 = u2.ui) ? void 0 : d2.base }), style: { transform: "translateZ(0)" } }), { default: Wt.withCtx((t3, a3, s4, r4) => {
        var n4, l3;
        if (!a3) return [Wt.createVNode(Wt.unref(g), { class: k.value.indicator({ class: null == (l3 = u2.ui) ? void 0 : l3.indicator }), style: z.value }, null, 8, ["class", "style"])];
        a3(om.ssrRenderComponent(Wt.unref(g), { class: k.value.indicator({ class: null == (n4 = u2.ui) ? void 0 : n4.indicator }), style: z.value }, null, s4, r4));
      }), _: 1 }, r3, n3)), _2.value ? (s3(`<div class="${om.ssrRenderClass(k.value.steps({ class: null == (c3 = u2.ui) ? void 0 : c3.steps }))}"${n3}><!--[-->`), om.ssrRenderList(l2.max, (e2, t3) => {
        var l3;
        s3(`<div class="${om.ssrRenderClass(k.value.step({ class: null == (l3 = u2.ui) ? void 0 : l3.step, step: N(t3) }))}"${n3}>`), om.ssrRenderSlot(a2.$slots, `step-${t3}`, { step: e2 }, () => {
          s3(`${om.ssrInterpolate(e2)}`);
        }, s3, r3, n3), s3("</div>");
      }), s3("<!--]--></div>")) : s3("<!---->");
    }), _: 3 }, r2));
  };
...
export { y };
//# sourceMappingURL=Progress-BetH7UXp.mjs.map
