...
import { C as C$1, T, N, I } from './useForwardPropsEmits-DnSfSOTI.mjs';
import { s } from './utils-iLtTyP0t.mjs';
import { c, b as b$1, f, h as h$1 } from './usePortal-DzDMWCd7.mjs';
...
const [m, v] = T("DialogRoot"), B = Wt.defineComponent({ inheritAttrs: false, __name: "DialogRoot", props: { open: { type: Boolean, default: void 0 }, defaultOpen: { type: Boolean, default: false }, modal: { type: Boolean, default: true } }, emits: ["update:open"], setup(t2, { emit: n2 }) {
  ...
  N();
  const r2 = m();
  return (o3, a2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(xm), Wt.mergeProps(n2, { type: "button" === o3.as ? "button" : void 0, onClick: a2[0] || (a2[0] = (t2) => Wt.unref(r2).onOpenChange(false)) }), { default: Wt.withCtx(() => [Wt.renderSlot(o3.$slots, "default")]), _: 3 }, 16, ["type"]));
} });
const y = Wt.defineComponent({ __name: "DialogContentImpl", props: { forceMount: { type: Boolean }, trapFocus: { type: Boolean }, disableOutsidePointerEvents: { type: Boolean }, asChild: { type: Boolean }, as: {} }, emits: ["escapeKeyDown", "pointerDownOutside", "focusOutside", "interactOutside", "openAutoFocus", "closeAutoFocus"], setup(t2, { emit: o2 }) {
  ...
  N();
  const r2 = m();
  return (o3, a2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(xm), Wt.mergeProps(n2, { id: Wt.unref(r2).descriptionId }), { default: Wt.withCtx(() => [Wt.renderSlot(o3.$slots, "default")]), _: 3 }, 16, ["id"]));
} }), O = Wt.defineComponent({ __name: "DialogOverlayImpl", props: { asChild: { type: Boolean }, as: {} }, setup(o2) {
  const n2 = m();
  return N$1(true), N(), (o3, a2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(xm), { as: o3.as, "as-child": o3.asChild, "data-state": Wt.unref(n2).open.value ? "open" : "closed", style: { "pointer-events": "auto" } }, { default: Wt.withCtx(() => [Wt.renderSlot(o3.$slots, "default")]), _: 3 }, 8, ["as", "as-child", "data-state"]));
  ...
  const n2 = o2, r2 = m();
  return N(), (o3, a2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(xm), Wt.mergeProps(n2, { id: Wt.unref(r2).titleId }), { default: Wt.withCtx(() => [Wt.renderSlot(o3.$slots, "default")]), _: 3 }, 16, ["id"]));
  ...
  return r2.contentId || (r2.contentId = c(void 0, "reka-dialog-content")), (o3, a2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(xm), Wt.mergeProps(n2, { ref: Wt.unref(s2), type: "button" === o3.as ? "button" : void 0, "aria-haspopup": "dialog", "aria-expanded": Wt.unref(r2).open.value || false, "aria-controls": Wt.unref(r2).open.value ? Wt.unref(r2).contentId : void 0, "data-state": Wt.unref(r2).open.value ? "open" : "closed", onClick: Wt.unref(r2).onOpenToggle }), { default: Wt.withCtx(() => [Wt.renderSlot(o3.$slots, "default")]), _: 3 }, 16, ["type", "aria-expanded", "aria-controls", "data-state", "onClick"]));
  ...
  const o2 = t2;
  return (t3, n2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(b$1), Wt.normalizeProps(Wt.guardReactiveProps(o2)), { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "default")]), _: 3 }, 16));
} });

export { B, C, D, P, b, h, k, w };
//# sourceMappingURL=DialogPortal-BClYAy6o.mjs.map
