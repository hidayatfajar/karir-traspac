import { v as Wt, x as ei, s as pm, w as Qs, b as Fs, u as da, r as Bm, t as Ky, _ as Rb, P as _m } from './server.mjs';
import { u as ue, e as ee } from './Table-DtcroUFq.mjs';
import { l as l$1 } from './useLocale-BTFVrGyI.mjs';
import { F, N as N$1, C as C$1, T as T$1 } from './useForwardPropsEmits-WwvTsoLV.mjs';
import { l, r } from './useToast-DLYNyVrM.mjs';
import 'node:http';
import 'node:https';
import 'node:zlib';
import 'node:stream';
    ...
    o2(pm.ssrRenderComponent(Wt.unref(b), Wt.mergeProps(Wt.unref(v2), { class: _2.value.root({ class: [null == (u3 = i2.ui) ? void 0 : u3.root, i2.class] }) }, n3), { default: Wt.withCtx(({ page: o3, pageCount: l3 }, n4, u4, c3) => {
      ...
      if (!n4) return [Wt.createVNode(Wt.unref(B), { class: _2.value.list({ class: null == (v3 = i2.ui) ? void 0 : v3.list }) }, { default: Wt.withCtx(({ items: r2 }) => {
        ...
        return [a2.showControls || d2.first ? (Wt.openBlock(), Wt.createBlock(Wt.unref(y), { key: 0, "as-child": "", class: _2.value.first({ class: null == (n5 = i2.ui) ? void 0 : n5.first }) }, { default: Wt.withCtx(() => [Wt.renderSlot(t2.$slots, "first", {}, () => {
          var t3;
          return [Wt.createVNode(Rb, { color: a2.color, variant: a2.variant, size: a2.size, icon: g2.value, to: null == (t3 = a2.to) ? void 0 : t3.call(a2, 1) }, null, 8, ["color", "variant", "size", "icon", "to"])];
          ...
          var t3;
          return [Wt.createVNode(Rb, { color: a2.color, variant: a2.variant, size: a2.size, icon: h2.value, to: o3 > 1 ? null == (t3 = a2.to) ? void 0 : t3.call(a2, o3 - 1) : void 0 }, null, 8, ["color", "variant", "size", "icon", "to"])];
          ...
          return Wt.openBlock(), Wt.createBlock(Wt.Fragment, null, ["page" === r3.type ? (Wt.openBlock(), Wt.createBlock(Wt.unref(R), { key: n6, "as-child": "", value: r3.value, class: _2.value.item({ class: null == (u6 = i2.ui) ? void 0 : u6.item }) }, { default: Wt.withCtx(() => [Wt.renderSlot(t2.$slots, "item", Wt.mergeProps({ ref_for: true }, { item: r3, index: n6, page: o3, pageCount: l3 }), () => {
            var t3;
            return [Wt.createVNode(Rb, { color: o3 === r3.value ? a2.activeColor : a2.color, variant: o3 === r3.value ? a2.activeVariant : a2.variant, size: a2.size, label: String(r3.value), ui: { label: _2.value.label() }, to: null == (t3 = a2.to) ? void 0 : t3.call(a2, r3.value), square: "" }, null, 8, ["color", "variant", "size", "label", "ui", "to"])];
          })]), _: 2 }, 1032, ["value", "class"])) : (Wt.openBlock(), Wt.createBlock(Wt.unref(k), { key: r3.type, index: n6, "as-child": "", class: _2.value.ellipsis({ class: null == (d3 = i2.ui) ? void 0 : d3.ellipsis }) }, { default: Wt.withCtx(() => [Wt.renderSlot(t2.$slots, "ellipsis", {}, () => [Wt.createVNode(Rb, { color: a2.color, variant: a2.variant, size: a2.size, icon: a2.ellipsisIcon || Wt.unref(m2).ui.icons.ellipsis }, null, 8, ["color", "variant", "size", "icon"])])]), _: 2 }, 1032, ["index", "class"]))], 64);
          ...
          var t3;
          return [Wt.createVNode(Rb, { color: a2.color, variant: a2.variant, size: a2.size, icon: x2.value, to: o3 < l3 ? null == (t3 = a2.to) ? void 0 : t3.call(a2, o3 + 1) : void 0 }, null, 8, ["color", "variant", "size", "icon", "to"])];
          ...
          var t3;
          return [Wt.createVNode(Rb, { color: a2.color, variant: a2.variant, size: a2.size, icon: C2.value, to: null == (t3 = a2.to) ? void 0 : t3.call(a2, l3) }, null, 8, ["color", "variant", "size", "icon", "to"])];
      ...
      n4(pm.ssrRenderComponent(Wt.unref(B), { class: _2.value.list({ class: null == (p2 = i2.ui) ? void 0 : p2.list }) }, { default: Wt.withCtx(({ items: n5 }, u5, c4, p3) => {
        ...
        if (!u5) return [a2.showControls || d2.first ? (Wt.openBlock(), Wt.createBlock(Wt.unref(y), { key: 0, "as-child": "", class: _2.value.first({ class: null == (z2 = i2.ui) ? void 0 : z2.first }) }, { default: Wt.withCtx(() => [Wt.renderSlot(t2.$slots, "first", {}, () => {
          ...
          return Wt.openBlock(), Wt.createBlock(Wt.Fragment, null, ["page" === r2.type ? (Wt.openBlock(), Wt.createBlock(Wt.unref(R), { key: n6, "as-child": "", value: r2.value, class: _2.value.item({ class: null == (u6 = i2.ui) ? void 0 : u6.item }) }, { default: Wt.withCtx(() => [Wt.renderSlot(t2.$slots, "item", Wt.mergeProps({ ref_for: true }, { item: r2, index: n6, page: o3, pageCount: l3 }), () => {
            var t3;
            return [Wt.createVNode(Rb, { color: o3 === r2.value ? a2.activeColor : a2.color, variant: o3 === r2.value ? a2.activeVariant : a2.variant, size: a2.size, label: String(r2.value), ui: { label: _2.value.label() }, to: null == (t3 = a2.to) ? void 0 : t3.call(a2, r2.value), square: "" }, null, 8, ["color", "variant", "size", "label", "ui", "to"])];
        ...
        a2.showControls || d2.first ? u5(pm.ssrRenderComponent(Wt.unref(y), { "as-child": "", class: _2.value.first({ class: null == (v4 = i2.ui) ? void 0 : v4.first }) }, { default: Wt.withCtx((o4, l4, n6, i3) => {
          ...
          pm.ssrRenderSlot(t2.$slots, "first", {}, () => {
            var e2;
            l4(pm.ssrRenderComponent(Rb, { color: a2.color, variant: a2.variant, size: a2.size, icon: g2.value, to: null == (e2 = a2.to) ? void 0 : e2.call(a2, 1) }, null, n6, i3));
          }, l4, n6, i3);
          ...
          pm.ssrRenderSlot(t2.$slots, "prev", {}, () => {
            var e2;
            n6(pm.ssrRenderComponent(Rb, { color: a2.color, variant: a2.variant, size: a2.size, icon: h2.value, to: o3 > 1 ? null == (e2 = a2.to) ? void 0 : e2.call(a2, o3 - 1) : void 0 }, null, i3, u6));
          }, n6, i3, u6);
          ...
          u5("<!--[-->"), "page" === n6.type ? u5(pm.ssrRenderComponent(Wt.unref(R), { key: d3, "as-child": "", value: n6.value, class: _2.value.item({ class: null == (v5 = i2.ui) ? void 0 : v5.item }) }, { default: Wt.withCtx((i3, u6, c5, p4) => {
            if (!u6) return [Wt.renderSlot(t2.$slots, "item", Wt.mergeProps({ ref_for: true }, { item: n6, index: d3, page: o3, pageCount: l3 }), () => {
              var t3;
              return [Wt.createVNode(Rb, { color: o3 === n6.value ? a2.activeColor : a2.color, variant: o3 === n6.value ? a2.activeVariant : a2.variant, size: a2.size, label: String(n6.value), ui: { label: _2.value.label() }, to: null == (t3 = a2.to) ? void 0 : t3.call(a2, n6.value), square: "" }, null, 8, ["color", "variant", "size", "label", "ui", "to"])];
            })];
            pm.ssrRenderSlot(t2.$slots, "item", Wt.mergeProps({ ref_for: true }, { item: n6, index: d3, page: o3, pageCount: l3 }), () => {
              var e2;
              u6(pm.ssrRenderComponent(Rb, { color: o3 === n6.value ? a2.activeColor : a2.color, variant: o3 === n6.value ? a2.activeVariant : a2.variant, size: a2.size, label: String(n6.value), ui: { label: _2.value.label() }, to: null == (e2 = a2.to) ? void 0 : e2.call(a2, n6.value), square: "" }, null, c5, p4));
            }, u6, c5, p4);
            ...
            if (!l4) return [Wt.renderSlot(t2.$slots, "ellipsis", {}, () => [Wt.createVNode(Rb, { color: a2.color, variant: a2.variant, size: a2.size, icon: a2.ellipsisIcon || Wt.unref(m2).ui.icons.ellipsis }, null, 8, ["color", "variant", "size", "icon"])])];
            pm.ssrRenderSlot(t2.$slots, "ellipsis", {}, () => {
              l4(pm.ssrRenderComponent(Rb, { color: a2.color, variant: a2.variant, size: a2.size, icon: a2.ellipsisIcon || Wt.unref(m2).ui.icons.ellipsis }, null, n7, i3));
            }, l4, n7, i3);
          }), _: 2 }, c4, p3)), u5("<!--]-->");
          ...
          pm.ssrRenderSlot(t2.$slots, "next", {}, () => {
            var e2;
            i3(pm.ssrRenderComponent(Rb, { color: a2.color, variant: a2.variant, size: a2.size, icon: x2.value, to: o3 < l3 ? null == (e2 = a2.to) ? void 0 : e2.call(a2, o3 + 1) : void 0 }, null, u6, d3));
          }, i3, u6, d3);
          ...
          pm.ssrRenderSlot(t2.$slots, "last", {}, () => {
            var e2;
            n6(pm.ssrRenderComponent(Rb, { color: a2.color, variant: a2.variant, size: a2.size, icon: C2.value, to: null == (e2 = a2.to) ? void 0 : e2.call(a2, l3) }, null, i3, u6));
          }, n6, i3, u6);
        }), _: 2 }, c4, p3)) : u5("<!---->");
      }), _: 2 }, u4, c3));
    }), _: 3 }, l2));
...
export { M as default };
//# sourceMappingURL=index-CKBH39lz.mjs.map
