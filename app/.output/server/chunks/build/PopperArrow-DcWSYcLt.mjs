...
import { N as N$1, T as T$1, n } from './useForwardPropsEmits-WwvTsoLV.mjs';
...
function ne(e2, t2, n2) {
  ...
  if (i2) {
    const e3 = oe(a2);
    return t2.concat(a2, a2.visualViewport || [], Y(r2) ? r2 : [], e3 && n2 ? ne(e3) : []);
  }
...
const ye = { convertOffsetParentRelativeRectToViewportRelativeRect: function(e2) {
  ...
  const i2 = [..."clippingAncestors" === n2 ? j(t2) ? [] : function(e3, t3) {
    ...
    for (; M(); ) {
      ...
      n4 || "fixed" !== t4.position || (r3 = null), (i3 ? !n4 && !r3 : !n4 && "static" === t4.position && r3 && de.has(r3.position) || Y(a2) && !n4 && he(e3)) ? o3 = o3.filter((e4) => e4 !== a2) : r3 = t4, a2 = ee(a2);
    }
...
const [Le, Te] = T$1("PopperRoot"), $e = Wt.defineComponent({ inheritAttrs: false, __name: "PopperRoot", setup(t2) {
  ...
  }), (n3, o2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(_m), { ref: Wt.unref(i2), as: n3.as, "as-child": n3.asChild }, { default: Wt.withCtx(() => [Wt.renderSlot(n3.$slots, "default")]), _: 3 }, 8, ["as", "as-child"]));
...
const Ye = { side: "bottom", sideOffset: 0, align: "center", alignOffset: 0, arrowPadding: 0, avoidCollisions: true, collisionBoundary: () => [], collisionPadding: 0, sticky: "partial", hideWhenDetached: false, positionStrategy: "fixed", updatePositionStrategy: "optimized", prioritizePosition: false }, [Xe, je] = T$1("PopperContent"), Ie = Wt.defineComponent({ inheritAttrs: false, __name: "PopperContent", props: Wt.mergeDefaults({ side: {}, sideOffset: {}, align: {}, alignOffset: {}, avoidCollisions: { type: Boolean }, collisionBoundary: {}, collisionPadding: {}, arrowPadding: {}, sticky: {}, hideWhenDetached: { type: Boolean }, positionStrategy: {}, updatePositionStrategy: {}, disableUpdateOnLayoutShift: { type: Boolean }, prioritizePosition: { type: Boolean }, reference: {}, asChild: { type: Boolean }, as: {} }, { ...Ye }), emits: ["placed"], setup(n2, { emit: i2 }) {
  ...
  const { forwardRef: n2 } = N$1(), r2 = Xe(), i2 = Wt.computed(() => Ne[r2.placedSide.value]);
  return (t3, o2) => {
    var a2, l2, s2, c2;
...
export { $e as $, He as H, Ie as I, Ye as Y, qe as q };
//# sourceMappingURL=PopperArrow-DcWSYcLt.mjs.map
