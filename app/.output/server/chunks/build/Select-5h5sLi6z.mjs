import { v as Wt, u as da, r as Bm, e as sg, i as Am, j as Pm, t as Ky, y as yg, s as pm, b as gb, d as _b, g as fg, A as Sb, P as _m, z as gg, a as Tm } from './server.mjs';
import { l as defu, j as isEqual } from '../_/nitro.mjs';
import { i, s, u as u$1 } from './usePortal-B0EwXMSu.mjs';
import { F, C, T, N, O, P } from './useForwardPropsEmits-nQnKVeqj.mjs';
import { $ as $e, H as He, N as Ne, j as je } from './PopperArrow-DHFd-Rdx.mjs';
import { d } from './VisuallyHidden-CudQpOEQ.mjs';
import { n as n$1, a } from './Collection-B86A2tPF.mjs';
import { e } from './useDirection-D0ypspbM.mjs';
import { n } from './nullish-aV-w2MPu.mjs';
import { u, c } from './Presence-D-YonBfP.mjs';
import { n as n$2, a as a$1 } from './useTypeahead-BwB5DMSn.mjs';
import { n as n$3 } from './utils-6y4URocx.mjs';
import { N as N$1, T as T$1, E } from './useBodyScrollLock-DClI9ev0.mjs';
...
function X(e2, l2, t2) {
  return void 0 !== e2 && (Array.isArray(e2) ? e2.some((e3) => Z(e3, l2, t2)) : Z(e2, l2, t2));
}
function Z(e2, l2, t2) {
...
const Q = Wt.defineComponent({ __name: "BubbleSelect", props: { autocomplete: {}, autofocus: { type: Boolean }, disabled: { type: Boolean }, form: {}, multiple: { type: Boolean }, name: {}, required: { type: Boolean }, size: {}, value: {} }, setup(l2) {
  ...
  n$1({ isProvider: true });
  const g2 = e(s2), f2 = a(c2), h2 = Wt.ref(/* @__PURE__ */ new Set()), y2 = Wt.computed(() => Array.from(h2.value).map((e2) => e2.value).join(";"));
  ...
  const i2 = t2, n2 = a2, { getItems: o2 } = n$1(), r2 = le(), s2 = ue(), u2 = Wt.ref(false), d2 = Wt.ref(true), c2 = Wt.ref(), { forwardRef: p2, currentElement: v2 } = N(), { viewport: m2, selectedItem: g2, selectedItemText: f2, focusSelectedItem: h2 } = s2;
  function y2() {
  ...
  const a2 = Tm(l2);
  return (l3, t2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(je), Wt.mergeProps(Wt.unref(a2), { style: { boxSizing: "border-box", "--reka-select-content-transform-origin": "var(--reka-popper-transform-origin)", "--reka-select-content-available-width": "var(--reka-popper-available-width)", "--reka-select-content-available-height": "var(--reka-popper-available-height)", "--reka-select-trigger-width": "var(--reka-popper-anchor-width)", "--reka-select-trigger-height": "var(--reka-popper-anchor-height)" } }), { default: Wt.withCtx(() => [Wt.renderSlot(l3.$slots, "default")]), _: 3 }, 16));
} }), se = { onViewportChange: () => {
}, itemTextRefCallback: () => {
}, itemRefCallback: () => {
  ...
  t(), N$1(i2.bodyLock);
  const { CollectionSlot: r2, getItems: s2 } = n$1(), u2 = Wt.ref();
  T$1(u2);
  const { search: d2, handleTypeaheadSearch: c2 } = n$2(), p2 = Wt.ref(), v2 = Wt.ref(), m2 = Wt.ref(), g2 = Wt.ref(false), f2 = Wt.ref(false), y2 = Wt.ref(false);
  function k2() {
    v2.value && u2.value && n$3([v2.value, u2.value]);
  }
  Wt.watch(g2, () => {
    k2();
  });
  ...
  function B2(e2) {
    ...
    if ("Tab" === e2.key && e2.preventDefault(), l3 || 1 !== e2.key.length || c2(e2.key, s2()), ["ArrowUp", "ArrowDown", "Home", "End"].includes(e2.key)) {
      ...
      setTimeout(() => n$3(l4)), e2.preventDefault();
    }
  }
  Wt.watchEffect((e2) => {
    if (!u2.value) return;
  ...
  const C2 = Wt.computed(() => "popper" === i2.position ? i2 : {}), L2 = Tm(C2.value);
  ...
  }) }, { default: Wt.withCtx(() => [Wt.createVNode(Wt.unref(u$1), { "as-child": "", "disable-outside-pointer-events": "", onFocusOutside: t2[2] || (t2[2] = Wt.withModifiers(() => {
  }, ["prevent"])), onDismiss: t2[3] || (t2[3] = (l4) => Wt.unref(o2).onOpenChange(false)), onEscapeKeyDown: t2[4] || (t2[4] = (e2) => n2("escapeKeyDown", e2)), onPointerDownOutside: t2[5] || (t2[5] = (e2) => n2("pointerDownOutside", e2)) }, { default: Wt.withCtx(() => [(Wt.openBlock(), Wt.createBlock(Wt.resolveDynamicComponent("popper" === l3.position ? re : oe), Wt.mergeProps({ ...l3.$attrs, ...Wt.unref(L2) }, { id: Wt.unref(o2).contentId, ref: (l4) => {
    u2.value = Wt.unref(O)(l4);
  ...
  return (l3, n2) => Wt.unref(a2).open.value && "popper" === Wt.unref(i2).position ? (Wt.openBlock(), Wt.createBlock(Wt.unref(Ne), Wt.normalizeProps(Wt.mergeProps({ key: 0 }, t2)), { default: Wt.withCtx(() => [Wt.renderSlot(l3.$slots, "default")]), _: 3 }, 16)) : Wt.createCommentVNode("", true);
  ...
  var _a;
  const i2 = t2, n2 = a2, { disabled: o2 } = Wt.toRefs(i2), r2 = le(), s2 = ue(), { forwardRef: u2 } = N(), { CollectionItem: d2 } = n$1(), c2 = Wt.computed(() => {
    var e2;
    return X(null == (e2 = r2.modelValue) ? void 0 : e2.value, i2.value, r2.by);
  }), p2 = Wt.ref(false), v2 = Wt.ref((_a = i2.textValue) != null ? _a : ""), m2 = u(void 0, "reka-select-item-text");
  async function g2(e2) {
    if (e2.defaultPrevented) return;
    const l2 = { originalEvent: e2, value: i2.value };
    a$1("select.select", f2, l2);
  }
  ...
  async function y2(l2) {
    var t3;
    await Wt.nextTick(), l2.defaultPrevented || l2.currentTarget === l() && (null == (t3 = s2.onItemLeave) || t3.call(s2));
  }
  async function k2(l2) {
    var t3;
  ...
  }, ["prevent", "stop"])), onPointermove: h2, onPointerleave: y2, onKeydown: k2 }, { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "default")]), _: 3 }, 8, ["aria-labelledby", "data-highlighted", "aria-selected", "data-state", "aria-disabled", "data-disabled", "tabindex", "as", "as-child"])]), _: 3 }, 8, ["value"]));
  ...
  const t2 = l2;
  return (l3, a2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(s), Wt.normalizeProps(Wt.guardReactiveProps(t2)), { default: Wt.withCtx(() => [Wt.renderSlot(l3.$slots, "default")]), _: 3 }, 16));
  ...
  i2.contentId || (i2.contentId = u(void 0, "reka-select-content"));
  const { getItems: r2 } = n$1(), { search: s2, handleTypeaheadSearch: u2, resetTypeahead: d2 } = n$2();
  function c2() {
  ...
  return (t3, a3) => (Wt.openBlock(), Wt.createBlock(Wt.unref(He), { "as-child": "", reference: t3.reference }, { default: Wt.withCtx(() => {
    var d3, v2, m2, g2;
    return [Wt.createVNode(Wt.unref(_m), { ref: Wt.unref(n2), role: "combobox", type: "button" === t3.as ? "button" : void 0, "aria-controls": Wt.unref(i2).contentId, "aria-expanded": Wt.unref(i2).open.value || false, "aria-required": null == (d3 = Wt.unref(i2).required) ? void 0 : d3.value, "aria-autocomplete": "none", disabled: o2.value, dir: null == (v2 = Wt.unref(i2)) ? void 0 : v2.dir.value, "data-state": (null == (m2 = Wt.unref(i2)) ? void 0 : m2.open.value) ? "open" : "closed", "data-disabled": o2.value ? "" : void 0, "data-placeholder": Wt.unref(J)(null == (g2 = Wt.unref(i2).modelValue) ? void 0 : g2.value) ? "" : void 0, "as-child": t3.asChild, as: t3.as, onClick: a3[0] || (a3[0] = (e2) => {
      var l2;
  ...
  const y2 = l2, b2 = h2, x2 = Wt.useSlots(), B2 = da(), C2 = F(Bm(y2, "open", "defaultOpen", "disabled", "autocomplete", "required", "multiple"), b2), S2 = i(Wt.toRef(() => y2.portal)), w2 = Wt.toRef(() => defu(y2.content, { side: "bottom", sideOffset: 8, collisionPadding: 8, position: "popper" })), I2 = Wt.toRef(() => y2.arrow), { emitFormChange: z2, emitFormInput: _2, emitFormBlur: V2, emitFormFocus: A2, size: T2, color: $2, id: P2, name: N2, highlight: R2, disabled: D2, ariaAttrs: E2 } = sg(y2), { orientation: q2, size: K2 } = Am(y2), { isLeading: F2, isTrailing: O2, leadingIconName: j2, trailingIconName: M2 } = Pm(Wt.toRef(() => defu(y2, { trailingIcon: B2.ui.icons.chevronDown }))), W2 = Wt.computed(() => K2.value || T2.value), H2 = Wt.computed(() => {
    var e2;
    return Ky({ extend: Ky(ze), ...(null == (e2 = B2.ui) ? void 0 : e2.select) || {} })({ color: $2.value, variant: y2.variant, size: null == W2 ? void 0 : W2.value, loading: y2.loading, highlight: R2.value, leading: F2.value || !!y2.avatar || !!x2.leading, trailing: O2.value || !!x2.trailing, buttonGroup: q2.value });
  }), U2 = Wt.computed(() => {
    var e2;
  ...
  return t2({ triggerRef: X2 }), (t3, a2, i2, n2) => {
    a2(pm.ssrRenderComponent(Wt.unref(ae), Wt.mergeProps({ name: Wt.unref(N2) }, Wt.unref(C2), { autocomplete: l2.autocomplete, disabled: Wt.unref(D2), "default-value": l2.defaultValue, "model-value": l2.modelValue, "onUpdate:modelValue": Z2, "onUpdate:open": J2 }, n2), { default: Wt.withCtx(({ modelValue: a3, open: i3 }, n3, o2, r2) => {
      var s2, u2;
      if (!n3) return [Wt.createVNode(Wt.unref(Ie), Wt.mergeProps({ id: Wt.unref(P2), ref_key: "triggerRef", ref: X2, class: H2.value.base({ class: [null == (u2 = y2.ui) ? void 0 : u2.base, y2.class] }) }, { ...t3.$attrs, ...Wt.unref(E2) }), { default: Wt.withCtx(() => {
        var n4, o3;
        return [Wt.unref(F2) || l2.avatar || x2.leading ? (Wt.openBlock(), Wt.createBlock("span", { key: 0, class: H2.value.leading({ class: null == (n4 = y2.ui) ? void 0 : n4.leading }) }, [Wt.renderSlot(t3.$slots, "leading", { modelValue: a3, open: i3, ui: H2.value }, () => {
          var t4, a4, i4;
          return [Wt.unref(F2) && Wt.unref(j2) ? (Wt.openBlock(), Wt.createBlock(gb, { key: 0, name: Wt.unref(j2), class: H2.value.leadingIcon({ class: null == (t4 = y2.ui) ? void 0 : t4.leadingIcon }) }, null, 8, ["name", "class"])) : l2.avatar ? (Wt.openBlock(), Wt.createBlock(_b, Wt.mergeProps({ key: 1, size: (null == (a4 = y2.ui) ? void 0 : a4.itemLeadingAvatarSize) || H2.value.itemLeadingAvatarSize() }, l2.avatar, { class: H2.value.itemLeadingAvatar({ class: null == (i4 = y2.ui) ? void 0 : i4.itemLeadingAvatar }) }), null, 16, ["size", "class"])) : Wt.createCommentVNode("", true)];
        ...
        }), 128))]), Wt.unref(O2) || x2.trailing ? (Wt.openBlock(), Wt.createBlock("span", { key: 1, class: H2.value.trailing({ class: null == (o3 = y2.ui) ? void 0 : o3.trailing }) }, [Wt.renderSlot(t3.$slots, "trailing", { modelValue: a3, open: i3, ui: H2.value }, () => {
          var l3;
          return [Wt.unref(M2) ? (Wt.openBlock(), Wt.createBlock(gb, { key: 0, name: Wt.unref(M2), class: H2.value.trailingIcon({ class: null == (l3 = y2.ui) ? void 0 : l3.trailingIcon }) }, null, 8, ["name", "class"])) : Wt.createCommentVNode("", true)];
        })], 2)) : Wt.createCommentVNode("", true)];
      }), _: 2 }, 1040, ["id", "class"]), Wt.createVNode(Wt.unref(Le), Wt.unref(S2), { default: Wt.withCtx(() => {
        var a4;
        return [Wt.createVNode(Wt.unref(ge), Wt.mergeProps({ class: H2.value.content({ class: null == (a4 = y2.ui) ? void 0 : a4.content }) }, w2.value), { default: Wt.withCtx(() => {
          var a5, i4;
          return [Wt.renderSlot(t3.$slots, "content-top"), Wt.createVNode("div", { role: "presentation", class: H2.value.viewport({ class: null == (a5 = y2.ui) ? void 0 : a5.viewport }) }, [(Wt.openBlock(true), Wt.createBlock(Wt.Fragment, null, Wt.renderList(U2.value, (a6, i5) => {
            ...
            return Wt.openBlock(), Wt.createBlock(Wt.unref(ye), { key: `group-${i5}`, class: H2.value.group({ class: null == (n4 = y2.ui) ? void 0 : n4.group }) }, { default: Wt.withCtx(() => [(Wt.openBlock(true), Wt.createBlock(Wt.Fragment, null, Wt.renderList(a6, (a7, n5) => {
              ...
              return Wt.openBlock(), Wt.createBlock(Wt.Fragment, { key: `group-${i5}-${n5}` }, [Q2(a7) && "label" === a7.type ? (Wt.openBlock(), Wt.createBlock(Wt.unref(Se), { key: 0, class: H2.value.label({ class: [null == (o3 = y2.ui) ? void 0 : o3.label, null == (r3 = a7.ui) ? void 0 : r3.label, a7.class] }) }, { default: Wt.withCtx(() => [Wt.createTextVNode(Wt.toDisplayString(Wt.unref(fg)(a7, y2.labelKey)), 1)]), _: 2 }, 1032, ["class"])) : Q2(a7) && "separator" === a7.type ? (Wt.openBlock(), Wt.createBlock(Wt.unref(we), { key: 1, class: H2.value.separator({ class: [null == (s3 = y2.ui) ? void 0 : s3.separator, null == (u3 = a7.ui) ? void 0 : u3.separator, a7.class] }) }, null, 8, ["class"])) : (Wt.openBlock(), Wt.createBlock(Wt.unref(xe), { key: 2, class: H2.value.item({ class: [null == (d2 = y2.ui) ? void 0 : d2.item, Q2(a7) && (null == (g2 = a7.ui) ? void 0 : g2.item), Q2(a7) && a7.class] }), disabled: Q2(a7) && a7.disabled, value: Q2(a7) ? Wt.unref(fg)(a7, y2.valueKey) : a7, onSelect: (e2) => {
                var l3;
                return Q2(a7) && (null == (l3 = a7.onSelect) ? void 0 : l3.call(a7, e2));
                ...
                return [Wt.renderSlot(t3.$slots, "item-leading", { item: a7, index: n5 }, () => {
                  ...
                  return [Q2(a7) && a7.icon ? (Wt.openBlock(), Wt.createBlock(gb, { key: 0, name: a7.icon, class: H2.value.itemLeadingIcon({ class: [null == (l3 = y2.ui) ? void 0 : l3.itemLeadingIcon, null == (t4 = a7.ui) ? void 0 : t4.itemLeadingIcon] }) }, null, 8, ["name", "class"])) : Q2(a7) && a7.avatar ? (Wt.openBlock(), Wt.createBlock(_b, Wt.mergeProps({ key: 1, size: (null == (i7 = a7.ui) ? void 0 : i7.itemLeadingAvatarSize) || (null == (n6 = y2.ui) ? void 0 : n6.itemLeadingAvatarSize) || H2.value.itemLeadingAvatarSize() }, { ref_for: true }, a7.avatar, { class: H2.value.itemLeadingAvatar({ class: [null == (o5 = y2.ui) ? void 0 : o5.itemLeadingAvatar, null == (r5 = a7.ui) ? void 0 : r5.itemLeadingAvatar] }) }), null, 16, ["size", "class"])) : Q2(a7) && a7.chip ? (Wt.openBlock(), Wt.createBlock(Sb, Wt.mergeProps({ key: 2, size: (null == (s5 = a7.ui) ? void 0 : s5.itemLeadingChipSize) || (null == (u4 = y2.ui) ? void 0 : u4.itemLeadingChipSize) || H2.value.itemLeadingChipSize(), inset: "", standalone: "" }, { ref_for: true }, a7.chip, { class: H2.value.itemLeadingChip({ class: [null == (d3 = y2.ui) ? void 0 : d3.itemLeadingChip, null == (v2 = a7.ui) ? void 0 : v2.itemLeadingChip] }) }), null, 16, ["size", "class"])) : Wt.createCommentVNode("", true)];
                }), Wt.createVNode(Wt.unref(Ce), { class: H2.value.itemLabel({ class: [null == (i6 = y2.ui) ? void 0 : i6.itemLabel, Q2(a7) && (null == (o4 = a7.ui) ? void 0 : o4.itemLabel)] }) }, { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "item-label", { item: a7, index: n5 }, () => [Wt.createTextVNode(Wt.toDisplayString(Q2(a7) ? Wt.unref(fg)(a7, y2.labelKey) : a7), 1)])]), _: 2 }, 1032, ["class"]), Wt.createVNode("span", { class: H2.value.itemTrailing({ class: [null == (r4 = y2.ui) ? void 0 : r4.itemTrailing, Q2(a7) && (null == (s4 = a7.ui) ? void 0 : s4.itemTrailing)] }) }, [Wt.renderSlot(t3.$slots, "item-trailing", { item: a7, index: n5 }), Wt.createVNode(Wt.unref(Be), { "as-child": "" }, { default: Wt.withCtx(() => {
                  var t4, i7;
                  return [Wt.createVNode(gb, { name: l2.selectedIcon || Wt.unref(B2).ui.icons.check, class: H2.value.itemTrailingIcon({ class: [null == (t4 = y2.ui) ? void 0 : t4.itemTrailingIcon, Q2(a7) && (null == (i7 = a7.ui) ? void 0 : i7.itemTrailingIcon)] }) }, null, 8, ["name", "class"])];
                }), _: 2 }, 1024)], 2)];
              })]), _: 2 }, 1032, ["class", "disabled", "value", "onSelect"]))], 64);
            }), 128))]), _: 2 }, 1032, ["class"]);
          }), 128))], 2), Wt.renderSlot(t3.$slots, "content-bottom"), l2.arrow ? (Wt.openBlock(), Wt.createBlock(Wt.unref(pe), Wt.mergeProps({ key: 0 }, I2.value, { class: H2.value.arrow({ class: null == (i4 = y2.ui) ? void 0 : i4.arrow }) }), null, 16, ["class"])) : Wt.createCommentVNode("", true)];
        }), _: 3 }, 16, ["class"])];
      }), _: 3 }, 16)];
      n3(pm.ssrRenderComponent(Wt.unref(Ie), Wt.mergeProps({ id: Wt.unref(P2), ref_key: "triggerRef", ref: X2, class: H2.value.base({ class: [null == (s2 = y2.ui) ? void 0 : s2.base, y2.class] }) }, { ...t3.$attrs, ...Wt.unref(E2) }), { default: Wt.withCtx((n4, o3, r3, s3) => {
        var u3, v2, m2, g2;
        if (!o3) return [Wt.unref(F2) || l2.avatar || x2.leading ? (Wt.openBlock(), Wt.createBlock("span", { key: 0, class: H2.value.leading({ class: null == (m2 = y2.ui) ? void 0 : m2.leading }) }, [Wt.renderSlot(t3.$slots, "leading", { modelValue: a3, open: i3, ui: H2.value }, () => {
          var t4, a4, i4;
          return [Wt.unref(F2) && Wt.unref(j2) ? (Wt.openBlock(), Wt.createBlock(gb, { key: 0, name: Wt.unref(j2), class: H2.value.leadingIcon({ class: null == (t4 = y2.ui) ? void 0 : t4.leadingIcon }) }, null, 8, ["name", "class"])) : l2.avatar ? (Wt.openBlock(), Wt.createBlock(_b, Wt.mergeProps({ key: 1, size: (null == (a4 = y2.ui) ? void 0 : a4.itemLeadingAvatarSize) || H2.value.itemLeadingAvatarSize() }, l2.avatar, { class: H2.value.itemLeadingAvatar({ class: null == (i4 = y2.ui) ? void 0 : i4.itemLeadingAvatar }) }), null, 16, ["size", "class"])) : Wt.createCommentVNode("", true)];
        })], 2)) : Wt.createCommentVNode("", true), Wt.renderSlot(t3.$slots, "default", { modelValue: a3, open: i3 }, () => [(Wt.openBlock(true), Wt.createBlock(Wt.Fragment, null, Wt.renderList([Y2(a3)], (t4) => {
          var _a;
          var a4, i4;
          return Wt.openBlock(), Wt.createBlock(Wt.Fragment, { key: t4 }, [null != t4 ? (Wt.openBlock(), Wt.createBlock("span", { key: 0, class: H2.value.value({ class: null == (a4 = y2.ui) ? void 0 : a4.value }) }, Wt.toDisplayString(t4), 3)) : (Wt.openBlock(), Wt.createBlock("span", { key: 1, class: H2.value.placeholder({ class: null == (i4 = y2.ui) ? void 0 : i4.placeholder }) }, Wt.toDisplayString((_a = l2.placeholder) != null ? _a : "\xA0"), 3))], 64);
        }), 128))]), Wt.unref(O2) || x2.trailing ? (Wt.openBlock(), Wt.createBlock("span", { key: 1, class: H2.value.trailing({ class: null == (g2 = y2.ui) ? void 0 : g2.trailing }) }, [Wt.renderSlot(t3.$slots, "trailing", { modelValue: a3, open: i3, ui: H2.value }, () => {
          var l3;
          return [Wt.unref(M2) ? (Wt.openBlock(), Wt.createBlock(gb, { key: 0, name: Wt.unref(M2), class: H2.value.trailingIcon({ class: null == (l3 = y2.ui) ? void 0 : l3.trailingIcon }) }, null, 8, ["name", "class"])) : Wt.createCommentVNode("", true)];
        })], 2)) : Wt.createCommentVNode("", true)];
        Wt.unref(F2) || l2.avatar || x2.leading ? (o3(`<span class="${pm.ssrRenderClass(H2.value.leading({ class: null == (u3 = y2.ui) ? void 0 : u3.leading }))}"${s3}>`), pm.ssrRenderSlot(t3.$slots, "leading", { modelValue: a3, open: i3, ui: H2.value }, () => {
          var t4, a4, i4;
          Wt.unref(F2) && Wt.unref(j2) ? o3(pm.ssrRenderComponent(gb, { name: Wt.unref(j2), class: H2.value.leadingIcon({ class: null == (t4 = y2.ui) ? void 0 : t4.leadingIcon }) }, null, r3, s3)) : l2.avatar ? o3(pm.ssrRenderComponent(_b, Wt.mergeProps({ size: (null == (a4 = y2.ui) ? void 0 : a4.itemLeadingAvatarSize) || H2.value.itemLeadingAvatarSize() }, l2.avatar, { class: H2.value.itemLeadingAvatar({ class: null == (i4 = y2.ui) ? void 0 : i4.itemLeadingAvatar }) }), null, r3, s3)) : o3("<!---->");
        ...
        }, o3, r3, s3), Wt.unref(O2) || x2.trailing ? (o3(`<span class="${pm.ssrRenderClass(H2.value.trailing({ class: null == (v2 = y2.ui) ? void 0 : v2.trailing }))}"${s3}>`), pm.ssrRenderSlot(t3.$slots, "trailing", { modelValue: a3, open: i3, ui: H2.value }, () => {
          var l3;
          Wt.unref(M2) ? o3(pm.ssrRenderComponent(gb, { name: Wt.unref(M2), class: H2.value.trailingIcon({ class: null == (l3 = y2.ui) ? void 0 : l3.trailingIcon }) }, null, r3, s3)) : o3("<!---->");
        }, o3, r3, s3), o3("</span>")) : o3("<!---->");
      }), _: 2 }, o2, r2)), n3(pm.ssrRenderComponent(Wt.unref(Le), Wt.unref(S2), { default: Wt.withCtx((a4, i4, n4, o3) => {
        var r3, s3;
        if (!i4) return [Wt.createVNode(Wt.unref(ge), Wt.mergeProps({ class: H2.value.content({ class: null == (s3 = y2.ui) ? void 0 : s3.content }) }, w2.value), { default: Wt.withCtx(() => {
          var a5, i5;
          return [Wt.renderSlot(t3.$slots, "content-top"), Wt.createVNode("div", { role: "presentation", class: H2.value.viewport({ class: null == (a5 = y2.ui) ? void 0 : a5.viewport }) }, [(Wt.openBlock(true), Wt.createBlock(Wt.Fragment, null, Wt.renderList(U2.value, (a6, i6) => {
            ...
            return Wt.openBlock(), Wt.createBlock(Wt.unref(ye), { key: `group-${i6}`, class: H2.value.group({ class: null == (n5 = y2.ui) ? void 0 : n5.group }) }, { default: Wt.withCtx(() => [(Wt.openBlock(true), Wt.createBlock(Wt.Fragment, null, Wt.renderList(a6, (a7, n6) => {
              ...
              return Wt.openBlock(), Wt.createBlock(Wt.Fragment, { key: `group-${i6}-${n6}` }, [Q2(a7) && "label" === a7.type ? (Wt.openBlock(), Wt.createBlock(Wt.unref(Se), { key: 0, class: H2.value.label({ class: [null == (o4 = y2.ui) ? void 0 : o4.label, null == (r4 = a7.ui) ? void 0 : r4.label, a7.class] }) }, { default: Wt.withCtx(() => [Wt.createTextVNode(Wt.toDisplayString(Wt.unref(fg)(a7, y2.labelKey)), 1)]), _: 2 }, 1032, ["class"])) : Q2(a7) && "separator" === a7.type ? (Wt.openBlock(), Wt.createBlock(Wt.unref(we), { key: 1, class: H2.value.separator({ class: [null == (s4 = y2.ui) ? void 0 : s4.separator, null == (u3 = a7.ui) ? void 0 : u3.separator, a7.class] }) }, null, 8, ["class"])) : (Wt.openBlock(), Wt.createBlock(Wt.unref(xe), { key: 2, class: H2.value.item({ class: [null == (d2 = y2.ui) ? void 0 : d2.item, Q2(a7) && (null == (g2 = a7.ui) ? void 0 : g2.item), Q2(a7) && a7.class] }), disabled: Q2(a7) && a7.disabled, value: Q2(a7) ? Wt.unref(fg)(a7, y2.valueKey) : a7, onSelect: (e2) => {
                var l3;
                return Q2(a7) && (null == (l3 = a7.onSelect) ? void 0 : l3.call(a7, e2));
                ...
                return [Wt.renderSlot(t3.$slots, "item-leading", { item: a7, index: n6 }, () => {
                  ...
                  return [Q2(a7) && a7.icon ? (Wt.openBlock(), Wt.createBlock(gb, { key: 0, name: a7.icon, class: H2.value.itemLeadingIcon({ class: [null == (l3 = y2.ui) ? void 0 : l3.itemLeadingIcon, null == (t4 = a7.ui) ? void 0 : t4.itemLeadingIcon] }) }, null, 8, ["name", "class"])) : Q2(a7) && a7.avatar ? (Wt.openBlock(), Wt.createBlock(_b, Wt.mergeProps({ key: 1, size: (null == (i8 = a7.ui) ? void 0 : i8.itemLeadingAvatarSize) || (null == (n7 = y2.ui) ? void 0 : n7.itemLeadingAvatarSize) || H2.value.itemLeadingAvatarSize() }, { ref_for: true }, a7.avatar, { class: H2.value.itemLeadingAvatar({ class: [null == (o6 = y2.ui) ? void 0 : o6.itemLeadingAvatar, null == (r6 = a7.ui) ? void 0 : r6.itemLeadingAvatar] }) }), null, 16, ["size", "class"])) : Q2(a7) && a7.chip ? (Wt.openBlock(), Wt.createBlock(Sb, Wt.mergeProps({ key: 2, size: (null == (s6 = a7.ui) ? void 0 : s6.itemLeadingChipSize) || (null == (u4 = y2.ui) ? void 0 : u4.itemLeadingChipSize) || H2.value.itemLeadingChipSize(), inset: "", standalone: "" }, { ref_for: true }, a7.chip, { class: H2.value.itemLeadingChip({ class: [null == (d3 = y2.ui) ? void 0 : d3.itemLeadingChip, null == (v2 = a7.ui) ? void 0 : v2.itemLeadingChip] }) }), null, 16, ["size", "class"])) : Wt.createCommentVNode("", true)];
                }), Wt.createVNode(Wt.unref(Ce), { class: H2.value.itemLabel({ class: [null == (i7 = y2.ui) ? void 0 : i7.itemLabel, Q2(a7) && (null == (o5 = a7.ui) ? void 0 : o5.itemLabel)] }) }, { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "item-label", { item: a7, index: n6 }, () => [Wt.createTextVNode(Wt.toDisplayString(Q2(a7) ? Wt.unref(fg)(a7, y2.labelKey) : a7), 1)])]), _: 2 }, 1032, ["class"]), Wt.createVNode("span", { class: H2.value.itemTrailing({ class: [null == (r5 = y2.ui) ? void 0 : r5.itemTrailing, Q2(a7) && (null == (s5 = a7.ui) ? void 0 : s5.itemTrailing)] }) }, [Wt.renderSlot(t3.$slots, "item-trailing", { item: a7, index: n6 }), Wt.createVNode(Wt.unref(Be), { "as-child": "" }, { default: Wt.withCtx(() => {
                  var t4, i8;
                  return [Wt.createVNode(gb, { name: l2.selectedIcon || Wt.unref(B2).ui.icons.check, class: H2.value.itemTrailingIcon({ class: [null == (t4 = y2.ui) ? void 0 : t4.itemTrailingIcon, Q2(a7) && (null == (i8 = a7.ui) ? void 0 : i8.itemTrailingIcon)] }) }, null, 8, ["name", "class"])];
                }), _: 2 }, 1024)], 2)];
              })]), _: 2 }, 1032, ["class", "disabled", "value", "onSelect"]))], 64);
            }), 128))]), _: 2 }, 1032, ["class"]);
          }), 128))], 2), Wt.renderSlot(t3.$slots, "content-bottom"), l2.arrow ? (Wt.openBlock(), Wt.createBlock(Wt.unref(pe), Wt.mergeProps({ key: 0 }, I2.value, { class: H2.value.arrow({ class: null == (i5 = y2.ui) ? void 0 : i5.arrow }) }), null, 16, ["class"])) : Wt.createCommentVNode("", true)];
        }), _: 3 }, 16, ["class"])];
        i4(pm.ssrRenderComponent(Wt.unref(ge), Wt.mergeProps({ class: H2.value.content({ class: null == (r3 = y2.ui) ? void 0 : r3.content }) }, w2.value), { default: Wt.withCtx((a5, i5, n5, o4) => {
          var r4, s4, u3, g2;
          if (!i5) return [Wt.renderSlot(t3.$slots, "content-top"), Wt.createVNode("div", { role: "presentation", class: H2.value.viewport({ class: null == (u3 = y2.ui) ? void 0 : u3.viewport }) }, [(Wt.openBlock(true), Wt.createBlock(Wt.Fragment, null, Wt.renderList(U2.value, (a6, i6) => {
            ...
            return Wt.openBlock(), Wt.createBlock(Wt.unref(ye), { key: `group-${i6}`, class: H2.value.group({ class: null == (n6 = y2.ui) ? void 0 : n6.group }) }, { default: Wt.withCtx(() => [(Wt.openBlock(true), Wt.createBlock(Wt.Fragment, null, Wt.renderList(a6, (a7, n7) => {
              ...
              return Wt.openBlock(), Wt.createBlock(Wt.Fragment, { key: `group-${i6}-${n7}` }, [Q2(a7) && "label" === a7.type ? (Wt.openBlock(), Wt.createBlock(Wt.unref(Se), { key: 0, class: H2.value.label({ class: [null == (o5 = y2.ui) ? void 0 : o5.label, null == (r5 = a7.ui) ? void 0 : r5.label, a7.class] }) }, { default: Wt.withCtx(() => [Wt.createTextVNode(Wt.toDisplayString(Wt.unref(fg)(a7, y2.labelKey)), 1)]), _: 2 }, 1032, ["class"])) : Q2(a7) && "separator" === a7.type ? (Wt.openBlock(), Wt.createBlock(Wt.unref(we), { key: 1, class: H2.value.separator({ class: [null == (s5 = y2.ui) ? void 0 : s5.separator, null == (u4 = a7.ui) ? void 0 : u4.separator, a7.class] }) }, null, 8, ["class"])) : (Wt.openBlock(), Wt.createBlock(Wt.unref(xe), { key: 2, class: H2.value.item({ class: [null == (d2 = y2.ui) ? void 0 : d2.item, Q2(a7) && (null == (g3 = a7.ui) ? void 0 : g3.item), Q2(a7) && a7.class] }), disabled: Q2(a7) && a7.disabled, value: Q2(a7) ? Wt.unref(fg)(a7, y2.valueKey) : a7, onSelect: (e2) => {
                var l3;
                return Q2(a7) && (null == (l3 = a7.onSelect) ? void 0 : l3.call(a7, e2));
                ...
                return [Wt.renderSlot(t3.$slots, "item-leading", { item: a7, index: n7 }, () => {
                  ...
                  return [Q2(a7) && a7.icon ? (Wt.openBlock(), Wt.createBlock(gb, { key: 0, name: a7.icon, class: H2.value.itemLeadingIcon({ class: [null == (l3 = y2.ui) ? void 0 : l3.itemLeadingIcon, null == (t4 = a7.ui) ? void 0 : t4.itemLeadingIcon] }) }, null, 8, ["name", "class"])) : Q2(a7) && a7.avatar ? (Wt.openBlock(), Wt.createBlock(_b, Wt.mergeProps({ key: 1, size: (null == (i8 = a7.ui) ? void 0 : i8.itemLeadingAvatarSize) || (null == (n8 = y2.ui) ? void 0 : n8.itemLeadingAvatarSize) || H2.value.itemLeadingAvatarSize() }, { ref_for: true }, a7.avatar, { class: H2.value.itemLeadingAvatar({ class: [null == (o7 = y2.ui) ? void 0 : o7.itemLeadingAvatar, null == (r7 = a7.ui) ? void 0 : r7.itemLeadingAvatar] }) }), null, 16, ["size", "class"])) : Q2(a7) && a7.chip ? (Wt.openBlock(), Wt.createBlock(Sb, Wt.mergeProps({ key: 2, size: (null == (s7 = a7.ui) ? void 0 : s7.itemLeadingChipSize) || (null == (u5 = y2.ui) ? void 0 : u5.itemLeadingChipSize) || H2.value.itemLeadingChipSize(), inset: "", standalone: "" }, { ref_for: true }, a7.chip, { class: H2.value.itemLeadingChip({ class: [null == (d3 = y2.ui) ? void 0 : d3.itemLeadingChip, null == (v2 = a7.ui) ? void 0 : v2.itemLeadingChip] }) }), null, 16, ["size", "class"])) : Wt.createCommentVNode("", true)];
                }), Wt.createVNode(Wt.unref(Ce), { class: H2.value.itemLabel({ class: [null == (i7 = y2.ui) ? void 0 : i7.itemLabel, Q2(a7) && (null == (o6 = a7.ui) ? void 0 : o6.itemLabel)] }) }, { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "item-label", { item: a7, index: n7 }, () => [Wt.createTextVNode(Wt.toDisplayString(Q2(a7) ? Wt.unref(fg)(a7, y2.labelKey) : a7), 1)])]), _: 2 }, 1032, ["class"]), Wt.createVNode("span", { class: H2.value.itemTrailing({ class: [null == (r6 = y2.ui) ? void 0 : r6.itemTrailing, Q2(a7) && (null == (s6 = a7.ui) ? void 0 : s6.itemTrailing)] }) }, [Wt.renderSlot(t3.$slots, "item-trailing", { item: a7, index: n7 }), Wt.createVNode(Wt.unref(Be), { "as-child": "" }, { default: Wt.withCtx(() => {
                  var t4, i8;
                  return [Wt.createVNode(gb, { name: l2.selectedIcon || Wt.unref(B2).ui.icons.check, class: H2.value.itemTrailingIcon({ class: [null == (t4 = y2.ui) ? void 0 : t4.itemTrailingIcon, Q2(a7) && (null == (i8 = a7.ui) ? void 0 : i8.itemTrailingIcon)] }) }, null, 8, ["name", "class"])];
                }), _: 2 }, 1024)], 2)];
              })]), _: 2 }, 1032, ["class", "disabled", "value", "onSelect"]))], 64);
            }), 128))]), _: 2 }, 1032, ["class"]);
          }), 128))], 2), Wt.renderSlot(t3.$slots, "content-bottom"), l2.arrow ? (Wt.openBlock(), Wt.createBlock(Wt.unref(pe), Wt.mergeProps({ key: 0 }, I2.value, { class: H2.value.arrow({ class: null == (g2 = y2.ui) ? void 0 : g2.arrow }) }), null, 16, ["class"])) : Wt.createCommentVNode("", true)];
          pm.ssrRenderSlot(t3.$slots, "content-top", {}, null, i5, n5, o4), i5(`<div role="presentation" class="${pm.ssrRenderClass(H2.value.viewport({ class: null == (r4 = y2.ui) ? void 0 : r4.viewport }))}"${o4}><!--[-->`), pm.ssrRenderList(U2.value, (a6, r5) => {
            ...
            i5(pm.ssrRenderComponent(Wt.unref(ye), { key: `group-${r5}`, class: H2.value.group({ class: null == (s5 = y2.ui) ? void 0 : s5.group }) }, { default: Wt.withCtx((i6, n6, o5, s6) => {
              if (!n6) return [(Wt.openBlock(true), Wt.createBlock(Wt.Fragment, null, Wt.renderList(a6, (a7, i7) => {
                ...
                return Wt.openBlock(), Wt.createBlock(Wt.Fragment, { key: `group-${r5}-${i7}` }, [Q2(a7) && "label" === a7.type ? (Wt.openBlock(), Wt.createBlock(Wt.unref(Se), { key: 0, class: H2.value.label({ class: [null == (n7 = y2.ui) ? void 0 : n7.label, null == (o6 = a7.ui) ? void 0 : o6.label, a7.class] }) }, { default: Wt.withCtx(() => [Wt.createTextVNode(Wt.toDisplayString(Wt.unref(fg)(a7, y2.labelKey)), 1)]), _: 2 }, 1032, ["class"])) : Q2(a7) && "separator" === a7.type ? (Wt.openBlock(), Wt.createBlock(Wt.unref(we), { key: 1, class: H2.value.separator({ class: [null == (s7 = y2.ui) ? void 0 : s7.separator, null == (u4 = a7.ui) ? void 0 : u4.separator, a7.class] }) }, null, 8, ["class"])) : (Wt.openBlock(), Wt.createBlock(Wt.unref(xe), { key: 2, class: H2.value.item({ class: [null == (d2 = y2.ui) ? void 0 : d2.item, Q2(a7) && (null == (g3 = a7.ui) ? void 0 : g3.item), Q2(a7) && a7.class] }), disabled: Q2(a7) && a7.disabled, value: Q2(a7) ? Wt.unref(fg)(a7, y2.valueKey) : a7, onSelect: (e2) => {
                  var l3;
                  return Q2(a7) && (null == (l3 = a7.onSelect) ? void 0 : l3.call(a7, e2));
                  ...
                  return [Wt.renderSlot(t3.$slots, "item-leading", { item: a7, index: i7 }, () => {
                    ...
                    return [Q2(a7) && a7.icon ? (Wt.openBlock(), Wt.createBlock(gb, { key: 0, name: a7.icon, class: H2.value.itemLeadingIcon({ class: [null == (l3 = y2.ui) ? void 0 : l3.itemLeadingIcon, null == (t4 = a7.ui) ? void 0 : t4.itemLeadingIcon] }) }, null, 8, ["name", "class"])) : Q2(a7) && a7.avatar ? (Wt.openBlock(), Wt.createBlock(_b, Wt.mergeProps({ key: 1, size: (null == (i8 = a7.ui) ? void 0 : i8.itemLeadingAvatarSize) || (null == (n9 = y2.ui) ? void 0 : n9.itemLeadingAvatarSize) || H2.value.itemLeadingAvatarSize() }, { ref_for: true }, a7.avatar, { class: H2.value.itemLeadingAvatar({ class: [null == (o8 = y2.ui) ? void 0 : o8.itemLeadingAvatar, null == (r7 = a7.ui) ? void 0 : r7.itemLeadingAvatar] }) }), null, 16, ["size", "class"])) : Q2(a7) && a7.chip ? (Wt.openBlock(), Wt.createBlock(Sb, Wt.mergeProps({ key: 2, size: (null == (s9 = a7.ui) ? void 0 : s9.itemLeadingChipSize) || (null == (u5 = y2.ui) ? void 0 : u5.itemLeadingChipSize) || H2.value.itemLeadingChipSize(), inset: "", standalone: "" }, { ref_for: true }, a7.chip, { class: H2.value.itemLeadingChip({ class: [null == (d3 = y2.ui) ? void 0 : d3.itemLeadingChip, null == (v2 = a7.ui) ? void 0 : v2.itemLeadingChip] }) }), null, 16, ["size", "class"])) : Wt.createCommentVNode("", true)];
                  }), Wt.createVNode(Wt.unref(Ce), { class: H2.value.itemLabel({ class: [null == (n8 = y2.ui) ? void 0 : n8.itemLabel, Q2(a7) && (null == (o7 = a7.ui) ? void 0 : o7.itemLabel)] }) }, { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "item-label", { item: a7, index: i7 }, () => [Wt.createTextVNode(Wt.toDisplayString(Q2(a7) ? Wt.unref(fg)(a7, y2.labelKey) : a7), 1)])]), _: 2 }, 1032, ["class"]), Wt.createVNode("span", { class: H2.value.itemTrailing({ class: [null == (r6 = y2.ui) ? void 0 : r6.itemTrailing, Q2(a7) && (null == (s8 = a7.ui) ? void 0 : s8.itemTrailing)] }) }, [Wt.renderSlot(t3.$slots, "item-trailing", { item: a7, index: i7 }), Wt.createVNode(Wt.unref(Be), { "as-child": "" }, { default: Wt.withCtx(() => {
                    var t4, i8;
                    return [Wt.createVNode(gb, { name: l2.selectedIcon || Wt.unref(B2).ui.icons.check, class: H2.value.itemTrailingIcon({ class: [null == (t4 = y2.ui) ? void 0 : t4.itemTrailingIcon, Q2(a7) && (null == (i8 = a7.ui) ? void 0 : i8.itemTrailingIcon)] }) }, null, 8, ["name", "class"])];
                  }), _: 2 }, 1024)], 2)];
                })]), _: 2 }, 1032, ["class", "disabled", "value", "onSelect"]))], 64);
              ...
              n6("<!--[-->"), pm.ssrRenderList(a6, (a7, i7) => {
                var r6, u4, g3, f2, h3, k2;
                n6("<!--[-->"), Q2(a7) && "label" === a7.type ? n6(pm.ssrRenderComponent(Wt.unref(Se), { class: H2.value.label({ class: [null == (r6 = y2.ui) ? void 0 : r6.label, null == (u4 = a7.ui) ? void 0 : u4.label, a7.class] }) }, { default: Wt.withCtx((l3, t4, i8, n7) => {
                ...
                }), _: 2 }, o5, s6)) : Q2(a7) && "separator" === a7.type ? n6(pm.ssrRenderComponent(Wt.unref(we), { class: H2.value.separator({ class: [null == (g3 = y2.ui) ? void 0 : g3.separator, null == (f2 = a7.ui) ? void 0 : f2.separator, a7.class] }) }, null, o5, s6)) : n6(pm.ssrRenderComponent(Wt.unref(xe), { class: H2.value.item({ class: [null == (h3 = y2.ui) ? void 0 : h3.item, Q2(a7) && (null == (k2 = a7.ui) ? void 0 : k2.item), Q2(a7) && a7.class] }), disabled: Q2(a7) && a7.disabled, value: Q2(a7) ? Wt.unref(fg)(a7, y2.valueKey) : a7, onSelect: (e2) => {
                  var l3;
                  return Q2(a7) && (null == (l3 = a7.onSelect) ? void 0 : l3.call(a7, e2));
                  ...
                  if (!o6) return [Wt.renderSlot(t3.$slots, "item", { item: a7, index: i7 }, () => {
                    ...
                    return [Wt.renderSlot(t3.$slots, "item-leading", { item: a7, index: i7 }, () => {
                      ...
                      return [Q2(a7) && a7.icon ? (Wt.openBlock(), Wt.createBlock(gb, { key: 0, name: a7.icon, class: H2.value.itemLeadingIcon({ class: [null == (l3 = y2.ui) ? void 0 : l3.itemLeadingIcon, null == (t4 = a7.ui) ? void 0 : t4.itemLeadingIcon] }) }, null, 8, ["name", "class"])) : Q2(a7) && a7.avatar ? (Wt.openBlock(), Wt.createBlock(_b, Wt.mergeProps({ key: 1, size: (null == (i8 = a7.ui) ? void 0 : i8.itemLeadingAvatarSize) || (null == (n9 = y2.ui) ? void 0 : n9.itemLeadingAvatarSize) || H2.value.itemLeadingAvatarSize() }, { ref_for: true }, a7.avatar, { class: H2.value.itemLeadingAvatar({ class: [null == (o8 = y2.ui) ? void 0 : o8.itemLeadingAvatar, null == (r9 = a7.ui) ? void 0 : r9.itemLeadingAvatar] }) }), null, 16, ["size", "class"])) : Q2(a7) && a7.chip ? (Wt.openBlock(), Wt.createBlock(Sb, Wt.mergeProps({ key: 2, size: (null == (s9 = a7.ui) ? void 0 : s9.itemLeadingChipSize) || (null == (u5 = y2.ui) ? void 0 : u5.itemLeadingChipSize) || H2.value.itemLeadingChipSize(), inset: "", standalone: "" }, { ref_for: true }, a7.chip, { class: H2.value.itemLeadingChip({ class: [null == (d2 = y2.ui) ? void 0 : d2.itemLeadingChip, null == (v2 = a7.ui) ? void 0 : v2.itemLeadingChip] }) }), null, 16, ["size", "class"])) : Wt.createCommentVNode("", true)];
                    }), Wt.createVNode(Wt.unref(Ce), { class: H2.value.itemLabel({ class: [null == (n8 = y2.ui) ? void 0 : n8.itemLabel, Q2(a7) && (null == (o7 = a7.ui) ? void 0 : o7.itemLabel)] }) }, { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "item-label", { item: a7, index: i7 }, () => [Wt.createTextVNode(Wt.toDisplayString(Q2(a7) ? Wt.unref(fg)(a7, y2.labelKey) : a7), 1)])]), _: 2 }, 1032, ["class"]), Wt.createVNode("span", { class: H2.value.itemTrailing({ class: [null == (r8 = y2.ui) ? void 0 : r8.itemTrailing, Q2(a7) && (null == (s8 = a7.ui) ? void 0 : s8.itemTrailing)] }) }, [Wt.renderSlot(t3.$slots, "item-trailing", { item: a7, index: i7 }), Wt.createVNode(Wt.unref(Be), { "as-child": "" }, { default: Wt.withCtx(() => {
                      var t4, i8;
                      return [Wt.createVNode(gb, { name: l2.selectedIcon || Wt.unref(B2).ui.icons.check, class: H2.value.itemTrailingIcon({ class: [null == (t4 = y2.ui) ? void 0 : t4.itemTrailingIcon, Q2(a7) && (null == (i8 = a7.ui) ? void 0 : i8.itemTrailingIcon)] }) }, null, 8, ["name", "class"])];
                    }), _: 2 }, 1024)], 2)];
                  })];
                  pm.ssrRenderSlot(t3.$slots, "item", { item: a7, index: i7 }, () => {
                    ...
                    pm.ssrRenderSlot(t3.$slots, "item-leading", { item: a7, index: i7 }, () => {
                      var l3, t4, i8, n9, u6, v2, g5, f4, h4, k3;
                      Q2(a7) && a7.icon ? o6(pm.ssrRenderComponent(gb, { name: a7.icon, class: H2.value.itemLeadingIcon({ class: [null == (l3 = y2.ui) ? void 0 : l3.itemLeadingIcon, null == (t4 = a7.ui) ? void 0 : t4.itemLeadingIcon] }) }, null, r7, s7)) : Q2(a7) && a7.avatar ? o6(pm.ssrRenderComponent(_b, Wt.mergeProps({ size: (null == (i8 = a7.ui) ? void 0 : i8.itemLeadingAvatarSize) || (null == (n9 = y2.ui) ? void 0 : n9.itemLeadingAvatarSize) || H2.value.itemLeadingAvatarSize() }, { ref_for: true }, a7.avatar, { class: H2.value.itemLeadingAvatar({ class: [null == (u6 = y2.ui) ? void 0 : u6.itemLeadingAvatar, null == (v2 = a7.ui) ? void 0 : v2.itemLeadingAvatar] }) }), null, r7, s7)) : Q2(a7) && a7.chip ? o6(pm.ssrRenderComponent(Sb, Wt.mergeProps({ size: (null == (g5 = a7.ui) ? void 0 : g5.itemLeadingChipSize) || (null == (f4 = y2.ui) ? void 0 : f4.itemLeadingChipSize) || H2.value.itemLeadingChipSize(), inset: "", standalone: "" }, { ref_for: true }, a7.chip, { class: H2.value.itemLeadingChip({ class: [null == (h4 = y2.ui) ? void 0 : h4.itemLeadingChip, null == (k3 = a7.ui) ? void 0 : k3.itemLeadingChip] }) }), null, r7, s7)) : o6("<!---->");
                    }, o6, r7, s7), o6(pm.ssrRenderComponent(Wt.unref(Ce), { class: H2.value.itemLabel({ class: [null == (n8 = y2.ui) ? void 0 : n8.itemLabel, Q2(a7) && (null == (u5 = a7.ui) ? void 0 : u5.itemLabel)] }) }, { default: Wt.withCtx((l3, n9, o7, r8) => {
                      if (!n9) return [Wt.renderSlot(t3.$slots, "item-label", { item: a7, index: i7 }, () => [Wt.createTextVNode(Wt.toDisplayString(Q2(a7) ? Wt.unref(fg)(a7, y2.labelKey) : a7), 1)])];
                      pm.ssrRenderSlot(t3.$slots, "item-label", { item: a7, index: i7 }, () => {
                        n9(`${pm.ssrInterpolate(Q2(a7) ? Wt.unref(fg)(a7, y2.labelKey) : a7)}`);
                      }, n9, o7, r8);
                    }), _: 2 }, r7, s7)), o6(`<span class="${pm.ssrRenderClass(H2.value.itemTrailing({ class: [null == (g4 = y2.ui) ? void 0 : g4.itemTrailing, Q2(a7) && (null == (f3 = a7.ui) ? void 0 : f3.itemTrailing)] }))}"${s7}>`), pm.ssrRenderSlot(t3.$slots, "item-trailing", { item: a7, index: i7 }, null, o6, r7, s7), o6(pm.ssrRenderComponent(Wt.unref(Be), { "as-child": "" }, { default: Wt.withCtx((t4, i8, n9, o7) => {
                      var r8, s8, u6, p2;
                      if (!i8) return [Wt.createVNode(gb, { name: l2.selectedIcon || Wt.unref(B2).ui.icons.check, class: H2.value.itemTrailingIcon({ class: [null == (u6 = y2.ui) ? void 0 : u6.itemTrailingIcon, Q2(a7) && (null == (p2 = a7.ui) ? void 0 : p2.itemTrailingIcon)] }) }, null, 8, ["name", "class"])];
                      i8(pm.ssrRenderComponent(gb, { name: l2.selectedIcon || Wt.unref(B2).ui.icons.check, class: H2.value.itemTrailingIcon({ class: [null == (r8 = y2.ui) ? void 0 : r8.itemTrailingIcon, Q2(a7) && (null == (s8 = a7.ui) ? void 0 : s8.itemTrailingIcon)] }) }, null, n9, o7));
                    }), _: 2 }, r7, s7)), o6("</span>");
                  }, o6, r7, s7);
                }), _: 2 }, o5, s6)), n6("<!--]-->");
              }), n6("<!--]-->");
            }), _: 2 }, n5, o4));
          }), i5("<!--]--></div>"), pm.ssrRenderSlot(t3.$slots, "content-bottom", {}, null, i5, n5, o4), l2.arrow ? i5(pm.ssrRenderComponent(Wt.unref(pe), Wt.mergeProps(I2.value, { class: H2.value.arrow({ class: null == (s4 = y2.ui) ? void 0 : s4.arrow }) }), null, n5, o4)) : i5("<!---->");
        }), _: 2 }, n4, o3));
      }), _: 2 }, o2, r2));
    }), _: 3 }, i2));
  };
...
export { _e as _ };
//# sourceMappingURL=Select-5h5sLi6z.mjs.map
