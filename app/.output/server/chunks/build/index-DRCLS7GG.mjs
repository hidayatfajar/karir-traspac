import { v as Wt, b as Fs, s as pm, _ as Rb, c as yb, d as Tb, u as da, a as Tm, r as Bm, t as Ky, P as _m } from './server.mjs';
import { _ as G } from './TextField-DvcL8FOr.mjs';
import { z as ze } from './SelectMenu-C9jA8Nq3.mjs';
import { c } from './index-CVudU8ow.mjs';
...
function v(e2, a2) {
  const t2 = Object.keys(e2), s2 = Object.keys(a2);
  if (t2.length !== s2.length) return false;
  return JSON.stringify(Object.keys(e2.breakpoints || {})) === JSON.stringify(Object.keys(a2.breakpoints || {})) && t2.every((t3) => {
    const s3 = e2[t3], i2 = a2[t3];
    return "function" == typeof s3 ? `${s3}` == `${i2}` : g(s3) && g(i2) ? v(s3, i2) : s3 === i2;
  });
}
function b(e2) {
...
function f(a2 = {}, t2 = []) {
  const s2 = Wt.isRef(a2), i2 = Wt.isRef(t2);
  let r2 = s2 ? a2.value : a2, n2 = i2 ? t2.value : t2;
  const l2 = Wt.shallowRef(), o2 = Wt.shallowRef();
  function d2() {
    o2.value && o2.value.reInit(r2, n2);
  }
  return s2 && Wt.watch(a2, (e2) => {
    v(r2, e2) || (r2 = e2, d2());
  }), i2 && Wt.watch(t2, (e2) => {
    (function(e3, a3) {
      if (e3.length !== a3.length) return false;
      const t3 = b(e3), s3 = b(a3);
      return t3.every((e4, a4) => v(e4, s3[a4]));
    })(n2, e2) || (n2 = e2, d2());
  }), [l2, o2];
}
...
const h = { slots: { root: "relative focus:outline-none", viewport: "overflow-hidden", container: "flex items-start", item: "min-w-0 shrink-0 basis-full", controls: "", arrows: "", prev: "absolute rounded-full", next: "absolute rounded-full", dots: "absolute inset-x-0 -bottom-7 flex flex-wrap items-center justify-center gap-3", dot: ["cursor-pointer size-3 bg-accented rounded-full", "transition"] }, variants: { orientation: { vertical: { container: "flex-col -mt-4", item: "pt-4", prev: "top-4 sm:-top-12 left-1/2 -translate-x-1/2 rotate-90 rtl:-rotate-90", next: "bottom-4 sm:-bottom-12 left-1/2 -translate-x-1/2 rotate-90 rtl:-rotate-90" }, horizontal: { container: "flex-row -ms-4", item: "ps-4", prev: "start-4 sm:-start-12 top-1/2 -translate-y-1/2", next: "end-4 sm:-end-12 top-1/2 -translate-y-1/2" } }, active: { true: { dot: "data-[state=active]:bg-inverted" } } } }, y = { __name: "Carousel", __ssrInlineRender: true, props: { as: { type: null, required: false }, prev: { type: Object, required: false }, prevIcon: { type: String, required: false }, next: { type: Object, required: false }, nextIcon: { type: String, required: false }, arrows: { type: Boolean, required: false, default: false }, dots: { type: Boolean, required: false, default: false }, orientation: { type: null, required: false, default: "horizontal" }, items: { type: Array, required: false }, autoplay: { type: [Boolean, Object], required: false, default: false }, autoScroll: { type: [Boolean, Object], required: false, default: false }, autoHeight: { type: [Boolean, Object], required: false, default: false }, classNames: { type: [Boolean, Object], required: false, default: false }, fade: { type: [Boolean, Object], required: false, default: false }, wheelGestures: { type: Boolean, required: false, skipCheck: true, default: false }, class: { type: null, required: false }, ui: { type: null, required: false }, align: { type: [String, Function], required: false, default: "center" }, containScroll: { type: [Boolean, String], required: false, default: "trimSnaps" }, slidesToScroll: { type: [String, Number], required: false, default: 1 }, dragFree: { type: Boolean, required: false, default: false }, dragThreshold: { type: Number, required: false, default: 10 }, inViewThreshold: { type: null, required: false, default: 0 }, loop: { type: Boolean, required: false, default: false }, skipSnaps: { type: Boolean, required: false, default: false }, duration: { type: Number, required: false, default: 25 }, startIndex: { type: Number, required: false, default: 0 }, watchDrag: { type: [Boolean, Function], required: false, default: true }, watchResize: { type: [Boolean, Function], required: false, default: true }, watchSlides: { type: [Boolean, Function], required: false, default: true }, watchFocus: { type: [Boolean, Function], required: false, default: true }, active: { type: Boolean, required: false, default: true }, breakpoints: { type: Object, required: false, default: () => ({}) } }, emits: ["select"], setup(o2, { expose: d2, emit: m2 }) {
  const u2 = o2, { dir: p2, t: g2 } = l(), v2 = da(), b2 = Tm(Bm(u2, "active", "align", "breakpoints", "containScroll", "dragFree", "dragThreshold", "duration", "inViewThreshold", "loop", "skipSnaps", "slidesToScroll", "startIndex", "watchDrag", "watchResize", "watchSlides", "watchFocus")), y2 = Wt.computed(() => u2.prevIcon || ("rtl" === p2.value ? v2.ui.icons.arrowRight : v2.ui.icons.arrowLeft)), k2 = Wt.computed(() => u2.nextIcon || ("rtl" === p2.value ? v2.ui.icons.arrowLeft : v2.ui.icons.arrowRight)), w2 = Wt.computed(() => {
    var e2;
    return Ky({ extend: Ky(h), ...(null == (e2 = v2.ui) ? void 0 : e2.carousel) || {} })({ orientation: u2.orientation });
  ...
  return d2({ emblaRef: C, emblaApi: S }), (a2, t2, s2, i2) => {
    var d3;
    t2(pm.ssrRenderComponent(Wt.unref(_m), Wt.mergeProps({ as: o2.as, role: "region", "aria-roledescription": "carousel", tabindex: "0", class: w2.value.root({ class: [null == (d3 = u2.ui) ? void 0 : d3.root, u2.class] }), onKeydown: I }, i2), { default: Wt.withCtx((t3, s3, i3, n2) => {
      var d4, m3, p3, c2, x2, v3, b3, f2, h2, j3, R2, I2, A, N;
      if (!s3) return [Wt.createVNode("div", { ref_key: "emblaRef", ref: C, class: w2.value.viewport({ class: null == (f2 = u2.ui) ? void 0 : f2.viewport }) }, [Wt.createVNode("div", { class: w2.value.container({ class: null == (h2 = u2.ui) ? void 0 : h2.container }) }, [(Wt.openBlock(true), Wt.createBlock(Wt.Fragment, null, Wt.renderList(o2.items, (t4, s4) => {
        var i4, r2;
        return Wt.openBlock(), Wt.createBlock("div", { key: s4, role: "group", "aria-roledescription": "slide", class: w2.value.item({ class: [null == (i4 = u2.ui) ? void 0 : i4.item, _(t4) && (null == (r2 = t4.ui) ? void 0 : r2.item), _(t4) && t4.class] }) }, [Wt.renderSlot(a2.$slots, "default", { item: t4, index: s4 })], 2);
      }), 128))], 2)], 2), o2.arrows || o2.dots ? (Wt.openBlock(), Wt.createBlock("div", { key: 0, class: w2.value.controls({ class: null == (j3 = u2.ui) ? void 0 : j3.controls }) }, [o2.arrows ? (Wt.openBlock(), Wt.createBlock("div", { key: 0, class: w2.value.arrows({ class: null == (R2 = u2.ui) ? void 0 : R2.arrows }) }, [Wt.createVNode(Rb, Wt.mergeProps({ disabled: !P.value, icon: y2.value, color: "neutral", variant: "outline", "aria-label": Wt.unref(g2)("carousel.prev") }, "object" == typeof o2.prev ? o2.prev : void 0, { class: w2.value.prev({ class: null == (I2 = u2.ui) ? void 0 : I2.prev }), onClick: q }), null, 16, ["disabled", "icon", "aria-label", "class"]), Wt.createVNode(Rb, Wt.mergeProps({ disabled: !$.value, icon: k2.value, color: "neutral", variant: "outline", "aria-label": Wt.unref(g2)("carousel.next") }, "object" == typeof o2.next ? o2.next : void 0, { class: w2.value.next({ class: null == (A = u2.ui) ? void 0 : A.next }), onClick: T }), null, 16, ["disabled", "icon", "aria-label", "class"])], 2)) : Wt.createCommentVNode("", true), o2.dots ? (Wt.openBlock(), Wt.createBlock("div", { key: 1, class: w2.value.dots({ class: null == (N = u2.ui) ? void 0 : N.dots }) }, [(Wt.openBlock(true), Wt.createBlock(Wt.Fragment, null, Wt.renderList(D.value, (a3, t4) => {
        var s4;
        return Wt.openBlock(), Wt.createBlock("button", { key: t4, "aria-label": Wt.unref(g2)("carousel.goto", { slide: t4 + 1 }), class: w2.value.dot({ class: null == (s4 = u2.ui) ? void 0 : s4.dot, active: B.value === t4 }), "data-state": B.value === t4 ? "active" : void 0, onClick: (e2) => function(e3) {
          var a4;
      ...
      s3(`<div class="${pm.ssrRenderClass(w2.value.viewport({ class: null == (d4 = u2.ui) ? void 0 : d4.viewport }))}"${n2}><div class="${pm.ssrRenderClass(w2.value.container({ class: null == (m3 = u2.ui) ? void 0 : m3.container }))}"${n2}><!--[-->`), pm.ssrRenderList(o2.items, (e2, t4) => {
        var l2, o3;
        s3(`<div role="group" aria-roledescription="slide" class="${pm.ssrRenderClass(w2.value.item({ class: [null == (l2 = u2.ui) ? void 0 : l2.item, _(e2) && (null == (o3 = e2.ui) ? void 0 : o3.item), _(e2) && e2.class] }))}"${n2}>`), pm.ssrRenderSlot(a2.$slots, "default", { item: e2, index: t4 }, null, s3, i3, n2), s3("</div>");
      }), s3("<!--]--></div></div>"), o2.arrows || o2.dots ? (s3(`<div class="${pm.ssrRenderClass(w2.value.controls({ class: null == (p3 = u2.ui) ? void 0 : p3.controls }))}"${n2}>`), o2.arrows ? (s3(`<div class="${pm.ssrRenderClass(w2.value.arrows({ class: null == (c2 = u2.ui) ? void 0 : c2.arrows }))}"${n2}>`), s3(pm.ssrRenderComponent(Rb, Wt.mergeProps({ disabled: !P.value, icon: y2.value, color: "neutral", variant: "outline", "aria-label": Wt.unref(g2)("carousel.prev") }, "object" == typeof o2.prev ? o2.prev : void 0, { class: w2.value.prev({ class: null == (x2 = u2.ui) ? void 0 : x2.prev }), onClick: q }), null, i3, n2)), s3(pm.ssrRenderComponent(Rb, Wt.mergeProps({ disabled: !$.value, icon: k2.value, color: "neutral", variant: "outline", "aria-label": Wt.unref(g2)("carousel.next") }, "object" == typeof o2.next ? o2.next : void 0, { class: w2.value.next({ class: null == (v3 = u2.ui) ? void 0 : v3.next }), onClick: T }), null, i3, n2)), s3("</div>")) : s3("<!---->"), o2.dots ? (s3(`<div class="${pm.ssrRenderClass(w2.value.dots({ class: null == (b3 = u2.ui) ? void 0 : b3.dots }))}"${n2}><!--[-->`), pm.ssrRenderList(D.value, (a3, t4) => {
        var i4;
        s3(`<button${pm.ssrRenderAttr("aria-label", Wt.unref(g2)("carousel.goto", { slide: t4 + 1 }))} class="${pm.ssrRenderClass(w2.value.dot({ class: null == (i4 = u2.ui) ? void 0 : i4.dot, active: B.value === t4 }))}"${pm.ssrRenderAttr("data-state", B.value === t4 ? "active" : void 0)}${n2}></button>`);
      }), s3("<!--]--></div>")) : s3("<!---->"), s3("</div>")) : s3("<!---->");
    }), _: 3 }, s2));
  };
} }, k = y.setup;
...
const w = Wt.defineComponent({ __name: "index", __ssrInlineRender: true, setup(a2) {
  ...
  return (a3, s3, i3, o2) => {
    ...
    s3(`<div${pm.ssrRenderAttrs(o2)}><main class="overflow-x-hidden xl:-mx-[150px]"><section id="hero" class="relative px-4 md:px-8 lg:px-16 xl:px-40 py-12 sm:py-16 md:py-20 lg:py-[56px] bg-slate-50"><div class="absolute -top-32 -left-32 w-64 h-64 rounded-full bg-primary-500 blur-2xl opacity-50"></div><div class="absolute -bottom-48 -right-48 w-96 h-96 rounded-full bg-primary-500 blur-2xl opacity-50"></div><div class="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 items-center relative z-10"><div class="text-center md:text-left"><h1 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-slate-900 leading-tight mb-4 md:mb-6"> Temukan Pekerjaan <span class="bg-gradient-to-r from-primary-500 to-neutral-500 bg-clip-text text-transparent">Impianmu</span></h1><p class="text-base sm:text-lg md:text-xl text-slate-600 mb-6 md:mb-8"> Jadilah bagian dari perjalanan kami dalam menciptakan solusi teknologi yang mengubah dunia. </p><div class="flex flex-col sm:flex-row justify-center md:justify-start space-y-3 sm:space-y-0 sm:space-x-4">`), s3(pm.ssrRenderComponent(f2, { label: "Daftar Sekarang", onClick: (e2) => a3.$router.push("/auth/register"), size: "xl", class: "w-full sm:w-auto justify-center rounded-xl lg:px-5", icon: "i-mdi-account-plus-outline" }, null, i3)), s3(pm.ssrRenderComponent(f2, { label: "Lihat Lowongan", onClick: (e2) => a3.$router.push("/lowongan"), size: "xl", class: "w-full sm:w-auto justify-center rounded-xl lg:px-5", variant: "outline" }, null, i3)), s3('</div></div><div class="hidden md:block mt-8 md:mt-0"><img class="w-full rounded-lg" src="https://kyyjdpebklyiaolvxrjj.supabase.co/storage/v1/object/public/storage-public/bg-hero.png" alt="Tim teknologi yang beragam sedang bekerja bersama" onerror="this.onerror=null;this.src=&#39;https://placehold.co/600x400/e0e7ff/4338ca?text=Inovasi&#39;"></div></div></section><section class="py-16"><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"><div class="text-center mb-12"><h3 class="text-3xl font-bold text-primary mb-4"> Lowongan Tersedia </h3><p class="text-gray-600"> Temukan posisi yang sesuai dengan passion dan keahlian Anda </p></div><div class="bg-white rounded-2xl shadow-lg p-8 mb-12"><div class="grid grid-cols-1 md:grid-cols-3 gap-6"><div class="md:col-span-2"><label class="block text-sm font-medium text-gray-700 mb-2">Cari Posisi</label><div class="relative">'), s3(pm.ssrRenderComponent(h2, { size: "xl", placeholder: "Masukkan nama posisi atau kata kunci...", type: "search", class: "w-full", icon: "i-heroicons-magnifying-glass-20-solid" }, null, i3)), s3('</div></div><div><label class="block text-sm font-medium text-gray-700 mb-2">Filter</label><div class="relative">'), s3(pm.ssrRenderComponent(k2, { placeholder: "Pilih Tipe", options: ["Semua Tipe", "Full-time", "Part-time", "Remote", "Contract"], size: "xl", class: "w-full" }, null, i3)), s3('</div></div></div><div class="mt-6 flex justify-center">'), s3(pm.ssrRenderComponent(f2, { label: "Cari Lowongan", color: "primary", size: "xl", icon: "i-heroicons-magnifying-glass-20-solid", class: "bg-primary text-white px-8 py-3 rounded-xl font-medium hover:bg-opacity-90 transition-all" }, null, i3)), s3('</div></div><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"><!--[-->'), pm.ssrRenderList(Wt.unref(c2).slice(0, 3), (e2) => {
      ...
      t3(`<div class="text-center p-6 md:p-8 bg-white/60 backdrop-blur-xl border border-white/30 rounded-2xl"${i4}>`), t3(pm.ssrRenderComponent(R, { src: a4.avatar, size: "2xl", class: "mx-auto mb-4" }, null, s4, i4)), t3(`<p class="text-gray-700 italic text-sm sm:text-base"${i4}> &quot;${pm.ssrInterpolate(a4.quote)}&quot; </p><div class="mt-4 md:mt-6"${i4}><h4 class="font-semibold text-gray-900 text-sm sm:text-base"${i4}>${pm.ssrInterpolate(a4.name)}</h4><p class="text-primary text-xs sm:text-sm"${i4}>${pm.ssrInterpolate(a4.position)}</p></div></div>`);
    }), _: 1 }, i3)), s3(`</div></section><section id="stats" class="px-4 sm:px-6 md:px-8 lg:px-16 xl:px-40 py-12 sm:py-16 md:py-20 lg:py-[86px] bg-slate-800 relative overflow-hidden"><div class="absolute inset-0 opacity-5" style="${pm.ssrRenderStyle({ "background-image": "radial-gradient(\r\n              circle at 2px 2px,\r\n              white 1px,\r\n              transparent 0\r\n            )", "background-size": "40px 40px" })}"></div><div class="container mx-auto px-6 relative z-10"><div class="text-center mb-12 md:mb-16"><h2 class="text-2xl sm:text-3xl font-bold text-white mb-4"> Statistik Platform Rekrutmen </h2><p class="text-white/70 max-w-2xl mx-auto text-sm sm:text-base"> Data terkini mengenai aktivitas dan pencapaian platform kami. </p></div><div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8"><div class="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 p-6 hover:bg-white/15 transition-all duration-300"><div class="text-white/70 text-sm sm:text-base font-medium mb-4"> Total Pelamar </div><div class="flex items-center justify-between">`), s3(pm.ssrRenderComponent(w2, { name: "i-mdi-account-group", class: "text-4xl sm:text-5xl text-blue-400" }, null, i3)), s3(`<div class="text-2xl sm:text-3xl font-bold text-white">${pm.ssrInterpolate(Wt.unref(n2).total_user || 0)}</div></div></div><div class="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 p-6 hover:bg-white/15 transition-all duration-300"><div class="text-white/70 text-sm sm:text-base font-medium mb-4"> Pelamar Hari Ini </div><div class="flex items-center justify-between">`), s3(pm.ssrRenderComponent(w2, { name: "i-mdi-calendar-today", class: "text-4xl sm:text-5xl text-green-400" }, null, i3)), s3(`<div class="text-2xl sm:text-3xl font-bold text-white">${pm.ssrInterpolate(Wt.unref(n2).user_hari_ini || 0)}</div></div></div><div class="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 p-6 hover:bg-white/15 transition-all duration-300"><div class="text-white/70 text-sm sm:text-base font-medium mb-4"> Lowongan Aktif </div><div class="flex items-center justify-between">`), s3(pm.ssrRenderComponent(w2, { name: "i-mdi-briefcase", class: "text-4xl sm:text-5xl text-amber-400" }, null, i3)), s3(`<div class="text-2xl sm:text-3xl font-bold text-white">${pm.ssrInterpolate(Wt.unref(n2).jumlah_lowongan || 0)}</div></div></div><div class="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 p-6 hover:bg-white/15 transition-all duration-300"><div class="text-white/70 text-sm sm:text-base font-medium mb-4"> Berhasil Diterima </div><div class="flex items-center justify-between">`), s3(pm.ssrRenderComponent(w2, { name: "i-mdi-handshake", class: "text-4xl sm:text-5xl text-emerald-400" }, null, i3)), s3(`<div class="text-2xl sm:text-3xl font-bold text-white">${pm.ssrInterpolate(Wt.unref(n2).total_diterima || 0)}</div></div></div></div></div></section><section id="faq" class="px-4 sm:px-6 md:px-8 lg:px-16 xl:px-40 py-12 sm:py-16 md:py-20 lg:py-[86px] bg-white"><div class="container mx-auto px-6"><div class="text-center mb-12 md:mb-16"><h2 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-4"> Pertanyaan Umum </h2><p class="text-gray-600 max-w-2xl mx-auto text-sm sm:text-base"> Temukan jawaban untuk pertanyaan yang sering diajukan seputar karir dan proses rekrutmen di Karir Traspac. </p></div></div><section id="faq-list" class="py-8"><div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8"><div class="space-y-4"><!--[-->`), pm.ssrRenderList(Wt.unref(v2).slice(0, 5), (a4) => {
      s3('<div class="faq-item bg-white rounded-2xl shadow-lg border border-gray-100">'), s3(pm.ssrRenderComponent(f2, { variant: "ghost", class: "w-full px-8 py-6 text-left flex items-center justify-between hover:bg-gray-50", onClick: (e2) => ((e3) => {
        const a5 = t2.value.indexOf(e3);
        a5 > -1 ? t2.value.splice(a5, 1) : t2.value.push(e3);
      })(a4.id) }, { default: Wt.withCtx((s4, i4, n3, l2) => {
        if (!i4) return [Wt.createVNode("h3", { class: "text-lg font-semibold text-gray-900 pr-4" }, Wt.toDisplayString(a4.question), 1), Wt.createVNode(w2, { name: Wt.unref(t2).includes(a4.id) ? "i-heroicons-minus" : "i-heroicons-plus", class: ["text-primary text-xl transition-transform duration-300", { "rotate-180": Wt.unref(t2).includes(a4.id) }] }, null, 8, ["name", "class"])];
        i4(`<h3 class="text-lg font-semibold text-gray-900 pr-4"${l2}>${pm.ssrInterpolate(a4.question)}</h3>`), i4(pm.ssrRenderComponent(w2, { name: Wt.unref(t2).includes(a4.id) ? "i-heroicons-minus" : "i-heroicons-plus", class: ["text-primary text-xl transition-transform duration-300", { "rotate-180": Wt.unref(t2).includes(a4.id) }] }, null, n3, l2));
      }), _: 2 }, i3)), Wt.unref(t2).includes(a4.id) ? s3(`<div class="px-8 pb-6 overflow-hidden"><p class="text-gray-600 leading-relaxed">${pm.ssrInterpolate(a4.answer)}</p></div>`) : s3("<!---->"), s3("</div>");
    }), s3("<!--]--></div></div></section></section></main></div>");
  };
} }), j = w.setup;
w.setup = (a2, t2) => {
  const s2 = Wt.useSSRContext();
  return (s2.modules || (s2.modules = /* @__PURE__ */ new Set())).add("pages/index.vue"), j ? j(a2, t2) : void 0;
};

export { w as default };
//# sourceMappingURL=index-DRCLS7GG.mjs.map
