import { v as Wt, K as Im, L as Hm, F as km, G as zm, H as Lm, E as Km, M as jm, I as Jm, J as Dm } from './server.mjs';
...
function m(a2, s2 = {}) {
  ...
  return function(t2, n2, o2 = {}) {
    ...
    km(f3);
  }(a2, A), Wt.watch(() => d(a2), (e2) => !e2 && A()), function(t2, a3, s3 = {}) {
    ...
    km(m3);
  }(a2, A, { attributeFilter: ["style", "class"] }), i2 && p("scroll", A, { capture: true, passive: true }), r2 && p("resize", A, { passive: true }), Km(() => {
    c2 && A();
  }), { height: f2, bottom: m2, left: R, right: g, top: y, width: b, x: E, y: V, update: A };
}

export { c, m, v };
//# sourceMappingURL=index-yQmnmHk3.mjs.map
