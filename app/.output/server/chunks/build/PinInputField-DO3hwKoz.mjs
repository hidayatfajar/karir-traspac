import { v as Wt, s as om, u as ua, r as Mm, e as eg, t as Hy, U as ug, P as xm } from './server.mjs';
import { F, N, C, T } from './useForwardPropsEmits-DnSfSOTI.mjs';
import { n as n$1 } from './VisuallyHiddenInput-BCSgpyOT.mjs';
import { n, o } from './usePrimitiveElement-BqlHGOiE.mjs';
...
const [h, b] = T("PinInputRoot"), y = Wt.defineComponent({ inheritAttrs: false, __name: "PinInputRoot", props: { modelValue: {}, defaultValue: {}, placeholder: { default: "" }, mask: { type: Boolean }, otp: { type: Boolean }, type: { default: "text" }, dir: {}, disabled: { type: Boolean }, id: {}, asChild: { type: Boolean }, as: {}, name: {}, required: { type: Boolean } }, emits: ["update:modelValue", "complete"], setup(i2, { emit: r2 }) {
  ...
  return Wt.watch(y2, () => {
    ...
    k2.value.add(e2);
  }, isNumericMode: V2 }), (i3, r3) => (Wt.openBlock(), Wt.createBlock(Wt.unref(xm), Wt.mergeProps(i3.$attrs, { ref: Wt.unref(g2), dir: Wt.unref(h2), "data-complete": _2.value ? "" : void 0, "data-disabled": Wt.unref(f2) ? "" : void 0 }), { default: Wt.withCtx(() => {
    var _a2;
  ...
  const d2 = t2, c2 = u2, m2 = ua(), f2 = F(Mm(d2, "defaultValue", "disabled", "id", "mask", "modelValue", "name", "otp", "required", "type"), c2), { emitFormInput: v2, emitFormFocus: g2, emitFormChange: h2, emitFormBlur: b2, size: V2, color: _2, id: B2, name: S2, highlight: q, disabled: R, ariaAttrs: w } = eg(d2), I = Wt.computed(() => {
    var e2;
    return Hy({ extend: Hy(k), ...(null == (e2 = m2.ui) ? void 0 : e2.pinInput) || {} })({ color: _2.value, variant: d2.variant, size: V2.value, highlight: q.value });
  ...
  return s2({ inputsRef: C }), (i2, r2, a2, l2) => {
    var s3;
    r2(om.ssrRenderComponent(Wt.unref(y), Wt.mergeProps({ ...Wt.unref(f2), ...Wt.unref(w) }, { id: Wt.unref(B2), name: Wt.unref(S2), placeholder: t2.placeholder, class: I.value.root({ class: [null == (s3 = d2.ui) ? void 0 : s3.root, d2.class] }), "onUpdate:modelValue": (t3) => Wt.unref(v2)(), onComplete: j }, l2), { default: Wt.withCtx((t3, i3, r3, a3) => {
      if (!i3) return [(Wt.openBlock(true), Wt.createBlock(Wt.Fragment, null, Wt.renderList(Wt.unref(ug)(d2.length), (t4, i4) => {
        var r4;
        return Wt.openBlock(), Wt.createBlock(Wt.unref(x), { key: t4, ref_for: true, ref: (e2) => C.value[i4] = e2, index: i4, class: I.value.base({ class: null == (r4 = d2.ui) ? void 0 : r4.base }), disabled: Wt.unref(R), onBlur: z, onFocus: Wt.unref(g2) }, null, 8, ["index", "class", "disabled", "onFocus"]);
      }), 128))];
      i3("<!--[-->"), om.ssrRenderList(Wt.unref(ug)(d2.length), (t4, l3) => {
        var o2;
        i3(om.ssrRenderComponent(Wt.unref(x), { key: t4, ref_for: true, ref: (e2) => C.value[l3] = e2, index: l3, class: I.value.base({ class: null == (o2 = d2.ui) ? void 0 : o2.base }), disabled: Wt.unref(R), onBlur: z, onFocus: Wt.unref(g2) }, null, r3, a3));
      }), i3("<!--]-->");
    }), _: 1 }, a2));
  };
} }, _ = V.setup;
...
export { B as default };
//# sourceMappingURL=PinInputField-DO3hwKoz.mjs.map
