import { v as Wt, j as ei, s as om, p as Qs, b as Fs, u as ua, r as Mm, t as Hy, _ as kb, P as xm } from './server.mjs';
import { u as ue, e as ee } from './Table-C3yOWgeJ.mjs';
import { l } from './useLocale-BepRiSpk.mjs';
import { F, N as N$1, C as C$1, T as T$1 } from './useForwardPropsEmits-DnSfSOTI.mjs';
...
const k = Wt.defineComponent({ __name: "PaginationEllipsis", props: { asChild: { type: Boolean }, as: {} }, setup(t2) {
  const o2 = t2;
  return N$1(), (t3, l2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(xm), Wt.mergeProps(o2, { "data-type": "ellipsis" }), { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "default", {}, () => [l2[0] || (l2[0] = Wt.createTextVNode("\u2026"))])]), _: 3 }, 16));
  ...
  return _({ page: u2, onPageChange(e2) {
    u2.value = e2;
  }, pageCount: d2, siblingCount: s2, disabled: n2, showEdges: i2 }), (t3, o3) => (Wt.openBlock(), Wt.createBlock(Wt.unref(xm), { as: t3.as, "as-child": t3.asChild }, { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "default", { page: Wt.unref(u2), pageCount: d2.value })]), _: 3 }, 8, ["as", "as-child"]));
  ...
  return (t3, s2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(xm), Wt.mergeProps(o2, { "aria-label": "First Page", type: "button" === t3.as ? "button" : void 0, disabled: r2.value, onClick: s2[0] || (s2[0] = (a2) => !r2.value && Wt.unref(l2).onPageChange(1)) }), { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "default", {}, () => [s2[1] || (s2[1] = Wt.createTextVNode("First page"))])]), _: 3 }, 16, ["type", "disabled"]));
  ...
  return (t3, s2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(xm), Wt.mergeProps(o2, { "aria-label": "Last Page", type: "button" === t3.as ? "button" : void 0, disabled: r2.value, onClick: s2[0] || (s2[0] = (a2) => !r2.value && Wt.unref(l2).onPageChange(Wt.unref(l2).pageCount.value)) }), { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "default", {}, () => [s2[1] || (s2[1] = Wt.createTextVNode("Last page"))])]), _: 3 }, 16, ["type", "disabled"]));
} });
function S(e2, a2) {
  const t2 = a2 - e2 + 1;
...
const B = Wt.defineComponent({ __name: "PaginationList", props: { asChild: { type: Boolean }, as: {} }, setup(t2) {
  ...
  return (t3, l3) => (Wt.openBlock(), Wt.createBlock(Wt.unref(xm), Wt.normalizeProps(Wt.guardReactiveProps(o2)), { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "default", { items: r2.value })]), _: 3 }, 16));
  ...
  return (t3, s2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(xm), Wt.mergeProps(o2, { "aria-label": "Next Page", type: "button" === t3.as ? "button" : void 0, disabled: r2.value, onClick: s2[0] || (s2[0] = (a2) => !r2.value && Wt.unref(l2).onPageChange(Wt.unref(l2).page.value + 1)) }), { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "default", {}, () => [s2[1] || (s2[1] = Wt.createTextVNode("Next page"))])]), _: 3 }, 16, ["type", "disabled"]));
  ...
  return (t3, s2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(xm), Wt.mergeProps(o2, { "aria-label": "Previous Page", type: "button" === t3.as ? "button" : void 0, disabled: r2.value, onClick: s2[0] || (s2[0] = (a2) => !r2.value && Wt.unref(l2).onPageChange(Wt.unref(l2).page.value - 1)) }), { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "default", {}, () => [s2[1] || (s2[1] = Wt.createTextVNode("Prev page"))])]), _: 3 }, 16, ["type", "disabled"]));
  ...
  const i2 = a2, u2 = n2, d2 = Wt.useSlots(), { dir: c2 } = l(), m2 = ua(), v2 = F(Mm(i2, "as", "defaultPage", "disabled", "itemsPerPage", "page", "showEdges", "siblingCount", "total"), u2), g2 = Wt.computed(() => i2.firstIcon || ("rtl" === c2.value ? m2.ui.icons.chevronDoubleRight : m2.ui.icons.chevronDoubleLeft)), h2 = Wt.computed(() => i2.prevIcon || ("rtl" === c2.value ? m2.ui.icons.chevronRight : m2.ui.icons.chevronLeft)), x2 = Wt.computed(() => i2.nextIcon || ("rtl" === c2.value ? m2.ui.icons.chevronLeft : m2.ui.icons.chevronRight)), C2 = Wt.computed(() => i2.lastIcon || ("rtl" === c2.value ? m2.ui.icons.chevronDoubleLeft : m2.ui.icons.chevronDoubleRight)), _2 = Wt.computed(() => {
    var e2;
    return Hy({ extend: Hy(N), ...(null == (e2 = m2.ui) ? void 0 : e2.pagination) || {} })();
  });
  return (t2, o2, l2, n3) => {
    var u3;
    o2(om.ssrRenderComponent(Wt.unref(b), Wt.mergeProps(Wt.unref(v2), { class: _2.value.root({ class: [null == (u3 = i2.ui) ? void 0 : u3.root, i2.class] }) }, n3), { default: Wt.withCtx(({ page: o3, pageCount: l3 }, n4, u4, c3) => {
      var p2, v3;
      if (!n4) return [Wt.createVNode(Wt.unref(B), { class: _2.value.list({ class: null == (v3 = i2.ui) ? void 0 : v3.list }) }, { default: Wt.withCtx(({ items: r2 }) => {
        ...
        return [a2.showControls || d2.first ? (Wt.openBlock(), Wt.createBlock(Wt.unref(y), { key: 0, "as-child": "", class: _2.value.first({ class: null == (n5 = i2.ui) ? void 0 : n5.first }) }, { default: Wt.withCtx(() => [Wt.renderSlot(t2.$slots, "first", {}, () => {
          var t3;
          return [Wt.createVNode(kb, { color: a2.color, variant: a2.variant, size: a2.size, icon: g2.value, to: null == (t3 = a2.to) ? void 0 : t3.call(a2, 1) }, null, 8, ["color", "variant", "size", "icon", "to"])];
          ...
          var t3;
          return [Wt.createVNode(kb, { color: a2.color, variant: a2.variant, size: a2.size, icon: h2.value, to: o3 > 1 ? null == (t3 = a2.to) ? void 0 : t3.call(a2, o3 - 1) : void 0 }, null, 8, ["color", "variant", "size", "icon", "to"])];
          ...
          return Wt.openBlock(), Wt.createBlock(Wt.Fragment, null, ["page" === r3.type ? (Wt.openBlock(), Wt.createBlock(Wt.unref(R), { key: n6, "as-child": "", value: r3.value, class: _2.value.item({ class: null == (u6 = i2.ui) ? void 0 : u6.item }) }, { default: Wt.withCtx(() => [Wt.renderSlot(t2.$slots, "item", Wt.mergeProps({ ref_for: true }, { item: r3, index: n6, page: o3, pageCount: l3 }), () => {
            var t3;
            return [Wt.createVNode(kb, { color: o3 === r3.value ? a2.activeColor : a2.color, variant: o3 === r3.value ? a2.activeVariant : a2.variant, size: a2.size, label: String(r3.value), ui: { label: _2.value.label() }, to: null == (t3 = a2.to) ? void 0 : t3.call(a2, r3.value), square: "" }, null, 8, ["color", "variant", "size", "label", "ui", "to"])];
          })]), _: 2 }, 1032, ["value", "class"])) : (Wt.openBlock(), Wt.createBlock(Wt.unref(k), { key: r3.type, index: n6, "as-child": "", class: _2.value.ellipsis({ class: null == (d3 = i2.ui) ? void 0 : d3.ellipsis }) }, { default: Wt.withCtx(() => [Wt.renderSlot(t2.$slots, "ellipsis", {}, () => [Wt.createVNode(kb, { color: a2.color, variant: a2.variant, size: a2.size, icon: a2.ellipsisIcon || Wt.unref(m2).ui.icons.ellipsis }, null, 8, ["color", "variant", "size", "icon"])])]), _: 2 }, 1032, ["index", "class"]))], 64);
          ...
          var t3;
          return [Wt.createVNode(kb, { color: a2.color, variant: a2.variant, size: a2.size, icon: x2.value, to: o3 < l3 ? null == (t3 = a2.to) ? void 0 : t3.call(a2, o3 + 1) : void 0 }, null, 8, ["color", "variant", "size", "icon", "to"])];
          ...
          var t3;
          return [Wt.createVNode(kb, { color: a2.color, variant: a2.variant, size: a2.size, icon: C2.value, to: null == (t3 = a2.to) ? void 0 : t3.call(a2, l3) }, null, 8, ["color", "variant", "size", "icon", "to"])];
        })]), _: 2 }, 1032, ["class"])) : Wt.createCommentVNode("", true)];
      }), _: 2 }, 1032, ["class"])];
      n4(om.ssrRenderComponent(Wt.unref(B), { class: _2.value.list({ class: null == (p2 = i2.ui) ? void 0 : p2.list }) }, { default: Wt.withCtx(({ items: n5 }, u5, c4, p3) => {
        ...
        if (!u5) return [a2.showControls || d2.first ? (Wt.openBlock(), Wt.createBlock(Wt.unref(y), { key: 0, "as-child": "", class: _2.value.first({ class: null == (z2 = i2.ui) ? void 0 : z2.first }) }, { default: Wt.withCtx(() => [Wt.renderSlot(t2.$slots, "first", {}, () => {
          ...
          return Wt.openBlock(), Wt.createBlock(Wt.Fragment, null, ["page" === r2.type ? (Wt.openBlock(), Wt.createBlock(Wt.unref(R), { key: n6, "as-child": "", value: r2.value, class: _2.value.item({ class: null == (u6 = i2.ui) ? void 0 : u6.item }) }, { default: Wt.withCtx(() => [Wt.renderSlot(t2.$slots, "item", Wt.mergeProps({ ref_for: true }, { item: r2, index: n6, page: o3, pageCount: l3 }), () => {
            var t3;
            return [Wt.createVNode(kb, { color: o3 === r2.value ? a2.activeColor : a2.color, variant: o3 === r2.value ? a2.activeVariant : a2.variant, size: a2.size, label: String(r2.value), ui: { label: _2.value.label() }, to: null == (t3 = a2.to) ? void 0 : t3.call(a2, r2.value), square: "" }, null, 8, ["color", "variant", "size", "label", "ui", "to"])];
        ...
        a2.showControls || d2.first ? u5(om.ssrRenderComponent(Wt.unref(y), { "as-child": "", class: _2.value.first({ class: null == (v4 = i2.ui) ? void 0 : v4.first }) }, { default: Wt.withCtx((o4, l4, n6, i3) => {
          if (!l4) return [Wt.renderSlot(t2.$slots, "first", {}, () => {
            var t3;
            return [Wt.createVNode(kb, { color: a2.color, variant: a2.variant, size: a2.size, icon: g2.value, to: null == (t3 = a2.to) ? void 0 : t3.call(a2, 1) }, null, 8, ["color", "variant", "size", "icon", "to"])];
          })];
          om.ssrRenderSlot(t2.$slots, "first", {}, () => {
            var e2;
            l4(om.ssrRenderComponent(kb, { color: a2.color, variant: a2.variant, size: a2.size, icon: g2.value, to: null == (e2 = a2.to) ? void 0 : e2.call(a2, 1) }, null, n6, i3));
          }, l4, n6, i3);
        }), _: 2 }, c4, p3)) : u5("<!---->"), a2.showControls || d2.prev ? u5(om.ssrRenderComponent(Wt.unref($), { "as-child": "", class: _2.value.prev({ class: null == (f2 = i2.ui) ? void 0 : f2.prev }) }, { default: Wt.withCtx((l4, n6, i3, u6) => {
          if (!n6) return [Wt.renderSlot(t2.$slots, "prev", {}, () => {
            var t3;
            return [Wt.createVNode(kb, { color: a2.color, variant: a2.variant, size: a2.size, icon: h2.value, to: o3 > 1 ? null == (t3 = a2.to) ? void 0 : t3.call(a2, o3 - 1) : void 0 }, null, 8, ["color", "variant", "size", "icon", "to"])];
          })];
          om.ssrRenderSlot(t2.$slots, "prev", {}, () => {
            var e2;
            n6(om.ssrRenderComponent(kb, { color: a2.color, variant: a2.variant, size: a2.size, icon: h2.value, to: o3 > 1 ? null == (e2 = a2.to) ? void 0 : e2.call(a2, o3 - 1) : void 0 }, null, i3, u6));
          }, n6, i3, u6);
        }), _: 2 }, c4, p3)) : u5("<!---->"), u5("<!--[-->"), om.ssrRenderList(n5, (n6, d3) => {
          var v5, g3;
          u5("<!--[-->"), "page" === n6.type ? u5(om.ssrRenderComponent(Wt.unref(R), { key: d3, "as-child": "", value: n6.value, class: _2.value.item({ class: null == (v5 = i2.ui) ? void 0 : v5.item }) }, { default: Wt.withCtx((i3, u6, c5, p4) => {
            if (!u6) return [Wt.renderSlot(t2.$slots, "item", Wt.mergeProps({ ref_for: true }, { item: n6, index: d3, page: o3, pageCount: l3 }), () => {
              var t3;
              return [Wt.createVNode(kb, { color: o3 === n6.value ? a2.activeColor : a2.color, variant: o3 === n6.value ? a2.activeVariant : a2.variant, size: a2.size, label: String(n6.value), ui: { label: _2.value.label() }, to: null == (t3 = a2.to) ? void 0 : t3.call(a2, n6.value), square: "" }, null, 8, ["color", "variant", "size", "label", "ui", "to"])];
            })];
            om.ssrRenderSlot(t2.$slots, "item", Wt.mergeProps({ ref_for: true }, { item: n6, index: d3, page: o3, pageCount: l3 }), () => {
              var e2;
              u6(om.ssrRenderComponent(kb, { color: o3 === n6.value ? a2.activeColor : a2.color, variant: o3 === n6.value ? a2.activeVariant : a2.variant, size: a2.size, label: String(n6.value), ui: { label: _2.value.label() }, to: null == (e2 = a2.to) ? void 0 : e2.call(a2, n6.value), square: "" }, null, c5, p4));
            }, u6, c5, p4);
          }), _: 2 }, c4, p3)) : u5(om.ssrRenderComponent(Wt.unref(k), { key: n6.type, index: d3, "as-child": "", class: _2.value.ellipsis({ class: null == (g3 = i2.ui) ? void 0 : g3.ellipsis }) }, { default: Wt.withCtx((o4, l4, n7, i3) => {
            if (!l4) return [Wt.renderSlot(t2.$slots, "ellipsis", {}, () => [Wt.createVNode(kb, { color: a2.color, variant: a2.variant, size: a2.size, icon: a2.ellipsisIcon || Wt.unref(m2).ui.icons.ellipsis }, null, 8, ["color", "variant", "size", "icon"])])];
            om.ssrRenderSlot(t2.$slots, "ellipsis", {}, () => {
              l4(om.ssrRenderComponent(kb, { color: a2.color, variant: a2.variant, size: a2.size, icon: a2.ellipsisIcon || Wt.unref(m2).ui.icons.ellipsis }, null, n7, i3));
            }, l4, n7, i3);
          }), _: 2 }, c4, p3)), u5("<!--]-->");
        }), u5("<!--]-->"), a2.showControls || d2.next ? u5(om.ssrRenderComponent(Wt.unref(P), { "as-child": "", class: _2.value.next({ class: null == (b2 = i2.ui) ? void 0 : b2.next }) }, { default: Wt.withCtx((n6, i3, u6, d3) => {
          if (!i3) return [Wt.renderSlot(t2.$slots, "next", {}, () => {
            var t3;
            return [Wt.createVNode(kb, { color: a2.color, variant: a2.variant, size: a2.size, icon: x2.value, to: o3 < l3 ? null == (t3 = a2.to) ? void 0 : t3.call(a2, o3 + 1) : void 0 }, null, 8, ["color", "variant", "size", "icon", "to"])];
          })];
          om.ssrRenderSlot(t2.$slots, "next", {}, () => {
            var e2;
            i3(om.ssrRenderComponent(kb, { color: a2.color, variant: a2.variant, size: a2.size, icon: x2.value, to: o3 < l3 ? null == (e2 = a2.to) ? void 0 : e2.call(a2, o3 + 1) : void 0 }, null, u6, d3));
          }, i3, u6, d3);
        }), _: 2 }, c4, p3)) : u5("<!---->"), a2.showControls || d2.last ? u5(om.ssrRenderComponent(Wt.unref(w), { "as-child": "", class: _2.value.last({ class: null == (S2 = i2.ui) ? void 0 : S2.last }) }, { default: Wt.withCtx((o4, n6, i3, u6) => {
          if (!n6) return [Wt.renderSlot(t2.$slots, "last", {}, () => {
            var t3;
            return [Wt.createVNode(kb, { color: a2.color, variant: a2.variant, size: a2.size, icon: C2.value, to: null == (t3 = a2.to) ? void 0 : t3.call(a2, l3) }, null, 8, ["color", "variant", "size", "icon", "to"])];
          })];
          om.ssrRenderSlot(t2.$slots, "last", {}, () => {
            var e2;
            n6(om.ssrRenderComponent(kb, { color: a2.color, variant: a2.variant, size: a2.size, icon: C2.value, to: null == (e2 = a2.to) ? void 0 : e2.call(a2, l3) }, null, i3, u6));
          }, n6, i3, u6);
        }), _: 2 }, c4, p3)) : u5("<!---->");
      }), _: 2 }, u4, c3));
    }), _: 3 }, l2));
...
const E = Qs.defineStore("useDataMasterStore", () => {
  ...
  } }], s2 = Wt.ref({ pageIndex: 0, pageSize: 5 }), n2 = E(), i2 = D(), u2 = t(), p2 = Wt.ref(false);
  Wt.ref(false);
...
const M = Wt.defineComponent({ __name: "index", __ssrInlineRender: true, setup(a2) {
  ...
  return (a3, l2, s2, n2) => {
    l2(`<div${om.ssrRenderAttrs(n2)}><div class="mt-5 flex flex-row gap-x-5"><div class="w-[293px] gap-y-2 h-full -intro-x"><div class="bg-secondary px-3 py-2 rounded-lg text-white text-sm font-semibold"> Menu </div><div class="bg-white p-4 rounded-lg min-h-[300px] mt-2"><div class="w-full flex flex-col gap-y-1"><!--[-->`), om.ssrRenderList(Wt.unref(o2), (a4) => {
      l2(`<div class="flex flex-col gap-y-3"><div class="${om.ssrRenderClass([a4.value == Wt.unref(t2) ? "text-777777 bg-PRIMARY bg-opacity-[0.08] border-l-[3px] border-PRIMARY" : "bg-transparent text-777777", "px-2 py-2 text-sm font-medium rounded cursor-pointer transition duration-500 ease-in-out hover:scale-105"])}">${om.ssrInterpolate(a4.text)}</div></div>`);
    }), l2('<!--]--></div></div></div><div class="grow intro-x">'), "mata-kuliah" == Wt.unref(t2) ? l2(om.ssrRenderComponent(I, null, null, s2)) : l2("<!---->"), l2("</div></div></div>");
  };
} }), j = M.setup;
M.setup = (a2, t2) => {
  const o2 = Wt.useSSRContext();
  return (o2.modules || (o2.modules = /* @__PURE__ */ new Set())).add("pages/admin/data-master/index.vue"), j ? j(a2, t2) : void 0;
};

export { M as default };
//# sourceMappingURL=index-BklKjTU-.mjs.map
