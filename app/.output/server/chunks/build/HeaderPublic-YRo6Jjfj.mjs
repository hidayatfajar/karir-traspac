import { v as Wt, $ as Bs, b as Fs, f as fa, s as om, _ as kb, u as ua, r as Mm, t as Hy } from './server.mjs';
import { l } from './useLocale-BepRiSpk.mjs';
import { O } from './usePortal-DzDMWCd7.mjs';
import { F } from './useForwardPropsEmits-DnSfSOTI.mjs';
import { B as B$1, b, P, w, h, D, k, C } from './DialogPortal-BClYAy6o.mjs';
...
const S = { slots: { overlay: "fixed inset-0 bg-elevated/75", content: "fixed bg-default divide-y divide-default sm:ring ring-default sm:shadow-lg flex flex-col focus:outline-none", header: "flex items-center gap-1.5 p-4 sm:px-6 min-h-16", wrapper: "", body: "flex-1 overflow-y-auto p-4 sm:p-6", footer: "flex items-center gap-1.5 p-4 sm:px-6", title: "text-highlighted font-semibold", description: "mt-1 text-muted text-sm", close: "absolute top-4 end-4" }, variants: { side: { top: { content: "inset-x-0 top-0 max-h-full" }, right: { content: "right-0 inset-y-0 w-full max-w-md" }, bottom: { content: "inset-x-0 bottom-0 max-h-full" }, left: { content: "left-0 inset-y-0 w-full max-w-md" } }, transition: { true: { overlay: "data-[state=open]:animate-[fade-in_200ms_ease-out] data-[state=closed]:animate-[fade-out_200ms_ease-in]" } } }, compoundVariants: [{ transition: true, side: "top", class: { content: "data-[state=open]:animate-[slide-in-from-top_200ms_ease-in-out] data-[state=closed]:animate-[slide-out-to-top_200ms_ease-in-out]" } }, { transition: true, side: "right", class: { content: "data-[state=open]:animate-[slide-in-from-right_200ms_ease-in-out] data-[state=closed]:animate-[slide-out-to-right_200ms_ease-in-out]" } }, { transition: true, side: "bottom", class: { content: "data-[state=open]:animate-[slide-in-from-bottom_200ms_ease-in-out] data-[state=closed]:animate-[slide-out-to-bottom_200ms_ease-in-out]" } }, { transition: true, side: "left", class: { content: "data-[state=open]:animate-[slide-in-from-left_200ms_ease-in-out] data-[state=closed]:animate-[slide-out-to-left_200ms_ease-in-out]" } }] }, B = { __name: "Slideover", __ssrInlineRender: true, props: { title: { type: String, required: false }, description: { type: String, required: false }, content: { type: Object, required: false }, overlay: { type: Boolean, required: false, default: true }, transition: { type: Boolean, required: false, default: true }, side: { type: null, required: false, default: "right" }, portal: { type: [Boolean, String], required: false, skipCheck: true, default: true }, close: { type: [Boolean, Object], required: false, default: true }, closeIcon: { type: String, required: false }, dismissible: { type: Boolean, required: false, default: true }, class: { type: null, required: false }, ui: { type: null, required: false }, open: { type: Boolean, required: false }, defaultOpen: { type: Boolean, required: false }, modal: { type: Boolean, required: false, default: true } }, emits: ["after:leave", "after:enter", "close:prevent", "update:open"], setup(n2, { emit: a2 }) {
  const i2 = n2, b2 = a2, g2 = Wt.useSlots(), { t: B2 } = l(), V2 = ua(), _2 = F(Mm(i2, "open", "defaultOpen", "modal"), b2), N2 = O(Wt.toRef(() => i2.portal)), $ = Wt.toRef(() => i2.content), w$1 = Wt.computed(() => {
    ...
    var e2;
    return Hy({ extend: Hy(S), ...(null == (e2 = V2.ui) ? void 0 : e2.slideover) || {} })({ transition: i2.transition, side: i2.side });
  });
  return (t2, o2, l2, a3) => {
    o2(om.ssrRenderComponent(Wt.unref(B$1), Wt.mergeProps(Wt.unref(_2), a3), { default: Wt.withCtx(({ open: o3, close: l3 }, a4, c2, d2) => {
      if (!a4) return [g2.default ? (Wt.openBlock(), Wt.createBlock(Wt.unref(b), { key: 0, "as-child": "", class: i2.class }, { default: Wt.withCtx(() => [Wt.renderSlot(t2.$slots, "default", { open: o3 })]), _: 2 }, 1032, ["class"])) : Wt.createCommentVNode("", true), Wt.createVNode(Wt.unref(P), Wt.unref(N2), { default: Wt.withCtx(() => {
        var o4, r2;
      ...
      g2.default ? a4(om.ssrRenderComponent(Wt.unref(b), { "as-child": "", class: i2.class }, { default: Wt.withCtx((l4, s2, n3, a5) => {
        if (!s2) return [Wt.renderSlot(t2.$slots, "default", { open: o3 })];
        om.ssrRenderSlot(t2.$slots, "default", { open: o3 }, null, s2, n3, a5);
      }), _: 2 }, c2, d2)) : a4("<!---->"), a4(om.ssrRenderComponent(Wt.unref(P), Wt.unref(N2), { default: Wt.withCtx((o4, a5, c3, d3) => {
        var u2, p2, m2, f2;
        ...
        n2.overlay ? a5(om.ssrRenderComponent(Wt.unref(w), { class: R.value.overlay({ class: null == (u2 = i2.ui) ? void 0 : u2.overlay }) }, null, c3, d3)) : a5("<!---->"), a5(om.ssrRenderComponent(Wt.unref(h), Wt.mergeProps({ "data-side": n2.side, class: R.value.content({ class: [!g2.default && i2.class, null == (p2 = i2.ui) ? void 0 : p2.content] }) }, $.value, { onAfterEnter: (e2) => b2("after:enter"), onAfterLeave: (e2) => b2("after:leave") }, Wt.toHandlers(w$1.value)), { default: Wt.withCtx((o5, a6, c4, d4) => {
          ...
          g2.content && (n2.title || g2.title || n2.description || g2.description) ? a6(om.ssrRenderComponent(Wt.unref(d$1), null, { default: Wt.withCtx((o6, l4, s2, a7) => {
            if (!l4) return [n2.title || g2.title ? (Wt.openBlock(), Wt.createBlock(Wt.unref(D), { key: 0 }, { default: Wt.withCtx(() => [Wt.renderSlot(t2.$slots, "title", {}, () => [Wt.createTextVNode(Wt.toDisplayString(n2.title), 1)])]), _: 3 })) : Wt.createCommentVNode("", true), n2.description || g2.description ? (Wt.openBlock(), Wt.createBlock(Wt.unref(k), { key: 1 }, { default: Wt.withCtx(() => [Wt.renderSlot(t2.$slots, "description", {}, () => [Wt.createTextVNode(Wt.toDisplayString(n2.description), 1)])]), _: 3 })) : Wt.createCommentVNode("", true)];
            n2.title || g2.title ? l4(om.ssrRenderComponent(Wt.unref(D), null, { default: Wt.withCtx((o7, l5, s3, a8) => {
              ...
              om.ssrRenderSlot(t2.$slots, "title", {}, () => {
                l5(`${om.ssrInterpolate(n2.title)}`);
              }, l5, s3, a8);
            }), _: 2 }, s2, a7)) : l4("<!---->"), n2.description || g2.description ? l4(om.ssrRenderComponent(Wt.unref(k), null, { default: Wt.withCtx((o7, l5, s3, a8) => {
              ...
              om.ssrRenderSlot(t2.$slots, "description", {}, () => {
                l5(`${om.ssrInterpolate(n2.description)}`);
              }, l5, s3, a8);
            }), _: 2 }, s2, a7)) : l4("<!---->");
          }), _: 2 }, c4, d4)) : a6("<!---->"), om.ssrRenderSlot(t2.$slots, "content", { close: l3 }, () => {
            var o6, u3, p3;
            g2.header || n2.title || g2.title || n2.description || g2.description || i2.close || g2.close ? (a6(`<div class="${om.ssrRenderClass(R.value.header({ class: null == (o6 = i2.ui) ? void 0 : o6.header }))}"${d4}>`), om.ssrRenderSlot(t2.$slots, "header", { close: l3 }, () => {
              var o7, u4, p4;
              a6(`<div class="${om.ssrRenderClass(R.value.wrapper({ class: null == (o7 = i2.ui) ? void 0 : o7.wrapper }))}"${d4}>`), n2.title || g2.title ? a6(om.ssrRenderComponent(Wt.unref(D), { class: R.value.title({ class: null == (u4 = i2.ui) ? void 0 : u4.title }) }, { default: Wt.withCtx((o8, l4, s2, a7) => {
                if (!l4) return [Wt.renderSlot(t2.$slots, "title", {}, () => [Wt.createTextVNode(Wt.toDisplayString(n2.title), 1)])];
                om.ssrRenderSlot(t2.$slots, "title", {}, () => {
                  l4(`${om.ssrInterpolate(n2.title)}`);
                }, l4, s2, a7);
              }), _: 2 }, c4, d4)) : a6("<!---->"), n2.description || g2.description ? a6(om.ssrRenderComponent(Wt.unref(k), { class: R.value.description({ class: null == (p4 = i2.ui) ? void 0 : p4.description }) }, { default: Wt.withCtx((o8, l4, s2, a7) => {
                if (!l4) return [Wt.renderSlot(t2.$slots, "description", {}, () => [Wt.createTextVNode(Wt.toDisplayString(n2.description), 1)])];
                om.ssrRenderSlot(t2.$slots, "description", {}, () => {
                  l4(`${om.ssrInterpolate(n2.description)}`);
                }, l4, s2, a7);
              }), _: 2 }, c4, d4)) : a6("<!---->"), a6("</div>"), om.ssrRenderSlot(t2.$slots, "actions", {}, null, a6, c4, d4), i2.close || g2.close ? a6(om.ssrRenderComponent(Wt.unref(C), { "as-child": "" }, { default: Wt.withCtx((o8, a7, c5, d5) => {
                ...
                om.ssrRenderSlot(t2.$slots, "close", { close: l3, ui: R.value }, () => {
                  var t3;
                  i2.close ? a7(om.ssrRenderComponent(kb, Wt.mergeProps({ icon: n2.closeIcon || Wt.unref(V2).ui.icons.close, color: "neutral", variant: "ghost", "aria-label": Wt.unref(B2)("slideover.close") }, "object" == typeof i2.close ? i2.close : {}, { class: R.value.close({ class: null == (t3 = i2.ui) ? void 0 : t3.close }) }), null, c5, d5)) : a7("<!---->");
                }, a7, c5, d5);
              }), _: 2 }, c4, d4)) : a6("<!---->");
            }, a6, c4, d4), a6("</div>")) : a6("<!---->"), a6(`<div class="${om.ssrRenderClass(R.value.body({ class: null == (u3 = i2.ui) ? void 0 : u3.body }))}"${d4}>`), om.ssrRenderSlot(t2.$slots, "body", { close: l3 }, null, a6, c4, d4), a6("</div>"), g2.footer ? (a6(`<div class="${om.ssrRenderClass(R.value.footer({ class: null == (p3 = i2.ui) ? void 0 : p3.footer }))}"${d4}>`), om.ssrRenderSlot(t2.$slots, "footer", { close: l3 }, null, a6, c4, d4), a6("</div>")) : a6("<!---->");
          }, a6, c4, d4);
        }), _: 2 }, c3, d3));
      }), _: 2 }, c2, d2));
    }), _: 3 }, l2));
...
const _ = Wt.defineComponent({ __name: "HeaderPublic", __ssrInlineRender: true, setup(t2) {
  const o2 = Bs(), l2 = Fs();
  fa(), Wt.ref(false), Wt.ref(false), Wt.ref(false);
  const c2 = Wt.computed(() => true), d2 = Wt.ref(false), u2 = [{ label: "Beranda", to: "/" }, { label: "Lowongan", to: "/lowongan" }, { label: "FAQ", to: "/faq" }], p2 = () => {
  ...
  return (t3, l3, n2, a2) => {
    const i2 = kb, v2 = B, k2 = d, x2 = Wt.resolveComponent("UDivider");
    l3(`<div${om.ssrRenderAttrs(a2)}><header class="sticky top-0 w-full bg-white/80 backdrop-blur-lg z-50 border-b border-slate-200/80"><div class="max-w-7xl mx-auto"><nav class="px-6 py-4"><div class="flex items-center justify-between"><div class="flex items-center"><img${om.ssrRenderAttr("src", s)} alt="Karir Traspac" class="w-32 object-contain mx-auto cursor-pointer"></div><div class="hidden lg:flex items-center space-x-2"><!--[-->`), om.ssrRenderList(u2, (s2) => {
      l3(om.ssrRenderComponent(i2, { key: s2.to, label: s2.label, onClick: (e2) => t3.$router.push(s2.to), class: ["w-full", Wt.unref(o2).path === s2.to ? "border-b-3 border-primary rounded-b-none" : ""], color: "neutral", variant: "ghost", size: "lg" }, null, n2));
    }), l3("<!--]-->"), Wt.unref(c2) ? l3(om.ssrRenderComponent(i2, { label: "Dashboard", onClick: (e2) => t3.$router.push("/pelamar"), class: ["w-full", "/pelamar" === Wt.unref(o2).path ? "border-b-3 border-primary rounded-b-none" : ""], color: "neutral", variant: "ghost", size: "lg" }, null, n2)) : l3("<!---->"), Wt.unref(c2) ? l3("<!---->") : l3(om.ssrRenderComponent(i2, { label: "Login", onClick: (e2) => t3.$router.push("/auth/login"), size: "lg", class: "border border-neutral-200 hover:border-neutral-300 px-8 rounded-2xl", color: "primary" }, null, n2)), l3('</div><div class="lg:hidden flex">'), l3(om.ssrRenderComponent(i2, { icon: "i-mdi-menu", color: "neutral", variant: "ghost", onClick: (e2) => d2.value = true }, null, n2)), l3("</div>"), l3(om.ssrRenderComponent(v2, { open: Wt.unref(d2), "onUpdate:open": (t4) => Wt.isRef(d2) ? d2.value = t4 : null }, { title: Wt.withCtx((e2, t4, o3, l4) => {
      if (!t4) return [];
    }), content: Wt.withCtx((l4, s2, n3, a3) => {
      if (!s2) return [Wt.createVNode(k2, { class: "flex flex-col flex-1 lg:hidden px-2" }, { default: Wt.withCtx(() => [Wt.createVNode("div", { class: "flex items-center justify-between mb-4" }, [Wt.createVNode("img", { src: s, alt: "Karir Traspac", class: "w-32 object-contain cursor-pointer", onClick: p2 }), Wt.createVNode(i2, { color: "neutral", variant: "ghost", icon: "i-mdi-close", class: "-my-1", onClick: (e2) => d2.value = false }, null, 8, ["onClick"])]), Wt.unref(c2) ? Wt.createCommentVNode("", true) : (Wt.openBlock(), Wt.createBlock("div", { key: 0, class: "flex flex-col items-center justify-center h-full gap-4" }, [(Wt.openBlock(), Wt.createBlock(Wt.Fragment, null, Wt.renderList(u2, (t4) => Wt.createVNode(i2, { key: t4.to, label: t4.label, onClick: (e2) => m2(t4.to), class: ["w-fit", Wt.unref(o2).path === t4.to ? "border-b-2 border-primary rounded-b-none" : ""], color: "neutral", variant: "ghost", size: "xl" }, null, 8, ["label", "onClick", "class"])), 64)), Wt.createVNode(x2, { class: "my-4" }), Wt.createVNode(i2, { label: "Login", onClick: (e2) => t3.$router.push("/auth/login"), color: "neutral", variant: "outline", size: "xl", block: "" }, null, 8, ["onClick"]), Wt.createVNode(i2, { label: "Daftar", onClick: (e2) => t3.$router.push("/auth/register"), size: "xl", block: "" }, null, 8, ["onClick"])])), Wt.unref(c2) ? (Wt.openBlock(), Wt.createBlock("div", { key: 1 }, [Wt.createVNode(i2, { label: "Dashboard", onClick: f2, color: "neutral", variant: "outline", size: "xl", block: "" })])) : Wt.createCommentVNode("", true)]), _: 1 })];
      s2(om.ssrRenderComponent(k2, { class: "flex flex-col flex-1 lg:hidden px-2" }, { default: Wt.withCtx((l5, s3, n4, a4) => {
        if (!s3) return [Wt.createVNode("div", { class: "flex items-center justify-between mb-4" }, [Wt.createVNode("img", { src: s, alt: "Karir Traspac", class: "w-32 object-contain cursor-pointer", onClick: p2 }), Wt.createVNode(i2, { color: "neutral", variant: "ghost", icon: "i-mdi-close", class: "-my-1", onClick: (e2) => d2.value = false }, null, 8, ["onClick"])]), Wt.unref(c2) ? Wt.createCommentVNode("", true) : (Wt.openBlock(), Wt.createBlock("div", { key: 0, class: "flex flex-col items-center justify-center h-full gap-4" }, [(Wt.openBlock(), Wt.createBlock(Wt.Fragment, null, Wt.renderList(u2, (t4) => Wt.createVNode(i2, { key: t4.to, label: t4.label, onClick: (e2) => m2(t4.to), class: ["w-fit", Wt.unref(o2).path === t4.to ? "border-b-2 border-primary rounded-b-none" : ""], color: "neutral", variant: "ghost", size: "xl" }, null, 8, ["label", "onClick", "class"])), 64)), Wt.createVNode(x2, { class: "my-4" }), Wt.createVNode(i2, { label: "Login", onClick: (e2) => t3.$router.push("/auth/login"), color: "neutral", variant: "outline", size: "xl", block: "" }, null, 8, ["onClick"]), Wt.createVNode(i2, { label: "Daftar", onClick: (e2) => t3.$router.push("/auth/register"), size: "xl", block: "" }, null, 8, ["onClick"])])), Wt.unref(c2) ? (Wt.openBlock(), Wt.createBlock("div", { key: 1 }, [Wt.createVNode(i2, { label: "Dashboard", onClick: f2, color: "neutral", variant: "outline", size: "xl", block: "" })])) : Wt.createCommentVNode("", true)];
        s3(`<div class="flex items-center justify-between mb-4"${a4}><img${om.ssrRenderAttr("src", s)} alt="Karir Traspac" class="w-32 object-contain cursor-pointer"${a4}>`), s3(om.ssrRenderComponent(i2, { color: "neutral", variant: "ghost", icon: "i-mdi-close", class: "-my-1", onClick: (e2) => d2.value = false }, null, n4, a4)), s3("</div>"), Wt.unref(c2) ? s3("<!---->") : (s3(`<div class="flex flex-col items-center justify-center h-full gap-4"${a4}><!--[-->`), om.ssrRenderList(u2, (t4) => {
          s3(om.ssrRenderComponent(i2, { key: t4.to, label: t4.label, onClick: (e2) => m2(t4.to), class: ["w-fit", Wt.unref(o2).path === t4.to ? "border-b-2 border-primary rounded-b-none" : ""], color: "neutral", variant: "ghost", size: "xl" }, null, n4, a4));
        }), s3("<!--]-->"), s3(om.ssrRenderComponent(x2, { class: "my-4" }, null, n4, a4)), s3(om.ssrRenderComponent(i2, { label: "Login", onClick: (e2) => t3.$router.push("/auth/login"), color: "neutral", variant: "outline", size: "xl", block: "" }, null, n4, a4)), s3(om.ssrRenderComponent(i2, { label: "Daftar", onClick: (e2) => t3.$router.push("/auth/register"), size: "xl", block: "" }, null, n4, a4)), s3("</div>")), Wt.unref(c2) ? (s3(`<div${a4}>`), s3(om.ssrRenderComponent(i2, { label: "Dashboard", onClick: f2, color: "neutral", variant: "outline", size: "xl", block: "" }, null, n4, a4)), s3("</div>")) : s3("<!---->");
      }), _: 1 }, n3, a3));
    }), _: 1 }, n2)), l3("</div></nav></div></header></div>");
  };
} }), N = _.setup;
_.setup = (t2, o2) => {
  const l2 = Wt.useSSRContext();
  return (l2.modules || (l2.modules = /* @__PURE__ */ new Set())).add("components/common/layouts/HeaderPublic.vue"), N ? N(t2, o2) : void 0;
};

export { _ as default };
//# sourceMappingURL=HeaderPublic-YRo6Jjfj.mjs.map
