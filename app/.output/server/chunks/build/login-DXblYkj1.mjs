...
import { _ as G$1, a as N$1 } from './TextField-DvcL8FOr.mjs';
import { v as Wt, f as ha, b as Fs, s as pm, c as yb, g as la, _ as Rb, u as da, a as Tm, r as Bm, e as sg, t as Ky, P as _m } from './server.mjs';
import { N as N$2, T as T$1, C } from './useForwardPropsEmits-WwvTsoLV.mjs';
...
import { l } from './RovingFocusGroup-CVcAGu6G.mjs';
import { f, c } from './usePortal-DtLtCtVs.mjs';
...
const [q, z] = T$1("CheckboxGroupRoot");
function $(e2) {
  return "indeterminate" === e2;
}
function P(e2) {
  return $(e2) ? "indeterminate" : e2 ? "checked" : "unchecked";
}
const D = Wt.defineComponent({ __name: "RovingFocusItem", props: { tabStopId: {}, focusable: { type: Boolean, default: true }, active: { type: Boolean }, allowShiftKey: { type: Boolean }, asChild: { type: Boolean }, as: { default: "span" } }, setup(e2) {
...
} }), [N, A] = T$1("CheckboxRoot"), M = Wt.defineComponent({ inheritAttrs: false, __name: "CheckboxRoot", props: { defaultValue: { type: [Boolean, String] }, modelValue: { type: [Boolean, String, null], default: void 0 }, disabled: { type: Boolean }, value: { default: "on" }, id: {}, asChild: { type: Boolean }, as: { default: "button" }, name: {}, required: { type: Boolean } }, emits: ["update:modelValue"], setup(e2, { emit: a2 }) {
  const r2 = e2, o2 = a2, { forwardRef: i2, currentElement: l2 } = N$2(), n2 = q(null), d2 = C(r2, "modelValue", o2, { defaultValue: r2.defaultValue, passive: void 0 === r2.modelValue }), u2 = Wt.computed(() => (null == n2 ? void 0 : n2.disabled.value) || r2.disabled), c2 = Wt.computed(() => n(null == n2 ? void 0 : n2.modelValue.value) ? "indeterminate" === d2.value ? "indeterminate" : d2.value : T(n2.modelValue.value, r2.value));
  function p2() {
    if (n(null == n2 ? void 0 : n2.modelValue.value)) d2.value = !!$(d2.value) || !d2.value;
    else {
  ...
  return A({ disabled: u2, state: c2 }), (e3, a3) => {
    var r3, o3;
    return Wt.openBlock(), Wt.createBlock(Wt.resolveDynamicComponent((null == (r3 = Wt.unref(n2)) ? void 0 : r3.rovingFocus.value) ? Wt.unref(D) : Wt.unref(_m)), Wt.mergeProps(e3.$attrs, { id: e3.id, ref: Wt.unref(i2), role: "checkbox", "as-child": e3.asChild, as: e3.as, type: "button" === e3.as ? "button" : void 0, "aria-checked": Wt.unref($)(c2.value) ? "mixed" : c2.value, "aria-required": e3.required, "aria-label": e3.$attrs["aria-label"] || v2.value, "data-state": Wt.unref(P)(c2.value), "data-disabled": u2.value ? "" : void 0, disabled: u2.value, focusable: (null == (o3 = Wt.unref(n2)) ? void 0 : o3.rovingFocus.value) ? !u2.value : void 0, onKeydown: Wt.withKeys(Wt.withModifiers(() => {
  ...
  return (e3, o2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(f), { present: e3.forceMount || Wt.unref($)(Wt.unref(r2).state.value) || true === Wt.unref(r2).state.value }, { default: Wt.withCtx(() => [Wt.createVNode(Wt.unref(_m), Wt.mergeProps({ ref: Wt.unref(a2), "data-state": Wt.unref(P)(Wt.unref(r2).state.value), "data-disabled": Wt.unref(r2).disabled.value ? "" : void 0, style: { pointerEvents: "none" }, "as-child": e3.asChild, as: e3.as }, e3.$attrs), { default: Wt.withCtx(() => [Wt.renderSlot(e3.$slots, "default")]), _: 3 }, 16, ["data-state", "data-disabled", "as-child", "as"])]), _: 3 }, 8, ["present"]));
  ...
  var _a;
  const p2 = e2, m2 = Wt.useSlots(), v2 = r2, f2 = Wt.useModel(e2, "modelValue", { type: [Boolean, String], default: void 0 }), b2 = da(), x2 = Tm(Bm(p2, "required", "value", "defaultValue")), { id: h2, emitFormChange: g2, emitFormInput: w2, size: y2, color: k2, name: _2, disabled: C2, ariaAttrs: R2 } = sg(p2), V2 = (_a = h2.value) != null ? _a : Wt.useId(), S2 = Wt.computed(() => {
    var e3;
    return Ky({ extend: Ky(K), ...(null == (e3 = b2.ui) ? void 0 : e3.checkbox) || {} })({ size: y2.value, color: k2.value, variant: p2.variant, indicator: p2.indicator, required: p2.required, disabled: C2.value });
  });
  function B2(e3) {
  ...
  return (r3, o2, i2, l2) => {
    ...
    o2(pm.ssrRenderComponent(Wt.unref(_m), Wt.mergeProps({ as: e2.variant && "list" !== e2.variant ? Wt.unref(N$1) : e2.as, class: S2.value.root({ class: [null == (n2 = p2.ui) ? void 0 : n2.root, p2.class] }) }, l2), { default: Wt.withCtx((s2, o3, i3, l3) => {
      ...
      o3(`<div class="${pm.ssrRenderClass(S2.value.container({ class: null == (n3 = p2.ui) ? void 0 : n3.container }))}"${l3}>`), o3(pm.ssrRenderComponent(Wt.unref(M), Wt.mergeProps({ id: Wt.unref(V2) }, { ...Wt.unref(x2), ...r3.$attrs, ...Wt.unref(R2) }, { modelValue: f2.value, "onUpdate:modelValue": [(e3) => f2.value = e3, B2], name: Wt.unref(_2), disabled: Wt.unref(C2), class: S2.value.base({ class: null == (d2 = p2.ui) ? void 0 : d2.base }) }), { default: Wt.withCtx(({ modelValue: a2 }, r4, s3, o4) => {
        ...
        r4(pm.ssrRenderComponent(Wt.unref(E), { class: S2.value.indicator({ class: null == (i4 = p2.ui) ? void 0 : i4.indicator }) }, { default: Wt.withCtx((r5, s4, o5, i5) => {
          var l5, n4, d3, m3;
          if (!s4) return ["indeterminate" === a2 ? (Wt.openBlock(), Wt.createBlock(yb, { key: 0, name: e2.indeterminateIcon || Wt.unref(b2).ui.icons.minus, class: S2.value.icon({ class: null == (d3 = p2.ui) ? void 0 : d3.icon }) }, null, 8, ["name", "class"])) : (Wt.openBlock(), Wt.createBlock(yb, { key: 1, name: e2.icon || Wt.unref(b2).ui.icons.check, class: S2.value.icon({ class: null == (m3 = p2.ui) ? void 0 : m3.icon }) }, null, 8, ["name", "class"]))];
          s4("indeterminate" === a2 ? pm.ssrRenderComponent(yb, { name: e2.indeterminateIcon || Wt.unref(b2).ui.icons.minus, class: S2.value.icon({ class: null == (l5 = p2.ui) ? void 0 : l5.icon }) }, null, o5, i5) : pm.ssrRenderComponent(yb, { name: e2.icon || Wt.unref(b2).ui.icons.check, class: S2.value.icon({ class: null == (n4 = p2.ui) ? void 0 : n4.icon }) }, null, o5, i5));
        }), _: 2 }, s3, o4));
...
const U = Wt.defineComponent({ __name: "login", __ssrInlineRender: true, setup(a2) {
  ...
  return Wt.ref([{ user_id: "123", username: "user1", user_group_id: "01", roles: "admin" }, { user_id: "124", username: "user2", user_group_id: "02", roles: "interviewer" }, { user_id: "125", username: "user3", user_group_id: "03", roles: "pelamar" }]), (a3, o3, p2, m2) => {
    const x2 = u, h2 = G$1, g2 = yb, w2 = F, y2 = la, k2 = Rb;
    ...
    }), _: 1 }, p2)), o3('<div class="self-stretch flex justify-between items-center">'), o3(pm.ssrRenderComponent(w2, { modelValue: Wt.unref(i2).is_remember, "onUpdate:modelValue": (e2) => Wt.unref(i2).is_remember = e2, id: "rememberMe", label: "Ingat Saya" }, null, p2)), o3(pm.ssrRenderComponent(y2, { to: "/auth/forget-password", class: "text-sm font-medium text-PRIMARY hover:text-opacity-80" }, { default: Wt.withCtx((e2, a4, r2, s3) => {
      if (!a4) return [Wt.createTextVNode(" Lupa password? ")];
      a4(" Lupa password? ");
    }), _: 1 }, p2)), o3('</div></div><div class="w-full space-y-4 mt-8">'), o3(pm.ssrRenderComponent(k2, { class: "rounded-xl font-semibold text-base text-white bg-[#0c315a]", color: "primary", variant: "solid", size: "xl", block: "", loading: Wt.unref(n2).simpan, disabled: Wt.unref(n2).simpan, onClick: (e2) => d2() }, { default: Wt.withCtx((e2, a4, r2, s3) => {
      if (!a4) return [Wt.createTextVNode(" Masuk ")];
      a4(" Masuk ");
    }), _: 1 }, p2)), o3('<div class="relative flex items-center py-2"><div class="flex-grow border-t border-neutral-200"></div><span class="flex-shrink mx-4 text-sm text-neutral-500">Atau login dengan</span><div class="flex-grow border-t border-neutral-200"></div></div>'), o3(pm.ssrRenderComponent(k2, { class: "rounded-xl bg-white ring-[#0c315a] text-[#0c315a] hover:bg-[#0c315a]/10", color: "primary", variant: "outline", avatar: { src: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Google_%22G%22_logo.svg/1024px-Google_%22G%22_logo.svg.png" }, size: "xl", block: "", loading: Wt.unref(n2).simpan, disabled: Wt.unref(n2).simpan, onClick: (e2) => (l2.value = { show: true, message: "Berhasil login (dummy)", error: false }, void setTimeout(() => {
    ...
    }), _: 1 }, p2)), o3('</div><div class="text-center mt-8"><p class="text-sm text-neutral-500"> Belum punya akun? '), o3(pm.ssrRenderComponent(y2, { to: "/auth/register", class: "font-medium text-PRIMARY hover:text-opacity-80" }, { default: Wt.withCtx((e2, a4, r2, s3) => {
...
U.setup = (e2, a2) => {
  const r2 = Wt.useSSRContext();
  return (r2.modules || (r2.modules = /* @__PURE__ */ new Set())).add("pages/auth/login.vue"), Y ? Y(e2, a2) : void 0;
};

export { U as default };
//# sourceMappingURL=login-DXblYkj1.mjs.map
