import { v as Wt, u as ua, r as Mm, e as eg, h as _m, i as wm, t as Hy, z as hg, s as om, c as hb, d as Sb, A as pg, C as bb, P as xm, B as dg, a as Sm } from './server.mjs';
import { m as defu, j as isEqual } from '../_/nitro.mjs';
import { O, c, b, f, h } from './usePortal-DzDMWCd7.mjs';
import { F, C, T, N, O as O$1, P } from './useForwardPropsEmits-DnSfSOTI.mjs';
import { $ as $e, H as He, q as qe, I as Ie$1 } from './PopperArrow-BQDIGHqG.mjs';
import { d } from './VisuallyHidden-CudQpOEQ.mjs';
import { l } from './Collection-CK0B56BN.mjs';
import { n as n$1 } from './usePrimitiveElement-BqlHGOiE.mjs';
import { e } from './useFormControl-BKZlrIrW.mjs';
import { n } from './nullish-aV-w2MPu.mjs';
import { r } from './useTypeahead-CXda91ln.mjs';
...
const Q = Wt.defineComponent({ __name: "BubbleSelect", props: { autocomplete: {}, autofocus: { type: Boolean }, disabled: { type: Boolean }, form: {}, multiple: { type: Boolean }, name: {}, required: { type: Boolean }, size: {}, value: {} }, setup(l2) {
  ...
  } }), (t3, a3) => (Wt.openBlock(), Wt.createElementBlock("div", { ref_key: "contentWrapperElement", ref: c2, style: Wt.normalizeStyle({ display: "flex", flexDirection: "column", position: "fixed", zIndex: k2.value }) }, [Wt.createVNode(Wt.unref(xm), Wt.mergeProps({ ref: Wt.unref(p2), style: { boxSizing: "border-box", maxHeight: "100%" } }, { ...t3.$attrs, ...i2 }), { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "default")]), _: 3 }, 16)], 4));
  ...
  const C2 = Wt.computed(() => "popper" === i2.position ? i2 : {}), S2 = Sm(C2.value);
  ...
  }) }, { default: Wt.withCtx(() => [Wt.createVNode(Wt.unref(h), { "as-child": "", "disable-outside-pointer-events": "", onFocusOutside: t2[2] || (t2[2] = Wt.withModifiers(() => {
  ...
  return he({ id: i2 }), (t3, n2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(xm), Wt.mergeProps({ role: "group" }, a2, { "aria-labelledby": Wt.unref(i2) }), { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "default")]), _: 3 }, 16, ["aria-labelledby"]));
  ...
  const a2 = t2, i2 = ke();
  return (t3, n2) => Wt.unref(i2).isSelected.value ? (Wt.openBlock(), Wt.createBlock(Wt.unref(xm), Wt.mergeProps({ key: 0, "aria-hidden": "true" }, a2), { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "default")]), _: 3 }, 16)) : Wt.createCommentVNode("", true);
  ...
  }), (t3, o3) => (Wt.openBlock(), Wt.createBlock(Wt.unref(xm), Wt.mergeProps({ id: Wt.unref(i2).textId, ref: Wt.unref(n2) }, { ...a2, ...t3.$attrs }), { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "default")]), _: 3 }, 16, ["id"]));
} }), Se = Wt.defineComponent({ __name: "SelectLabel", props: { for: {}, asChild: { type: Boolean }, as: { default: "div" } }, setup(t2) {
  const a2 = t2, i2 = fe({ id: "" });
  return (t3, n2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(xm), Wt.mergeProps(a2, { id: Wt.unref(i2).id }), { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "default")]), _: 3 }, 16, ["id"]));
  ...
  const t2 = l2;
  return (l3, a2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(b), Wt.normalizeProps(Wt.guardReactiveProps(t2)), { default: Wt.withCtx(() => [Wt.renderSlot(l3.$slots, "default")]), _: 3 }, 16));
} }), we = Wt.defineComponent({ __name: "SelectSeparator", props: { asChild: { type: Boolean }, as: {} }, setup(t2) {
  const a2 = t2;
  return (t3, i2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(xm), Wt.mergeProps({ "aria-hidden": "true" }, a2), { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "default")]), _: 3 }, 16));
  ...
  return (t3, a3) => (Wt.openBlock(), Wt.createBlock(Wt.unref(He), { "as-child": "", reference: t3.reference }, { default: Wt.withCtx(() => {
    var d3, v2, m2, g2;
    return [Wt.createVNode(Wt.unref(xm), { ref: Wt.unref(n2), role: "combobox", type: "button" === t3.as ? "button" : void 0, "aria-controls": Wt.unref(i2).contentId, "aria-expanded": Wt.unref(i2).open.value || false, "aria-required": null == (d3 = Wt.unref(i2).required) ? void 0 : d3.value, "aria-autocomplete": "none", disabled: o2.value, dir: null == (v2 = Wt.unref(i2)) ? void 0 : v2.dir.value, "data-state": (null == (m2 = Wt.unref(i2)) ? void 0 : m2.open.value) ? "open" : "closed", "data-disabled": o2.value ? "" : void 0, "data-placeholder": Wt.unref(J)(null == (g2 = Wt.unref(i2).modelValue) ? void 0 : g2.value) ? "" : void 0, "as-child": t3.asChild, as: t3.as, onClick: a3[0] || (a3[0] = (e2) => {
      var l2;
  ...
  const y2 = l2, k2 = h2, b2 = Wt.useSlots(), B2 = ua(), C2 = F(Mm(y2, "open", "defaultOpen", "disabled", "autocomplete", "required", "multiple"), k2), S2 = O(Wt.toRef(() => y2.portal)), L2 = Wt.toRef(() => defu(y2.content, { side: "bottom", sideOffset: 8, collisionPadding: 8, position: "popper" })), w2 = Wt.toRef(() => y2.arrow), { emitFormChange: z2, emitFormInput: _2, emitFormBlur: V2, emitFormFocus: A2, size: T2, color: $2, id: P2, name: N2, highlight: R2, disabled: D2, ariaAttrs: E2 } = eg(y2), { orientation: q2, size: K2 } = _m(y2), { isLeading: F2, isTrailing: O2, leadingIconName: j2, trailingIconName: M2 } = wm(Wt.toRef(() => defu(y2, { trailingIcon: B2.ui.icons.chevronDown }))), W2 = Wt.computed(() => K2.value || T2.value), H2 = Wt.computed(() => {
    var e2;
    return Hy({ extend: Hy(ze), ...(null == (e2 = B2.ui) ? void 0 : e2.select) || {} })({ color: $2.value, variant: y2.variant, size: null == W2 ? void 0 : W2.value, loading: y2.loading, highlight: R2.value, leading: F2.value || !!y2.avatar || !!b2.leading, trailing: O2.value || !!b2.trailing, buttonGroup: q2.value });
  }), U2 = Wt.computed(() => {
    var e2;
    return (null == (e2 = y2.items) ? void 0 : e2.length) ? hg(y2.items) ? y2.items : [y2.items] : [];
  ...
  function Y2(e2) {
    ...
    const l3 = G2.value.find((l4) => dg("object" == typeof l4 ? pg(l4, y2.valueKey) : l4, e2));
    return l3 && ("object" == typeof l3 ? pg(l3, y2.labelKey) : l3);
  }
  ...
  return t2({ triggerRef: X2 }), (t3, a2, i2, n2) => {
    a2(om.ssrRenderComponent(Wt.unref(ae), Wt.mergeProps({ name: Wt.unref(N2) }, Wt.unref(C2), { autocomplete: l2.autocomplete, disabled: Wt.unref(D2), "default-value": l2.defaultValue, "model-value": l2.modelValue, "onUpdate:modelValue": Z2, "onUpdate:open": J2 }, n2), { default: Wt.withCtx(({ modelValue: a3, open: i3 }, n3, o2, r2) => {
      var s2, u2;
      if (!n3) return [Wt.createVNode(Wt.unref(Ie), Wt.mergeProps({ id: Wt.unref(P2), ref_key: "triggerRef", ref: X2, class: H2.value.base({ class: [null == (u2 = y2.ui) ? void 0 : u2.base, y2.class] }) }, { ...t3.$attrs, ...Wt.unref(E2) }), { default: Wt.withCtx(() => {
        var n4, o3;
        return [Wt.unref(F2) || l2.avatar || b2.leading ? (Wt.openBlock(), Wt.createBlock("span", { key: 0, class: H2.value.leading({ class: null == (n4 = y2.ui) ? void 0 : n4.leading }) }, [Wt.renderSlot(t3.$slots, "leading", { modelValue: a3, open: i3, ui: H2.value }, () => {
          var t4, a4, i4;
          return [Wt.unref(F2) && Wt.unref(j2) ? (Wt.openBlock(), Wt.createBlock(hb, { key: 0, name: Wt.unref(j2), class: H2.value.leadingIcon({ class: null == (t4 = y2.ui) ? void 0 : t4.leadingIcon }) }, null, 8, ["name", "class"])) : l2.avatar ? (Wt.openBlock(), Wt.createBlock(Sb, Wt.mergeProps({ key: 1, size: (null == (a4 = y2.ui) ? void 0 : a4.itemLeadingAvatarSize) || H2.value.itemLeadingAvatarSize() }, l2.avatar, { class: H2.value.itemLeadingAvatar({ class: null == (i4 = y2.ui) ? void 0 : i4.itemLeadingAvatar }) }), null, 16, ["size", "class"])) : Wt.createCommentVNode("", true)];
          ...
          var l3;
          return [Wt.unref(M2) ? (Wt.openBlock(), Wt.createBlock(hb, { key: 0, name: Wt.unref(M2), class: H2.value.trailingIcon({ class: null == (l3 = y2.ui) ? void 0 : l3.trailingIcon }) }, null, 8, ["name", "class"])) : Wt.createCommentVNode("", true)];
        ...
        return [Wt.createVNode(Wt.unref(ge), Wt.mergeProps({ class: H2.value.content({ class: null == (a4 = y2.ui) ? void 0 : a4.content }) }, L2.value), { default: Wt.withCtx(() => {
          ...
          return [Wt.renderSlot(t3.$slots, "content-top"), Wt.createVNode("div", { role: "presentation", class: H2.value.viewport({ class: null == (a5 = y2.ui) ? void 0 : a5.viewport }) }, [(Wt.openBlock(true), Wt.createBlock(Wt.Fragment, null, Wt.renderList(U2.value, (a6, i5) => {
            ...
            return Wt.openBlock(), Wt.createBlock(Wt.unref(ye), { key: `group-${i5}`, class: H2.value.group({ class: null == (n4 = y2.ui) ? void 0 : n4.group }) }, { default: Wt.withCtx(() => [(Wt.openBlock(true), Wt.createBlock(Wt.Fragment, null, Wt.renderList(a6, (a7, n5) => {
              ...
              return Wt.openBlock(), Wt.createBlock(Wt.Fragment, { key: `group-${i5}-${n5}` }, [Q2(a7) && "label" === a7.type ? (Wt.openBlock(), Wt.createBlock(Wt.unref(Se), { key: 0, class: H2.value.label({ class: [null == (o3 = y2.ui) ? void 0 : o3.label, null == (r3 = a7.ui) ? void 0 : r3.label, a7.class] }) }, { default: Wt.withCtx(() => [Wt.createTextVNode(Wt.toDisplayString(Wt.unref(pg)(a7, y2.labelKey)), 1)]), _: 2 }, 1032, ["class"])) : Q2(a7) && "separator" === a7.type ? (Wt.openBlock(), Wt.createBlock(Wt.unref(we), { key: 1, class: H2.value.separator({ class: [null == (s3 = y2.ui) ? void 0 : s3.separator, null == (u3 = a7.ui) ? void 0 : u3.separator, a7.class] }) }, null, 8, ["class"])) : (Wt.openBlock(), Wt.createBlock(Wt.unref(xe), { key: 2, class: H2.value.item({ class: [null == (d2 = y2.ui) ? void 0 : d2.item, Q2(a7) && (null == (g2 = a7.ui) ? void 0 : g2.item), Q2(a7) && a7.class] }), disabled: Q2(a7) && a7.disabled, value: Q2(a7) ? Wt.unref(pg)(a7, y2.valueKey) : a7, onSelect: (e2) => {
                var l3;
                ...
                return [Wt.renderSlot(t3.$slots, "item-leading", { item: a7, index: n5 }, () => {
                  ...
                  return [Q2(a7) && a7.icon ? (Wt.openBlock(), Wt.createBlock(hb, { key: 0, name: a7.icon, class: H2.value.itemLeadingIcon({ class: [null == (l3 = y2.ui) ? void 0 : l3.itemLeadingIcon, null == (t4 = a7.ui) ? void 0 : t4.itemLeadingIcon] }) }, null, 8, ["name", "class"])) : Q2(a7) && a7.avatar ? (Wt.openBlock(), Wt.createBlock(Sb, Wt.mergeProps({ key: 1, size: (null == (i7 = a7.ui) ? void 0 : i7.itemLeadingAvatarSize) || (null == (n6 = y2.ui) ? void 0 : n6.itemLeadingAvatarSize) || H2.value.itemLeadingAvatarSize() }, { ref_for: true }, a7.avatar, { class: H2.value.itemLeadingAvatar({ class: [null == (o5 = y2.ui) ? void 0 : o5.itemLeadingAvatar, null == (r5 = a7.ui) ? void 0 : r5.itemLeadingAvatar] }) }), null, 16, ["size", "class"])) : Q2(a7) && a7.chip ? (Wt.openBlock(), Wt.createBlock(bb, Wt.mergeProps({ key: 2, size: (null == (s5 = a7.ui) ? void 0 : s5.itemLeadingChipSize) || (null == (u4 = y2.ui) ? void 0 : u4.itemLeadingChipSize) || H2.value.itemLeadingChipSize(), inset: "", standalone: "" }, { ref_for: true }, a7.chip, { class: H2.value.itemLeadingChip({ class: [null == (d3 = y2.ui) ? void 0 : d3.itemLeadingChip, null == (v2 = a7.ui) ? void 0 : v2.itemLeadingChip] }) }), null, 16, ["size", "class"])) : Wt.createCommentVNode("", true)];
                }), Wt.createVNode(Wt.unref(Ce), { class: H2.value.itemLabel({ class: [null == (i6 = y2.ui) ? void 0 : i6.itemLabel, Q2(a7) && (null == (o4 = a7.ui) ? void 0 : o4.itemLabel)] }) }, { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "item-label", { item: a7, index: n5 }, () => [Wt.createTextVNode(Wt.toDisplayString(Q2(a7) ? Wt.unref(pg)(a7, y2.labelKey) : a7), 1)])]), _: 2 }, 1032, ["class"]), Wt.createVNode("span", { class: H2.value.itemTrailing({ class: [null == (r4 = y2.ui) ? void 0 : r4.itemTrailing, Q2(a7) && (null == (s4 = a7.ui) ? void 0 : s4.itemTrailing)] }) }, [Wt.renderSlot(t3.$slots, "item-trailing", { item: a7, index: n5 }), Wt.createVNode(Wt.unref(Be), { "as-child": "" }, { default: Wt.withCtx(() => {
                  var t4, i7;
                  return [Wt.createVNode(hb, { name: l2.selectedIcon || Wt.unref(B2).ui.icons.check, class: H2.value.itemTrailingIcon({ class: [null == (t4 = y2.ui) ? void 0 : t4.itemTrailingIcon, Q2(a7) && (null == (i7 = a7.ui) ? void 0 : i7.itemTrailingIcon)] }) }, null, 8, ["name", "class"])];
                }), _: 2 }, 1024)], 2)];
      ...
      n3(om.ssrRenderComponent(Wt.unref(Ie), Wt.mergeProps({ id: Wt.unref(P2), ref_key: "triggerRef", ref: X2, class: H2.value.base({ class: [null == (s2 = y2.ui) ? void 0 : s2.base, y2.class] }) }, { ...t3.$attrs, ...Wt.unref(E2) }), { default: Wt.withCtx((n4, o3, r3, s3) => {
        var u3, v2, m2, g2;
        if (!o3) return [Wt.unref(F2) || l2.avatar || b2.leading ? (Wt.openBlock(), Wt.createBlock("span", { key: 0, class: H2.value.leading({ class: null == (m2 = y2.ui) ? void 0 : m2.leading }) }, [Wt.renderSlot(t3.$slots, "leading", { modelValue: a3, open: i3, ui: H2.value }, () => {
          var t4, a4, i4;
          return [Wt.unref(F2) && Wt.unref(j2) ? (Wt.openBlock(), Wt.createBlock(hb, { key: 0, name: Wt.unref(j2), class: H2.value.leadingIcon({ class: null == (t4 = y2.ui) ? void 0 : t4.leadingIcon }) }, null, 8, ["name", "class"])) : l2.avatar ? (Wt.openBlock(), Wt.createBlock(Sb, Wt.mergeProps({ key: 1, size: (null == (a4 = y2.ui) ? void 0 : a4.itemLeadingAvatarSize) || H2.value.itemLeadingAvatarSize() }, l2.avatar, { class: H2.value.itemLeadingAvatar({ class: null == (i4 = y2.ui) ? void 0 : i4.itemLeadingAvatar }) }), null, 16, ["size", "class"])) : Wt.createCommentVNode("", true)];
        })], 2)) : Wt.createCommentVNode("", true), Wt.renderSlot(t3.$slots, "default", { modelValue: a3, open: i3 }, () => [(Wt.openBlock(true), Wt.createBlock(Wt.Fragment, null, Wt.renderList([Y2(a3)], (t4) => {
          var _a;
        ...
        Wt.unref(F2) || l2.avatar || b2.leading ? (o3(`<span class="${om.ssrRenderClass(H2.value.leading({ class: null == (u3 = y2.ui) ? void 0 : u3.leading }))}"${s3}>`), om.ssrRenderSlot(t3.$slots, "leading", { modelValue: a3, open: i3, ui: H2.value }, () => {
          var t4, a4, i4;
          Wt.unref(F2) && Wt.unref(j2) ? o3(om.ssrRenderComponent(hb, { name: Wt.unref(j2), class: H2.value.leadingIcon({ class: null == (t4 = y2.ui) ? void 0 : t4.leadingIcon }) }, null, r3, s3)) : l2.avatar ? o3(om.ssrRenderComponent(Sb, Wt.mergeProps({ size: (null == (a4 = y2.ui) ? void 0 : a4.itemLeadingAvatarSize) || H2.value.itemLeadingAvatarSize() }, l2.avatar, { class: H2.value.itemLeadingAvatar({ class: null == (i4 = y2.ui) ? void 0 : i4.itemLeadingAvatar }) }), null, r3, s3)) : o3("<!---->");
        }, o3, r3, s3), o3("</span>")) : o3("<!---->"), om.ssrRenderSlot(t3.$slots, "default", { modelValue: a3, open: i3 }, () => {
          o3("<!--[-->"), om.ssrRenderList([Y2(a3)], (e2) => {
            var _a;
            var t4, a4;
            o3("<!--[-->"), o3(null != e2 ? `<span class="${om.ssrRenderClass(H2.value.value({ class: null == (t4 = y2.ui) ? void 0 : t4.value }))}"${s3}>${om.ssrInterpolate(e2)}</span>` : `<span class="${om.ssrRenderClass(H2.value.placeholder({ class: null == (a4 = y2.ui) ? void 0 : a4.placeholder }))}"${s3}>${om.ssrInterpolate((_a = l2.placeholder) != null ? _a : "\xA0")}</span>`), o3("<!--]-->");
          }), o3("<!--]-->");
        }, o3, r3, s3), Wt.unref(O2) || b2.trailing ? (o3(`<span class="${om.ssrRenderClass(H2.value.trailing({ class: null == (v2 = y2.ui) ? void 0 : v2.trailing }))}"${s3}>`), om.ssrRenderSlot(t3.$slots, "trailing", { modelValue: a3, open: i3, ui: H2.value }, () => {
          var l3;
          Wt.unref(M2) ? o3(om.ssrRenderComponent(hb, { name: Wt.unref(M2), class: H2.value.trailingIcon({ class: null == (l3 = y2.ui) ? void 0 : l3.trailingIcon }) }, null, r3, s3)) : o3("<!---->");
        }, o3, r3, s3), o3("</span>")) : o3("<!---->");
      }), _: 2 }, o2, r2)), n3(om.ssrRenderComponent(Wt.unref(Le), Wt.unref(S2), { default: Wt.withCtx((a4, i4, n4, o3) => {
        var r3, s3;
        ...
        i4(om.ssrRenderComponent(Wt.unref(ge), Wt.mergeProps({ class: H2.value.content({ class: null == (r3 = y2.ui) ? void 0 : r3.content }) }, L2.value), { default: Wt.withCtx((a5, i5, n5, o4) => {
          var r4, s4, u3, g2;
          ...
          om.ssrRenderSlot(t3.$slots, "content-top", {}, null, i5, n5, o4), i5(`<div role="presentation" class="${om.ssrRenderClass(H2.value.viewport({ class: null == (r4 = y2.ui) ? void 0 : r4.viewport }))}"${o4}><!--[-->`), om.ssrRenderList(U2.value, (a6, r5) => {
            var s5;
            i5(om.ssrRenderComponent(Wt.unref(ye), { key: `group-${r5}`, class: H2.value.group({ class: null == (s5 = y2.ui) ? void 0 : s5.group }) }, { default: Wt.withCtx((i6, n6, o5, s6) => {
              if (!n6) return [(Wt.openBlock(true), Wt.createBlock(Wt.Fragment, null, Wt.renderList(a6, (a7, i7) => {
                ...
                return Wt.openBlock(), Wt.createBlock(Wt.Fragment, { key: `group-${r5}-${i7}` }, [Q2(a7) && "label" === a7.type ? (Wt.openBlock(), Wt.createBlock(Wt.unref(Se), { key: 0, class: H2.value.label({ class: [null == (n7 = y2.ui) ? void 0 : n7.label, null == (o6 = a7.ui) ? void 0 : o6.label, a7.class] }) }, { default: Wt.withCtx(() => [Wt.createTextVNode(Wt.toDisplayString(Wt.unref(pg)(a7, y2.labelKey)), 1)]), _: 2 }, 1032, ["class"])) : Q2(a7) && "separator" === a7.type ? (Wt.openBlock(), Wt.createBlock(Wt.unref(we), { key: 1, class: H2.value.separator({ class: [null == (s7 = y2.ui) ? void 0 : s7.separator, null == (u4 = a7.ui) ? void 0 : u4.separator, a7.class] }) }, null, 8, ["class"])) : (Wt.openBlock(), Wt.createBlock(Wt.unref(xe), { key: 2, class: H2.value.item({ class: [null == (d2 = y2.ui) ? void 0 : d2.item, Q2(a7) && (null == (g3 = a7.ui) ? void 0 : g3.item), Q2(a7) && a7.class] }), disabled: Q2(a7) && a7.disabled, value: Q2(a7) ? Wt.unref(pg)(a7, y2.valueKey) : a7, onSelect: (e2) => {
                  ...
                  return [Wt.renderSlot(t3.$slots, "item-leading", { item: a7, index: i7 }, () => {
                    ...
                    return [Q2(a7) && a7.icon ? (Wt.openBlock(), Wt.createBlock(hb, { key: 0, name: a7.icon, class: H2.value.itemLeadingIcon({ class: [null == (l3 = y2.ui) ? void 0 : l3.itemLeadingIcon, null == (t4 = a7.ui) ? void 0 : t4.itemLeadingIcon] }) }, null, 8, ["name", "class"])) : Q2(a7) && a7.avatar ? (Wt.openBlock(), Wt.createBlock(Sb, Wt.mergeProps({ key: 1, size: (null == (i8 = a7.ui) ? void 0 : i8.itemLeadingAvatarSize) || (null == (n9 = y2.ui) ? void 0 : n9.itemLeadingAvatarSize) || H2.value.itemLeadingAvatarSize() }, { ref_for: true }, a7.avatar, { class: H2.value.itemLeadingAvatar({ class: [null == (o8 = y2.ui) ? void 0 : o8.itemLeadingAvatar, null == (r7 = a7.ui) ? void 0 : r7.itemLeadingAvatar] }) }), null, 16, ["size", "class"])) : Q2(a7) && a7.chip ? (Wt.openBlock(), Wt.createBlock(bb, Wt.mergeProps({ key: 2, size: (null == (s9 = a7.ui) ? void 0 : s9.itemLeadingChipSize) || (null == (u5 = y2.ui) ? void 0 : u5.itemLeadingChipSize) || H2.value.itemLeadingChipSize(), inset: "", standalone: "" }, { ref_for: true }, a7.chip, { class: H2.value.itemLeadingChip({ class: [null == (d3 = y2.ui) ? void 0 : d3.itemLeadingChip, null == (v2 = a7.ui) ? void 0 : v2.itemLeadingChip] }) }), null, 16, ["size", "class"])) : Wt.createCommentVNode("", true)];
                  }), Wt.createVNode(Wt.unref(Ce), { class: H2.value.itemLabel({ class: [null == (n8 = y2.ui) ? void 0 : n8.itemLabel, Q2(a7) && (null == (o7 = a7.ui) ? void 0 : o7.itemLabel)] }) }, { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "item-label", { item: a7, index: i7 }, () => [Wt.createTextVNode(Wt.toDisplayString(Q2(a7) ? Wt.unref(pg)(a7, y2.labelKey) : a7), 1)])]), _: 2 }, 1032, ["class"]), Wt.createVNode("span", { class: H2.value.itemTrailing({ class: [null == (r6 = y2.ui) ? void 0 : r6.itemTrailing, Q2(a7) && (null == (s8 = a7.ui) ? void 0 : s8.itemTrailing)] }) }, [Wt.renderSlot(t3.$slots, "item-trailing", { item: a7, index: i7 }), Wt.createVNode(Wt.unref(Be), { "as-child": "" }, { default: Wt.withCtx(() => {
                    var t4, i8;
                    return [Wt.createVNode(hb, { name: l2.selectedIcon || Wt.unref(B2).ui.icons.check, class: H2.value.itemTrailingIcon({ class: [null == (t4 = y2.ui) ? void 0 : t4.itemTrailingIcon, Q2(a7) && (null == (i8 = a7.ui) ? void 0 : i8.itemTrailingIcon)] }) }, null, 8, ["name", "class"])];
                  }), _: 2 }, 1024)], 2)];
                })]), _: 2 }, 1032, ["class", "disabled", "value", "onSelect"]))], 64);
              }), 128))];
              n6("<!--[-->"), om.ssrRenderList(a6, (a7, i7) => {
                var r6, u4, g3, f2, h3, k3;
                n6("<!--[-->"), Q2(a7) && "label" === a7.type ? n6(om.ssrRenderComponent(Wt.unref(Se), { class: H2.value.label({ class: [null == (r6 = y2.ui) ? void 0 : r6.label, null == (u4 = a7.ui) ? void 0 : u4.label, a7.class] }) }, { default: Wt.withCtx((l3, t4, i8, n7) => {
                  if (!t4) return [Wt.createTextVNode(Wt.toDisplayString(Wt.unref(pg)(a7, y2.labelKey)), 1)];
                  t4(`${om.ssrInterpolate(Wt.unref(pg)(a7, y2.labelKey))}`);
                }), _: 2 }, o5, s6)) : Q2(a7) && "separator" === a7.type ? n6(om.ssrRenderComponent(Wt.unref(we), { class: H2.value.separator({ class: [null == (g3 = y2.ui) ? void 0 : g3.separator, null == (f2 = a7.ui) ? void 0 : f2.separator, a7.class] }) }, null, o5, s6)) : n6(om.ssrRenderComponent(Wt.unref(xe), { class: H2.value.item({ class: [null == (h3 = y2.ui) ? void 0 : h3.item, Q2(a7) && (null == (k3 = a7.ui) ? void 0 : k3.item), Q2(a7) && a7.class] }), disabled: Q2(a7) && a7.disabled, value: Q2(a7) ? Wt.unref(pg)(a7, y2.valueKey) : a7, onSelect: (e2) => {
                  var l3;
                  return Q2(a7) && (null == (l3 = a7.onSelect) ? void 0 : l3.call(a7, e2));
                  ...
                  if (!o6) return [Wt.renderSlot(t3.$slots, "item", { item: a7, index: i7 }, () => {
                    ...
                    return [Wt.renderSlot(t3.$slots, "item-leading", { item: a7, index: i7 }, () => {
                      ...
                      return [Q2(a7) && a7.icon ? (Wt.openBlock(), Wt.createBlock(hb, { key: 0, name: a7.icon, class: H2.value.itemLeadingIcon({ class: [null == (l3 = y2.ui) ? void 0 : l3.itemLeadingIcon, null == (t4 = a7.ui) ? void 0 : t4.itemLeadingIcon] }) }, null, 8, ["name", "class"])) : Q2(a7) && a7.avatar ? (Wt.openBlock(), Wt.createBlock(Sb, Wt.mergeProps({ key: 1, size: (null == (i8 = a7.ui) ? void 0 : i8.itemLeadingAvatarSize) || (null == (n9 = y2.ui) ? void 0 : n9.itemLeadingAvatarSize) || H2.value.itemLeadingAvatarSize() }, { ref_for: true }, a7.avatar, { class: H2.value.itemLeadingAvatar({ class: [null == (o8 = y2.ui) ? void 0 : o8.itemLeadingAvatar, null == (r9 = a7.ui) ? void 0 : r9.itemLeadingAvatar] }) }), null, 16, ["size", "class"])) : Q2(a7) && a7.chip ? (Wt.openBlock(), Wt.createBlock(bb, Wt.mergeProps({ key: 2, size: (null == (s9 = a7.ui) ? void 0 : s9.itemLeadingChipSize) || (null == (u5 = y2.ui) ? void 0 : u5.itemLeadingChipSize) || H2.value.itemLeadingChipSize(), inset: "", standalone: "" }, { ref_for: true }, a7.chip, { class: H2.value.itemLeadingChip({ class: [null == (d2 = y2.ui) ? void 0 : d2.itemLeadingChip, null == (v2 = a7.ui) ? void 0 : v2.itemLeadingChip] }) }), null, 16, ["size", "class"])) : Wt.createCommentVNode("", true)];
                    }), Wt.createVNode(Wt.unref(Ce), { class: H2.value.itemLabel({ class: [null == (n8 = y2.ui) ? void 0 : n8.itemLabel, Q2(a7) && (null == (o7 = a7.ui) ? void 0 : o7.itemLabel)] }) }, { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "item-label", { item: a7, index: i7 }, () => [Wt.createTextVNode(Wt.toDisplayString(Q2(a7) ? Wt.unref(pg)(a7, y2.labelKey) : a7), 1)])]), _: 2 }, 1032, ["class"]), Wt.createVNode("span", { class: H2.value.itemTrailing({ class: [null == (r8 = y2.ui) ? void 0 : r8.itemTrailing, Q2(a7) && (null == (s8 = a7.ui) ? void 0 : s8.itemTrailing)] }) }, [Wt.renderSlot(t3.$slots, "item-trailing", { item: a7, index: i7 }), Wt.createVNode(Wt.unref(Be), { "as-child": "" }, { default: Wt.withCtx(() => {
                      var t4, i8;
                      return [Wt.createVNode(hb, { name: l2.selectedIcon || Wt.unref(B2).ui.icons.check, class: H2.value.itemTrailingIcon({ class: [null == (t4 = y2.ui) ? void 0 : t4.itemTrailingIcon, Q2(a7) && (null == (i8 = a7.ui) ? void 0 : i8.itemTrailingIcon)] }) }, null, 8, ["name", "class"])];
                    }), _: 2 }, 1024)], 2)];
                  })];
                  om.ssrRenderSlot(t3.$slots, "item", { item: a7, index: i7 }, () => {
                    var n8, u5, g4, f3;
                    om.ssrRenderSlot(t3.$slots, "item-leading", { item: a7, index: i7 }, () => {
                      var l3, t4, i8, n9, u6, v2, g5, f4, h4, k4;
                      Q2(a7) && a7.icon ? o6(om.ssrRenderComponent(hb, { name: a7.icon, class: H2.value.itemLeadingIcon({ class: [null == (l3 = y2.ui) ? void 0 : l3.itemLeadingIcon, null == (t4 = a7.ui) ? void 0 : t4.itemLeadingIcon] }) }, null, r7, s7)) : Q2(a7) && a7.avatar ? o6(om.ssrRenderComponent(Sb, Wt.mergeProps({ size: (null == (i8 = a7.ui) ? void 0 : i8.itemLeadingAvatarSize) || (null == (n9 = y2.ui) ? void 0 : n9.itemLeadingAvatarSize) || H2.value.itemLeadingAvatarSize() }, { ref_for: true }, a7.avatar, { class: H2.value.itemLeadingAvatar({ class: [null == (u6 = y2.ui) ? void 0 : u6.itemLeadingAvatar, null == (v2 = a7.ui) ? void 0 : v2.itemLeadingAvatar] }) }), null, r7, s7)) : Q2(a7) && a7.chip ? o6(om.ssrRenderComponent(bb, Wt.mergeProps({ size: (null == (g5 = a7.ui) ? void 0 : g5.itemLeadingChipSize) || (null == (f4 = y2.ui) ? void 0 : f4.itemLeadingChipSize) || H2.value.itemLeadingChipSize(), inset: "", standalone: "" }, { ref_for: true }, a7.chip, { class: H2.value.itemLeadingChip({ class: [null == (h4 = y2.ui) ? void 0 : h4.itemLeadingChip, null == (k4 = a7.ui) ? void 0 : k4.itemLeadingChip] }) }), null, r7, s7)) : o6("<!---->");
                    }, o6, r7, s7), o6(om.ssrRenderComponent(Wt.unref(Ce), { class: H2.value.itemLabel({ class: [null == (n8 = y2.ui) ? void 0 : n8.itemLabel, Q2(a7) && (null == (u5 = a7.ui) ? void 0 : u5.itemLabel)] }) }, { default: Wt.withCtx((l3, n9, o7, r8) => {
                      if (!n9) return [Wt.renderSlot(t3.$slots, "item-label", { item: a7, index: i7 }, () => [Wt.createTextVNode(Wt.toDisplayString(Q2(a7) ? Wt.unref(pg)(a7, y2.labelKey) : a7), 1)])];
                      om.ssrRenderSlot(t3.$slots, "item-label", { item: a7, index: i7 }, () => {
                        n9(`${om.ssrInterpolate(Q2(a7) ? Wt.unref(pg)(a7, y2.labelKey) : a7)}`);
                      }, n9, o7, r8);
                    }), _: 2 }, r7, s7)), o6(`<span class="${om.ssrRenderClass(H2.value.itemTrailing({ class: [null == (g4 = y2.ui) ? void 0 : g4.itemTrailing, Q2(a7) && (null == (f3 = a7.ui) ? void 0 : f3.itemTrailing)] }))}"${s7}>`), om.ssrRenderSlot(t3.$slots, "item-trailing", { item: a7, index: i7 }, null, o6, r7, s7), o6(om.ssrRenderComponent(Wt.unref(Be), { "as-child": "" }, { default: Wt.withCtx((t4, i8, n9, o7) => {
                      var r8, s8, u6, p2;
                      if (!i8) return [Wt.createVNode(hb, { name: l2.selectedIcon || Wt.unref(B2).ui.icons.check, class: H2.value.itemTrailingIcon({ class: [null == (u6 = y2.ui) ? void 0 : u6.itemTrailingIcon, Q2(a7) && (null == (p2 = a7.ui) ? void 0 : p2.itemTrailingIcon)] }) }, null, 8, ["name", "class"])];
                      i8(om.ssrRenderComponent(hb, { name: l2.selectedIcon || Wt.unref(B2).ui.icons.check, class: H2.value.itemTrailingIcon({ class: [null == (r8 = y2.ui) ? void 0 : r8.itemTrailingIcon, Q2(a7) && (null == (s8 = a7.ui) ? void 0 : s8.itemTrailingIcon)] }) }, null, n9, o7));
                    }), _: 2 }, r7, s7)), o6("</span>");
                  }, o6, r7, s7);
                }), _: 2 }, o5, s6)), n6("<!--]-->");
              }), n6("<!--]-->");
            }), _: 2 }, n5, o4));
          }), i5("<!--]--></div>"), om.ssrRenderSlot(t3.$slots, "content-bottom", {}, null, i5, n5, o4), l2.arrow ? i5(om.ssrRenderComponent(Wt.unref(pe), Wt.mergeProps(w2.value, { class: H2.value.arrow({ class: null == (s4 = y2.ui) ? void 0 : s4.arrow }) }), null, n5, o4)) : i5("<!---->");
        }), _: 2 }, n4, o3));
      }), _: 2 }, o2, r2));
    }), _: 3 }, i2));
  };
...
export { _e as _ };
//# sourceMappingURL=Select-DbdRKll6.mjs.map
