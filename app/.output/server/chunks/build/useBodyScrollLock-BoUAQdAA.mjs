...
import { N as N$1, u, l as l$2, w, O } from './useForwardPropsEmits-DnSfSOTI.mjs';
...
const E = Wt.defineComponent({ __name: "FocusScope", props: { loop: { type: Boolean, default: false }, trapped: { type: Boolean, default: false }, asChild: { type: Boolean }, as: {} }, emits: ["mountAutoFocus", "unmountAutoFocus"], setup(n2, { emit: o2 }) {
  ...
  }), (n3, r2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(xm), { ref_key: "currentRef", ref: i2, tabindex: "-1", "as-child": n3.asChild, as: n3.as, onKeydown: g2 }, { default: Wt.withCtx(() => [Wt.renderSlot(n3.$slots, "default")]), _: 3 }, 8, ["as-child", "as"]));
} });
function T(t2) {
  let n2;
  Wt.watch(() => O(t2), (e2) => {
...
export { E, N, T };
//# sourceMappingURL=useBodyScrollLock-BoUAQdAA.mjs.map
