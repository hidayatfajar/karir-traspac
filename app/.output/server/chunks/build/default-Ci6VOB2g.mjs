import N from './HeaderPublic-2EErE6LA.mjs';
...
const m = o(p, [["ssrRender", function(i2, p2, d2, m2) {
  const n = N, a = o$1, l = m$1;
  p2(`<div${pm.ssrRenderAttrs(m2)}><div class="bg-[##EEF5F9] min-h-dvh">`), p2(pm.ssrRenderComponent(n, null, null, d2)), p2(pm.ssrRenderComponent(a, { ui: { base: "mx-auto", padding: "sm:px-0 lg:px-0 xl:px-0 md:px-0 px-0", constrained: "max-w-7xl" } }, { default: Wt.withCtx((t2, o2, r2, p3) => {
    if (!o2) return [Wt.renderSlot(i2.$slots, "default")];
    pm.ssrRenderSlot(i2.$slots, "default", {}, null, o2, r2, p3);
  }), _: 3 }, d2)), p2(pm.ssrRenderComponent(l, null, null, d2)), p2("</div></div>");
}]]);

export { m as default };
//# sourceMappingURL=default-Ci6VOB2g.mjs.map
