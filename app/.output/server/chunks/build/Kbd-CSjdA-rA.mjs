import { V as Nm, u as da, v as Wt, t as Ky, s as pm, P as _m } from './server.mjs';

const i = { meta: "", ctrl: "", alt: "", win: "\u229E", command: "\u2318", shift: "\u21E7", control: "\u2303", option: "\u2325", enter: "\u21B5", delete: "\u2326", backspace: "\u232B", escape: "\u238B", tab: "\u21E5", capslock: "\u21EA", arrowup: "\u2191", arrowright: "\u2192", arrowdown: "\u2193", arrowleft: "\u2190", pageup: "\u21DE", pagedown: "\u21DF", home: "\u2196", end: "\u2198" }, l = Nm(() => {
  ...
  const i2 = e2, { getKbdKey: d2 } = l(), o2 = da(), p = Wt.computed(() => {
    var e3;
    return Ky({ extend: Ky(u), ...(null == (e3 = o2.ui) ? void 0 : e3.kbd) || {} });
  });
  return (n2, r2, l2, u2) => {
    r2(pm.ssrRenderComponent(Wt.unref(_m), Wt.mergeProps({ as: e2.as, class: p.value({ variant: e2.variant, size: e2.size, class: i2.class }) }, u2), { default: Wt.withCtx((r3, a2, i3, l3) => {
      if (!a2) return [Wt.renderSlot(n2.$slots, "default", {}, () => [Wt.createTextVNode(Wt.toDisplayString(Wt.unref(d2)(e2.value)), 1)])];
      pm.ssrRenderSlot(n2.$slots, "default", {}, () => {
        a2(`${pm.ssrInterpolate(Wt.unref(d2)(e2.value))}`);
      }, a2, i3, l3);
    }), _: 3 }, l2));
  };
} }, o = d.setup;
...
export { d };
//# sourceMappingURL=Kbd-CSjdA-rA.mjs.map
