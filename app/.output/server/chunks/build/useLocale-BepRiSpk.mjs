import { S as Pm, v as Wt, A as pg } from './server.mjs';
import { m as defu } from '../_/nitro.mjs';

function n(a2) {
  return (o2, n2) => function(e2, a3, o3) {
    const n3 = pg(o3, `messages.${e2}`, e2);
...
export { l };
//# sourceMappingURL=useLocale-BepRiSpk.mjs.map
