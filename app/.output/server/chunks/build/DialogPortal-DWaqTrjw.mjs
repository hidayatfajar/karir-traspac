...
import { C as C$1, T, N, I } from './useForwardPropsEmits-nQnKVeqj.mjs';
import { t } from './utils-6y4URocx.mjs';
import { u, c } from './Presence-D-YonBfP.mjs';
import { N as N$1, T as T$1, E } from './useBodyScrollLock-DClI9ev0.mjs';
import { s, u as u$1 } from './usePortal-B0EwXMSu.mjs';
...
const y = Wt.defineComponent({ __name: "DialogContentImpl", props: { forceMount: { type: Boolean }, trapFocus: { type: Boolean }, disableOutsidePointerEvents: { type: Boolean }, asChild: { type: Boolean }, as: {} }, emits: ["escapeKeyDown", "pointerDownOutside", "focusOutside", "interactOutside", "openAutoFocus", "closeAutoFocus"], setup(t2, { emit: o2 }) {
  const n2 = t2, r2 = o2, u2 = m(), { forwardRef: d2} = N();
  return u2.titleId || (u2.titleId = u(void 0, "reka-dialog-title")), u2.descriptionId || (u2.descriptionId = u(void 0, "reka-dialog-description")), (t3, o3) => (Wt.openBlock(), Wt.createBlock(Wt.unref(E), { "as-child": "", loop: "", trapped: n2.trapFocus, onMountAutoFocus: o3[5] || (o3[5] = (e2) => r2("openAutoFocus", e2)), onUnmountAutoFocus: o3[6] || (o3[6] = (e2) => r2("closeAutoFocus", e2)) }, { default: Wt.withCtx(() => [Wt.createVNode(Wt.unref(u$1), Wt.mergeProps({ id: Wt.unref(u2).contentId, ref: Wt.unref(d2), as: t3.as, "as-child": t3.asChild, "disable-outside-pointer-events": t3.disableOutsidePointerEvents, role: "dialog", "aria-describedby": Wt.unref(u2).descriptionId, "aria-labelledby": Wt.unref(u2).titleId, "data-state": Wt.unref(t)(Wt.unref(u2).open.value) }, t3.$attrs, { onDismiss: o3[0] || (o3[0] = (t4) => Wt.unref(u2).onOpenChange(false)), onEscapeKeyDown: o3[1] || (o3[1] = (e2) => r2("escapeKeyDown", e2)), onFocusOutside: o3[2] || (o3[2] = (e2) => r2("focusOutside", e2)), onInteractOutside: o3[3] || (o3[3] = (e2) => r2("interactOutside", e2)), onPointerDownOutside: o3[4] || (o3[4] = (e2) => r2("pointerDownOutside", e2)) }), { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "default")]), _: 3 }, 16, ["id", "as", "as-child", "disable-outside-pointer-events", "aria-describedby", "aria-labelledby", "data-state"])]), _: 3 }, 8, ["trapped"]));
  ...
  const n2 = t2, s2 = o2, l2 = m(), u2 = I(s2), { forwardRef: i2, currentElement: p2 } = N();
  return T$1(p2), (t3, o3) => (Wt.openBlock(), Wt.createBlock(y, Wt.mergeProps({ ...n2, ...Wt.unref(u2) }, { ref: Wt.unref(i2), "trap-focus": Wt.unref(l2).open.value, "disable-outside-pointer-events": true, onCloseAutoFocus: o3[0] || (o3[0] = (t4) => {
    var o4;
  ...
  const n2 = t2, s2 = o2, l2 = m(), i2 = I(s2), { forwardRef: d2 } = N();
  return (t3, o3) => (Wt.openBlock(), Wt.createBlock(Wt.unref(c), { present: t3.forceMount || Wt.unref(l2).open.value }, { default: Wt.withCtx(() => [Wt.unref(l2).modal.value ? (Wt.openBlock(), Wt.createBlock(g, Wt.mergeProps({ key: 0, ref: Wt.unref(d2) }, { ...n2, ...Wt.unref(i2), ...t3.$attrs }), { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "default")]), _: 3 }, 16)) : (Wt.openBlock(), Wt.createBlock(_, Wt.mergeProps({ key: 1, ref: Wt.unref(d2) }, { ...n2, ...Wt.unref(i2), ...t3.$attrs }), { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "default")]), _: 3 }, 16))]), _: 3 }, 8, ["present"]));
  ...
  return r2.contentId || (r2.contentId = u(void 0, "reka-dialog-content")), (o3, a2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(_m), Wt.mergeProps(n2, { ref: Wt.unref(s2), type: "button" === o3.as ? "button" : void 0, "aria-haspopup": "dialog", "aria-expanded": Wt.unref(r2).open.value || false, "aria-controls": Wt.unref(r2).open.value ? Wt.unref(r2).contentId : void 0, "data-state": Wt.unref(r2).open.value ? "open" : "closed", onClick: Wt.unref(r2).onOpenToggle }), { default: Wt.withCtx(() => [Wt.renderSlot(o3.$slots, "default")]), _: 3 }, 16, ["type", "aria-expanded", "aria-controls", "data-state", "onClick"]));
  ...
  const o2 = t2;
  return (t3, n2) => (Wt.openBlock(), Wt.createBlock(Wt.unref(s), Wt.normalizeProps(Wt.guardReactiveProps(o2)), { default: Wt.withCtx(() => [Wt.renderSlot(t3.$slots, "default")]), _: 3 }, 16));
} });

export { B, C, D, P, b, h, k, w };
//# sourceMappingURL=DialogPortal-DWaqTrjw.mjs.map
