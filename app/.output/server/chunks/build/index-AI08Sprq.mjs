...
import { v as Wt, s as om, _ as kb, c as hb } from './server.mjs';
import 'node:http';
import 'node:https';
import 'node:zlib';
import 'node:stream';
  ...
  return (n3, d2, x, g) => {
    ...
    d2(`<div${om.ssrRenderAttrs(g)}><section id="hero-section" class="bg-white py-16"><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center"><h2 class="text-4xl md:text-5xl font-bold text-primary mb-6"> Pertanyaan Umum </h2><p class="text-lg text-gray-600 mb-8 max-w-3xl mx-auto"> Temukan jawaban untuk pertanyaan yang sering diajukan seputar karir dan proses rekrutmen di <span class="text-primary font-semibold">Karir Traspac</span>. </p></div></section><section id="search-faq" class="bg-gray-50 py-12"><div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8"><div class="bg-white rounded-2xl shadow-lg p-8"><div class="relative">`), d2(om.ssrRenderComponent(k, { modelValue: Wt.unref(o), "onUpdate:modelValue": (a2) => Wt.isRef(o) ? o.value = a2 : null, size: "xl", placeholder: "Cari pertanyaan atau kata kunci...", type: "search", class: "w-full", icon: "i-heroicons-magnifying-glass" }, null, x)), d2('</div></div></div></section><section id="faq-categories" class="py-8"><div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8"><div class="flex flex-wrap justify-center gap-4"><!--[-->'), om.ssrRenderList(Wt.unref(p), (a2) => {
      d2(om.ssrRenderComponent(f, { key: a2.value, variant: Wt.unref(s2) === a2.value ? "solid" : "outline", color: Wt.unref(s2) === a2.value ? "primary" : "neutral", class: "px-6 py-3 rounded-xl font-medium transition-all", onClick: (e2) => {
        ...
        r2(`${om.ssrInterpolate(a2.text)}`);
      }), _: 2 }, x));
    }), d2('<!--]--></div></div></section><section id="faq-list" class="py-8"><div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8"><div class="space-y-4"><!--[-->'), om.ssrRenderList(Wt.unref(m), (a2) => {
      d2('<div class="faq-item bg-white rounded-2xl shadow-lg border border-gray-100">'), d2(om.ssrRenderComponent(f, { variant: "ghost", class: "w-full px-8 py-6 text-left flex items-center justify-between hover:bg-gray-50", onClick: (e2) => ((a3) => {
        ...
        r2(`<h3 class="text-lg font-semibold text-gray-900 pr-4"${s3}>${om.ssrInterpolate(a2.question)}</h3>`), r2(om.ssrRenderComponent(v, { name: Wt.unref(l).includes(a2.id) ? "i-heroicons-minus" : "i-heroicons-plus", class: ["text-primary text-xl transition-transform duration-300", { "rotate-180": Wt.unref(l).includes(a2.id) }] }, null, n4, s3));
      }), _: 2 }, x)), Wt.unref(l).includes(a2.id) ? d2(`<div class="px-8 pb-6 overflow-hidden"><p class="text-gray-600 leading-relaxed">${om.ssrInterpolate(a2.answer)}</p></div>`) : d2("<!---->"), d2("</div>");
    }), d2('<!--]--></div></div></section><section id="contact-support" class="py-16 bg-white"><div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center"><h3 class="text-2xl font-bold text-primary mb-4"> Masih Ada Pertanyaan? </h3><p class="text-gray-600 mb-8"> Tim HR kami siap membantu menjawab pertanyaan Anda </p><div class="grid grid-cols-1 md:grid-cols-2 gap-6"><div class="bg-gray-50 rounded-2xl p-6 text-center">'), d2(om.ssrRenderComponent(v, { name: "i-heroicons-envelope", class: "text-primary text-5xl mb-4 mx-auto" }, null, x)), d2('<h4 class="font-semibold text-gray-900 mb-2">Email Support</h4><p class="text-gray-600 mb-4">Kirim pertanyaan Anda via email</p>'), d2(om.ssrRenderComponent(f, { onClick: c$1, variant: "solid", color: "primary", class: "px-6 py-3 rounded-xl font-medium hover:bg-opacity-90 transition-all" }, { default: Wt.withCtx((a2, t2, i2, r2) => {
      if (!t2) return [Wt.createTextVNode(" info@traspac.co.id ")];
      t2(" info@traspac.co.id ");
    }), _: 1 }, x)), d2('</div><div class="bg-gray-50 rounded-2xl p-6 text-center">'), d2(om.ssrRenderComponent(v, { name: "i-heroicons-phone", class: "text-primary text-5xl mb-4 mx-auto" }, null, x)), d2('<h4 class="font-semibold text-gray-900 mb-2">Phone Support</h4><p class="text-gray-600 mb-4">Hubungi kami di jam kerja</p>'), d2(om.ssrRenderComponent(f, { variant: "solid", onClick: u, color: "primary", class: "px-6 py-3 rounded-xl font-medium hover:bg-opacity-90 transition-all" }, { default: Wt.withCtx((a2, t2, i2, r2) => {
...
export { n as default };
//# sourceMappingURL=index-AI08Sprq.mjs.map
