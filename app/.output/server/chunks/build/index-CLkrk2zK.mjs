import { v as Wt, O as Cm, Q as qm, J as Tm, K as Bm, L as Nm, I as Hm, R as Rm, M as Wm, N as Om } from './server.mjs';

function c(t2, l2, n2) {
  let o2;
  o2 = Wt.isRef(n2) ? { evaluating: n2 } : {};
  const { lazy: a2 = false, flush: s2 = "pre", evaluating: u2, shallow: r2 = true, onError: c2 = Rm } = o2, v2 = Wt.shallowRef(!a2), f2 = r2 ? Wt.shallowRef(l2) : Wt.ref(l2);
  let h2 = 0;
...
function v(t2 = {}) {
  ...
  return Cm({ define: o2, reuse: a2 }, [o2, a2]);
}
function f(e2) {
  const t2 = {};
  for (const l2 in e2) t2[qm(l2)] = e2[l2];
  return t2;
}
const h = void 0;
function d(t2) {
...
function p(...t2) {
  const o2 = [], u2 = () => {
    ...
    const l2 = Bm(Wt.toValue(t2[0])).filter((e2) => null != e2);
    return l2.every((e2) => "string" != typeof e2) ? l2 : void 0;
  }), i2 = Wm(() => {
    var l2, o3;
    return [null != (o3 = null == (l2 = r2.value) ? void 0 : l2.map((e2) => d(e2))) ? o3 : [h].filter((e2) => null != e2), Bm(Wt.toValue(r2.value ? t2[1] : t2[0])), Bm(Wt.unref(r2.value ? t2[2] : t2[1])), Wt.toValue(r2.value ? t2[3] : t2[2])];
  }, ([e2, t3, l2, n2]) => {
    if (u2(), !(null == e2 ? void 0 : e2.length) || !(null == t3 ? void 0 : t3.length) || !(null == l2 ? void 0 : l2.length)) return;
    const a2 = Om(n2) ? { ...n2 } : n2;
...
function m(a2, s2 = {}) {
  ...
  return function(t2, n2, o2 = {}) {
    ...
    const c3 = w(() => u3 && "MutationObserver" in u3), v3 = () => {
      ...
      const l2 = Wt.toValue(t2), a4 = Bm(l2).map(d).filter(Nm);
      return new Set(a4);
    ...
    Tm(m3);
  }(a2, O, { attributeFilter: ["style", "class"] }), i2 && p("scroll", O, { capture: true, passive: true }), r2 && p("resize", O, { passive: true }), Hm(() => {
    c2 && O();
  }), { height: f2, bottom: m2, left: R, right: g, top: y, width: b, x: E, y: V, update: O };
}

export { c, m, v };
//# sourceMappingURL=index-CLkrk2zK.mjs.map
