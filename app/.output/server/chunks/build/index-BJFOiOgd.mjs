import { v as Wt$1, P as _m, a as Tm } from './server.mjs';
import { N, T, F, C, j as j$1, y, a, l, I } from './useForwardPropsEmits-WwvTsoLV.mjs';
...
import { H as He$1, q as qe$1, $ as $e$1, I as Ie$1, Y as Ye$1 } from './PopperArrow-DcWSYcLt.mjs';
...
import { f, h, c, b } from './usePortal-DtLtCtVs.mjs';
import { c as c$2 } from './RovingFocusGroup-CVcAGu6G.mjs';
...
const j = 1721426;
function Q(e2, t2, a2, n2) {
  let o2 = (t2 = q(e2, t2)) - 1, r2 = -2;
  return a2 <= 2 ? r2 = 0 : Z(t2) && (r2 = -1), 1721425 + 365 * o2 + Math.floor(o2 / 4) - Math.floor(o2 / 100) + Math.floor(o2 / 400) + Math.floor((367 * a2 - 362) / 12 + r2 + n2);
}
function Z(e2) {
...
class te {
  fromJulianDay(e2) {
    let t2 = e2, a2 = t2 - j, n2 = Math.floor(a2 / 146097), o2 = z(a2, 146097), r2 = Math.floor(o2 / 36524), l2 = z(o2, 36524), i2 = Math.floor(l2 / 1461), u2 = z(l2, 1461), s2 = Math.floor(u2 / 365), d2 = 400 * n2 + 100 * r2 + 4 * i2 + s2 + (4 !== r2 && 4 !== s2 ? 1 : 0), [c2, f2] = X(d2), p2 = t2 - Q(c2, f2, 1, 1), h2 = 2;
    t2 < Q(c2, f2, 3, 1) ? h2 = 0 : Z(f2) && (h2 = 1);
    let v2 = Math.floor((12 * (p2 + h2) + 373) / 367), m2 = t2 - Q(c2, f2, v2, 1) + 1;
    return new Xe(c2, f2, v2, m2);
  }
  toJulianDay(e2) {
    return Q(e2.era, e2.year, e2.month, e2.day);
  }
  getDaysInMonth(e2) {
    return ee[Z(e2.year) ? "leapyear" : "standard"][e2.month - 1];
  }
  getMonthsInYear(e2) {
    return 12;
  }
  getDaysInYear(e2) {
    return Z(e2.year) ? 366 : 365;
  }
  getYearsInEra(e2) {
    return 9999;
  }
...
function oe(e2, t2) {
  return t2 = _e(t2, e2.calendar), e2 = ve(e2), t2 = ve(t2), e2.era === t2.era && e2.year === t2.year && e2.month === t2.month;
}
function re(e2, t2) {
...
function we(e2, t2) {
  if ("UTC" === t2) return 0;
  if (e2 > 0 && t2 === he()) return -6e4 * new Date(e2).getTimezoneOffset();
...
function Je(e2, t2, a2, n2) {
  ...
  switch (t2) {
    case "era": {
      ...
      r3 = Ye(r3, a2, 0, t3.length - 1, null == n2 ? void 0 : n2.round), o2.era = t3[r3], Te(o2);
      break;
    }
    case "year":
      var r2, l2;
      (null === (r2 = (l2 = o2.calendar).isInverseEra) || void 0 === r2 ? void 0 : r2.call(l2, o2)) && (a2 = -a2), o2.year = Ye(e2.year, a2, -1 / 0, 9999, null == n2 ? void 0 : n2.round), o2.year === -1 / 0 && (o2.year = 1), o2.calendar.balanceYearMonth && o2.calendar.balanceYearMonth(o2, e2);
      break;
    case "month":
      o2.month = Ye(e2.month, a2, 1, e2.calendar.getMonthsInYear(e2), null == n2 ? void 0 : n2.round);
      break;
    case "day":
      o2.day = Ye(e2.day, a2, 1, e2.calendar.getDaysInMonth(e2), null == n2 ? void 0 : n2.round);
      break;
    default:
...
function Ke(e2, t2, a2, n2) {
  ...
  switch (t2) {
    case "hour": {
      ...
      o2.hour = Ye(t3, a2, r2, l2, null == n2 ? void 0 : n2.round);
      break;
    }
    case "minute":
      o2.minute = Ye(e2.minute, a2, 0, 59, null == n2 ? void 0 : n2.round);
      break;
    case "second":
      o2.second = Ye(e2.second, a2, 0, 59, null == n2 ? void 0 : n2.round);
      break;
    case "millisecond":
      o2.millisecond = Ye(e2.millisecond, a2, 0, 999, null == n2 ? void 0 : n2.round);
      break;
    default:
      throw new Error("Unsupported field " + t2);
  }
...
function Ye(e2, t2, a2, n2, o2 = false) {
  if (o2) {
...
class Xe {
  ...
  constructor(...e2) {
    Qe(this, qe, { writable: true, value: void 0 });
    let [t2, a2, n2, o2, r2] = Ze(e2);
...
class tt {
  ...
  constructor(...e2) {
    Qe(this, et, { writable: true, value: void 0 });
    let [t2, a2, n2, o2, r2] = Ze(e2);
...
class nt {
    ...
    return function(e3, t3, a3, n2) {
      switch (t3) {
        case "hour": {
          ...
          return d2 = Ye(c2, a3, Math.floor(i2 / Re), Math.floor(s2 / Re), null == n2 ? void 0 : n2.round) * Re + f2, _e(Se(d2, e3.timeZone), e3.calendar);
        }
        case "minute":
        case "second":
        case "millisecond":
  ...
  constructor(...e2) {
    Qe(this, at, { writable: true, value: void 0 });
    let [t2, a2, n2, o2, r2] = Ze(e2), l2 = e2.shift(), i2 = e2.shift();
...
const ht = 1911;
function vt(e2) {
  return "minguo" === e2.era ? e2.year + ht : 1 - e2.year + ht;
}
function mt(e2) {
  let t2 = e2 - ht;
...
class Bt extends te {
  fromJulianDay(e2) {
    let t2, a2, n2, o2 = super.fromJulianDay(e2), r2 = o2.year - 78, l2 = e2 - Q(o2.era, o2.year, 1, 1);
    if (l2 < 80 ? (r2--, t2 = Z(o2.year - 1) ? 31 : 30, l2 += t2 + 155 + 90 + 10) : (t2 = Z(o2.year) ? 31 : 30, l2 -= 80), l2 < t2) a2 = 1, n2 = l2 + 1;
    else {
      let e3 = l2 - t2;
  ...
  toJulianDay(e2) {
    ...
    return Z(r2) ? (t2 = 31, a2 = Q(o2, r2, 3, 21)) : (t2 = 30, a2 = Q(o2, r2, 3, 22)), 1 === e2.month ? a2 + e2.day - 1 : (a2 += t2 + 31 * Math.min(e2.month - 2, 5), e2.month >= 8 && (a2 += 30 * (e2.month - 7)), a2 += e2.day - 1, a2);
  }
  getDaysInMonth(e2) {
    return 1 === e2.month && Z(e2.year + 78) || e2.month >= 2 && e2.month <= 6 ? 31 : 30;
  }
  getYearsInEra() {
    return 9919;
  }
...
const Gt = 1723856, Ht = 1824665, zt = 5500;
function jt(e2, t2, a2, n2) {
  return e2 + 365 * t2 + Math.floor(t2 / 4) + 30 * (a2 - 1) + n2 - 1;
}
function Qt(e2, t2) {
  let a2 = Math.floor(4 * (t2 - e2) / 1461), n2 = 1 + Math.floor((t2 - jt(e2, a2, 1, 1)) / 30);
  return [a2, n2, t2 + 1 - jt(e2, a2, n2, 1)];
}
function Zt(e2) {
  return Math.floor(e2 % 4 / 3);
}
function qt(e2, t2) {
  return t2 % 13 != 0 ? 30 : Zt(e2) + 5;
}
class Xt {
  fromJulianDay(e2) {
    let [t2, a2, n2] = Qt(Gt, e2), o2 = "AM";
    return t2 <= 0 && (o2 = "AA", t2 += zt), new Xe(this, o2, t2, a2, n2);
  }
  toJulianDay(e2) {
    let t2 = e2.year;
    return "AA" === e2.era && (t2 -= zt), jt(Gt, t2, e2.month, e2.day);
  }
  getDaysInMonth(e2) {
...
class ta extends Xt {
  fromJulianDay(e2) {
    let [t2, a2, n2] = Qt(Ht, e2), o2 = "CE";
    return t2 <= 0 && (o2 = "BCE", t2 = 1 - t2), new Xe(this, o2, t2, a2, n2);
  }
  toJulianDay(e2) {
    let t2 = e2.year;
    return "BCE" === e2.era && (t2 = 1 - t2), jt(Ht, t2, e2.month, e2.day);
  }
  getDaysInMonth(e2) {
    let t2 = e2.year;
...
function ma(e2) {
  const { dateObj: t2, weekStartsOn: a2, fixedWeeks: n2, locale: o2 } = e2, r2 = fa(t2), l2 = Array.from({ length: r2 }, (e3, a3) => t2.set({ day: a3 + 1 })), i2 = ve(t2), u2 = me(t2), s2 = function(e3, t3, a3) {
    const n3 = se(e3, a3);
  ...
  }(u2, a2, o2), c2 = va(s2.subtract({ days: 1 }), i2), f2 = va(u2, d2.add({ days: 1 })), p2 = c2.length + l2.length + f2.length;
  if (n2 && p2 < 42) {
    const e3 = 42 - p2;
  ...
  const h2 = c2.concat(l2, f2), v2 = function(e3, t3) {
    const a3 = [];
    for (let n3 = 0; n3 < e3.length; n3 += t3) a3.push(e3.slice(n3, n3 + t3));
    return a3;
  }(h2, 7);
  return { value: t2, cells: h2, rows: v2 };
}
function ya(e2) {
...
function ga(t2) {
  ...
  return { isDateDisabled: function(e2) {
    var a3;
    return !(!(null == (a3 = t2.isDateDisabled) ? void 0 : a3.call(t2, e2)) && !t2.disabled.value) || (!(!t2.maxValue.value || !ha(e2, t2.maxValue.value)) || !(!t2.minValue.value || !pa(e2, t2.minValue.value)));
    ...
    if (!e2 && !t2.nextPage.value) {
      return ha(a3.add({ months: 1 }).set({ day: 1 }), t2.maxValue.value);
    }
    ...
    return ha(n3, t2.maxValue.value);
...
const wa = { style: { border: "0px", clip: "rect(0px, 0px, 0px, 0px)", "clip-path": "inset(50%)", height: "1px", margin: "-1px", overflow: "hidden", padding: "0px", position: "absolute", "white-space": "nowrap", width: "1px" } }, Ca = { role: "heading", "aria-level": "2" }, [Ba, Da] = T("CalendarRoot"), ka = Wt$1.defineComponent({ __name: "CalendarRoot", props: { defaultValue: { default: void 0 }, defaultPlaceholder: {}, placeholder: { default: void 0 }, pagedNavigation: { type: Boolean, default: false }, preventDeselect: { type: Boolean, default: false }, weekStartsOn: { default: 0 }, weekdayFormat: { default: "narrow" }, calendarLabel: {}, fixedWeeks: { type: Boolean, default: false }, maxValue: {}, minValue: {}, locale: {}, numberOfMonths: { default: 1 }, disabled: { type: Boolean, default: false }, readonly: { type: Boolean, default: false }, initialFocus: { type: Boolean, default: false }, isDateDisabled: { type: Function, default: void 0 }, isDateUnavailable: { type: Function, default: void 0 }, dir: {}, nextPage: {}, prevPage: {}, modelValue: {}, multiple: { type: Boolean, default: false }, disableDaysOutsideCurrentView: { type: Boolean, default: false }, asChild: { type: Boolean }, as: { default: "div" } }, emits: ["update:modelValue", "update:placeholder"], setup(a2, { emit: n2 }) {
  var _a2;
  const r2 = a2, l2 = n2, { disabled: i2, readonly: u2, initialFocus: s2, pagedNavigation: d2, weekStartsOn: c2, weekdayFormat: h2, fixedWeeks: v2, multiple: m2, minValue: y2, maxValue: g2, numberOfMonths: b2, preventDeselect: w2, isDateDisabled: C2, isDateUnavailable: B2, calendarLabel: D2, defaultValue: k2, nextPage: P2, prevPage: x2, dir: S2, locale: O2, disableDaysOutsideCurrentView: M2 } = Wt$1.toRefs(r2), { primitiveElement: _2, currentElement: V2 } = o(), R2 = ba(O2), I2 = n(S2), E2 = C(r2, "modelValue", l2, { defaultValue: k2.value, passive: void 0 === r2.modelValue }), A2 = ua({ defaultPlaceholder: r2.placeholder, defaultValue: E2.value, locale: r2.locale }), F2 = C(r2, "placeholder", l2, { defaultValue: (_a2 = r2.defaultPlaceholder) != null ? _a2 : A2.copy(), passive: void 0 === r2.placeholder });
  function T2(e2) {
    F2.value = e2.copy();
  }
  const { fullCalendarLabel: $2, headingValue: U2, isDateDisabled: N2, isDateUnavailable: W2, isNextButtonDisabled: L2, isPrevButtonDisabled: J2, weekdays: K2, isOutsideVisibleView: Y2, nextPage: G2, prevPage: H2, formatter: z2, grid: j2 } = ga({ locale: R2, placeholder: F2, weekStartsOn: c2, fixedWeeks: v2, numberOfMonths: b2, minValue: y2, maxValue: g2, disabled: i2, weekdayFormat: h2, pagedNavigation: d2, isDateDisabled: C2.value, isDateUnavailable: B2.value, calendarLabel: D2, nextPage: P2, prevPage: x2 }), { isInvalid: Q2, isDateSelected: Z2 } = function(t2) {
  ...
  }), Da({ isDateUnavailable: W2, dir: I2, isDateDisabled: N2, locale: R2, formatter: z2, modelValue: E2, placeholder: F2, disabled: i2, initialFocus: s2, pagedNavigation: d2, grid: j2, weekDays: K2, weekStartsOn: c2, weekdayFormat: h2, fixedWeeks: v2, multiple: m2, numberOfMonths: b2, readonly: u2, preventDeselect: w2, fullCalendarLabel: $2, headingValue: U2, isInvalid: Q2, isDateSelected: Z2, isNextButtonDisabled: L2, isPrevButtonDisabled: J2, isOutsideVisibleView: Y2, nextPage: G2, prevPage: H2, parentElement: V2, onPlaceholderChange: T2, onDateChange: function(e2) {
  ...
  }, disableDaysOutsideCurrentView: M2 }), (a3, n3) => (Wt$1.openBlock(), Wt$1.createBlock(Wt$1.unref(_m), { ref_key: "primitiveElement", ref: _2, as: a3.as, "as-child": a3.asChild, role: "application", "aria-label": Wt$1.unref($2), "data-readonly": Wt$1.unref(u2) ? "" : void 0, "data-disabled": Wt$1.unref(i2) ? "" : void 0, "data-invalid": Wt$1.unref(Q2) ? "" : void 0, dir: Wt$1.unref(I2) }, { default: Wt$1.withCtx(() => [Wt$1.renderSlot(a3.$slots, "default", { date: Wt$1.unref(F2), grid: Wt$1.unref(j2), weekDays: Wt$1.unref(K2), weekStartsOn: Wt$1.unref(c2), locale: Wt$1.unref(R2), fixedWeeks: Wt$1.unref(v2), modelValue: Wt$1.unref(E2) }), Wt$1.createElementVNode("div", wa, [Wt$1.createElementVNode("div", Ca, Wt$1.toDisplayString(Wt$1.unref($2)), 1)])]), _: 3 }, 8, ["as", "as-child", "aria-label", "data-readonly", "data-disabled", "data-invalid", "dir"]));
} }), Pa = Wt$1.defineComponent({ __name: "CalendarCell", props: { date: {}, asChild: { type: Boolean }, as: { default: "td" } }, setup(a2) {
  const n2 = Ba();
  return (a3, o2) => {
    var r2, l2;
    return Wt$1.openBlock(), Wt$1.createBlock(Wt$1.unref(_m), { as: a3.as, "as-child": a3.asChild, role: "gridcell", "aria-selected": !!Wt$1.unref(n2).isDateSelected(a3.date) || void 0, "aria-disabled": Wt$1.unref(n2).isDateDisabled(a3.date) || (null == (l2 = (r2 = Wt$1.unref(n2)).isDateUnavailable) ? void 0 : l2.call(r2, a3.date)) || Wt$1.unref(n2).disableDaysOutsideCurrentView.value, "data-disabled": Wt$1.unref(n2).isDateDisabled(a3.date) || Wt$1.unref(n2).disableDaysOutsideCurrentView.value ? "" : void 0 }, { default: Wt$1.withCtx(() => [Wt$1.renderSlot(a3.$slots, "default")]), _: 3 }, 8, ["as", "as-child", "aria-selected", "aria-disabled", "data-disabled"]);
  };
} });
function xa(e2) {
  var _a2;
...
const Sa = Wt$1.defineComponent({ __name: "CalendarCellTrigger", props: { day: {}, month: {}, asChild: { type: Boolean }, as: { default: "div" } }, setup(a2) {
  ...
  }), c2 = Wt$1.computed(() => ue(n2.day, he())), p2 = Wt$1.computed(() => !oe(n2.day, n2.month)), h2 = Wt$1.computed(() => r2.isOutsideVisibleView(n2.day)), m2 = Wt$1.computed(() => r2.isDateDisabled(n2.day) || r2.disableDaysOutsideCurrentView.value && p2.value), y2 = Wt$1.computed(() => !r2.disabled.value && ne(n2.day, r2.placeholder.value)), g2 = Wt$1.computed(() => r2.isDateSelected(n2.day));
  function b2(e2) {
    var t2;
  ...
  return (a3, o3) => (Wt$1.openBlock(), Wt$1.createBlock(Wt$1.unref(_m), Wt$1.mergeProps({ ref_key: "primitiveElement", ref: l2 }, n2, { role: "button", "aria-label": s2.value, "data-reka-calendar-cell-trigger": "", "aria-disabled": !(!m2.value && !d2.value) || void 0, "data-selected": !!g2.value || void 0, "data-value": a3.day.toString(), "data-disabled": m2.value ? "" : void 0, "data-unavailable": d2.value ? "" : void 0, "data-today": c2.value ? "" : void 0, "data-outside-view": p2.value ? "" : void 0, "data-outside-visible-view": h2.value ? "" : void 0, "data-focused": y2.value ? "" : void 0, tabindex: y2.value ? 0 : p2.value || m2.value ? void 0 : -1, onClick: w2, onKeydown: [Wt$1.withKeys(C2, ["up", "down", "left", "right", "space", "enter"]), o3[0] || (o3[0] = Wt$1.withKeys(Wt$1.withModifiers(() => {
  }, ["prevent"]), ["enter"]))] }), { default: Wt$1.withCtx(() => [Wt$1.renderSlot(a3.$slots, "default", { dayValue: u2.value, disabled: m2.value, today: c2.value, selected: g2.value, outsideView: p2.value, outsideVisibleView: h2.value, unavailable: d2.value }, () => [Wt$1.createTextVNode(Wt$1.toDisplayString(u2.value), 1)])]), _: 3 }, 16, ["aria-label", "aria-disabled", "data-selected", "data-value", "data-disabled", "data-unavailable", "data-today", "data-outside-view", "data-outside-visible-view", "data-focused", "tabindex"]));
  ...
  return (a3, o3) => (Wt$1.openBlock(), Wt$1.createBlock(Wt$1.unref(_m), Wt$1.mergeProps(n2, { tabindex: "-1", role: "grid", "aria-readonly": l2.value, "aria-disabled": r2.value, "data-readonly": l2.value && "", "data-disabled": r2.value && "" }), { default: Wt$1.withCtx(() => [Wt$1.renderSlot(a3.$slots, "default")]), _: 3 }, 16, ["aria-readonly", "aria-disabled", "data-readonly", "data-disabled"]));
} }), Ma = Wt$1.defineComponent({ __name: "CalendarGridBody", props: { asChild: { type: Boolean }, as: { default: "tbody" } }, setup(a2) {
  const n2 = a2;
  return (a3, o2) => (Wt$1.openBlock(), Wt$1.createBlock(Wt$1.unref(_m), Wt$1.normalizeProps(Wt$1.guardReactiveProps(n2)), { default: Wt$1.withCtx(() => [Wt$1.renderSlot(a3.$slots, "default")]), _: 3 }, 16));
} }), _a = Wt$1.defineComponent({ __name: "CalendarGridHead", props: { asChild: { type: Boolean }, as: { default: "thead" } }, setup(a2) {
  const n2 = a2;
  return (a3, o2) => (Wt$1.openBlock(), Wt$1.createBlock(Wt$1.unref(_m), Wt$1.mergeProps(n2, { "aria-hidden": "true" }), { default: Wt$1.withCtx(() => [Wt$1.renderSlot(a3.$slots, "default")]), _: 3 }, 16));
  ...
  return (a3, l2) => (Wt$1.openBlock(), Wt$1.createBlock(Wt$1.unref(_m), { as: n2.as, "as-child": n2.asChild, "aria-label": "Next page", type: "button" === a3.as ? "button" : void 0, "aria-disabled": o2.value || void 0, "data-disabled": o2.value || void 0, disabled: o2.value, onClick: l2[0] || (l2[0] = (t2) => Wt$1.unref(r2).nextPage(n2.nextPage)) }, { default: Wt$1.withCtx(() => [Wt$1.renderSlot(a3.$slots, "default", { disabled: o2.value }, () => [l2[1] || (l2[1] = Wt$1.createTextVNode(" Next page "))])]), _: 3 }, 8, ["as", "as-child", "type", "aria-disabled", "data-disabled", "disabled"]));
  ...
  return (a3, l2) => (Wt$1.openBlock(), Wt$1.createBlock(Wt$1.unref(_m), { "aria-label": "Previous page", as: n2.as, "as-child": n2.asChild, type: "button" === a3.as ? "button" : void 0, "aria-disabled": o2.value || void 0, "data-disabled": o2.value || void 0, disabled: o2.value, onClick: l2[0] || (l2[0] = (t2) => Wt$1.unref(r2).prevPage(n2.prevPage)) }, { default: Wt$1.withCtx(() => [Wt$1.renderSlot(a3.$slots, "default", { disabled: o2.value }, () => [l2[1] || (l2[1] = Wt$1.createTextVNode(" Prev page "))])]), _: 3 }, 8, ["as", "as-child", "type", "aria-disabled", "data-disabled", "disabled"]));
...
const $a = l(function() {
...
} }), [Ka, Ya] = T("MenuContent"), Ga = Wt$1.defineComponent({ __name: "MenuContentImpl", props: Wt$1.mergeDefaults({ loop: { type: Boolean }, disableOutsidePointerEvents: { type: Boolean }, disableOutsideScroll: { type: Boolean }, trapFocus: { type: Boolean }, side: {}, sideOffset: {}, align: {}, alignOffset: {}, avoidCollisions: { type: Boolean }, collisionBoundary: {}, collisionPadding: {}, arrowPadding: {}, sticky: {}, hideWhenDetached: { type: Boolean }, positionStrategy: {}, updatePositionStrategy: {}, disableUpdateOnLayoutShift: { type: Boolean }, prioritizePosition: { type: Boolean }, reference: {}, asChild: { type: Boolean }, as: {} }, { ...Ye$1 }), emits: ["escapeKeyDown", "pointerDownOutside", "focusOutside", "interactOutside", "entryFocus", "openAutoFocus", "closeAutoFocus", "dismiss"], setup(t2, { emit: a2 }) {
  const n2 = t2, o2 = a2, r2 = Ua(), i2 = Wa(), { trapFocus: u2, disableOutsidePointerEvents: s2, loop: d2 } = Wt$1.toRefs(n2);
  t(), N$1(s2.value);
  const c2 = Wt$1.ref(""), f2 = Wt$1.ref(0), p2 = Wt$1.ref(0), h2 = Wt$1.ref(null), v2 = Wt$1.ref("right"), m2 = Wt$1.ref(0), y2 = Wt$1.ref(null), b2 = Wt$1.ref(), { forwardRef: w2, currentElement: C2 } = N(), { handleTypeaheadSearch: O2 } = r$1();
  function M2(e2) {
    var t3, a3;
    return v2.value === (null == (t3 = h2.value) ? void 0 : t3.side) && l$2(e2, null == (a3 = h2.value) ? void 0 : a3.area);
  }
  ...
  function I2(e2) {
    ...
    if ((null == (t3 = null == e2 ? void 0 : e2.currentTarget) ? void 0 : t3.contains(a3)) && n3) {
      ...
      v2.value = t4, m2.value = e2.clientX;
    }
  }
  return Wt$1.watch(C2, (e2) => {
    r2.onContentChange(e2);
  }), Ya({ onItemEnter: (e2) => !!M2(e2), onItemLeave: (e2) => {
    var t3;
  ...
  return (a3, n3) => (Wt$1.openBlock(), Wt$1.createBlock(Wt$1.unref(i2), { value: { textValue: a3.textValue } }, { default: Wt$1.withCtx(() => [Wt$1.createVNode(Wt$1.unref(_m), Wt$1.mergeProps({ ref: Wt$1.unref(r2), role: "menuitem", tabindex: "-1" }, a3.$attrs, { as: a3.as, "as-child": a3.asChild, "aria-disabled": a3.disabled || void 0, "data-disabled": a3.disabled ? "" : void 0, "data-highlighted": u2.value ? "" : void 0, onPointermove: s2, onPointerleave: d2, onFocus: n3[0] || (n3[0] = async (t2) => {
...
} }), [ja, Qa] = T(["MenuCheckboxItem", "MenuRadioItem"], "MenuItemIndicatorContext"), Za = Wt$1.defineComponent({ __name: "MenuItemIndicator", props: { forceMount: { type: Boolean }, asChild: { type: Boolean }, as: { default: "span" } }, setup(a2) {
  const n2 = ja({ modelValue: Wt$1.ref(false) });
  return (a3, o2) => (Wt$1.openBlock(), Wt$1.createBlock(Wt$1.unref(f), { present: a3.forceMount || Wt$1.unref(u)(Wt$1.unref(n2).modelValue.value) || true === Wt$1.unref(n2).modelValue.value }, { default: Wt$1.withCtx(() => [Wt$1.createVNode(Wt$1.unref(_m), { as: a3.as, "as-child": a3.asChild, "data-state": Wt$1.unref(a$1)(Wt$1.unref(n2).modelValue.value) }, { default: Wt$1.withCtx(() => [Wt$1.renderSlot(a3.$slots, "default")]), _: 3 }, 8, ["as", "as-child", "data-state"])]), _: 3 }, 8, ["present"]));
  ...
  return Qa({ modelValue: l2 }), (t3, a3) => (Wt$1.openBlock(), Wt$1.createBlock(za, Wt$1.mergeProps({ role: "menuitemcheckbox" }, n2, { "aria-checked": Wt$1.unref(u)(Wt$1.unref(l2)) ? "mixed" : Wt$1.unref(l2), "data-state": Wt$1.unref(a$1)(Wt$1.unref(l2)), onSelect: a3[0] || (a3[0] = async (t4) => {
  ...
  return (t3, a3) => (Wt$1.openBlock(), Wt$1.createBlock(Ga, Wt$1.mergeProps(Wt$1.unref(n2), { "trap-focus": false, "disable-outside-pointer-events": false, "disable-outside-scroll": false, onDismiss: a3[0] || (a3[0] = (t4) => Wt$1.unref(o2).onOpenChange(false)) }), { default: Wt$1.withCtx(() => [Wt$1.renderSlot(t3.$slots, "default")]), _: 3 }, 16));
  ...
  const n2 = a2;
  return (a3, o2) => (Wt$1.openBlock(), Wt$1.createBlock(Wt$1.unref(_m), Wt$1.mergeProps({ role: "group" }, n2), { default: Wt$1.withCtx(() => [Wt$1.renderSlot(a3.$slots, "default")]), _: 3 }, 16));
  ...
  const a2 = t2;
  return (t3, n2) => (Wt$1.openBlock(), Wt$1.createBlock(Wt$1.unref(h), Wt$1.normalizeProps(Wt$1.guardReactiveProps(a2)), { default: Wt$1.withCtx(() => [Wt$1.renderSlot(t3.$slots, "default")]), _: 3 }, 16));
  ...
  return Qa({ modelValue: i2 }), (t3, a3) => (Wt$1.openBlock(), Wt$1.createBlock(za, Wt$1.mergeProps({ role: "menuitemradio" }, n2, { "aria-checked": i2.value, "data-state": Wt$1.unref(a$1)(i2.value), onSelect: a3[0] || (a3[0] = async (t4) => {
  ...
  const n2 = a2;
  return (a3, o2) => (Wt$1.openBlock(), Wt$1.createBlock(Wt$1.unref(_m), Wt$1.mergeProps(n2, { role: "separator", "aria-orientation": "horizontal" }), { default: Wt$1.withCtx(() => [Wt$1.renderSlot(a3.$slots, "default")]), _: 3 }, 16));
...
} }), vn = Wt$1.defineComponent({ __name: "MenuAnchor", props: { reference: {}, asChild: { type: Boolean }, as: {} }, setup(t2) {
  const a2 = t2;
  ...
  return r2.triggerId || (r2.triggerId = c(void 0, "reka-menu-sub-trigger")), (t3, o3) => (Wt$1.openBlock(), Wt$1.createBlock(vn, { "as-child": "" }, { default: Wt$1.withCtx(() => [Wt$1.createVNode(Ha, Wt$1.mergeProps(a2, { id: Wt$1.unref(r2).triggerId, ref: (t4) => {
    var a3;
  ...
  N();
  const o2 = yn();
  return (a3, r2) => (Wt$1.openBlock(), Wt$1.createBlock(Wt$1.unref(_m), { type: "button" === a3.as ? "button" : void 0, as: a3.as, "as-child": n2.asChild, onClick: r2[0] || (r2[0] = (t2) => Wt$1.unref(o2).onOpenChange(false)) }, { default: Wt$1.withCtx(() => [Wt$1.renderSlot(a3.$slots, "default")]), _: 3 }, 8, ["type", "as", "as-child"]));
  ...
  const o2 = n2, r2 = Tm(a(t2, "trapFocus", "disableOutsidePointerEvents")), { forwardRef: i2 } = N(), s2 = yn();
...
const _n = { style: { border: "0px", clip: "rect(0px, 0px, 0px, 0px)", "clip-path": "inset(50%)", height: "1px", margin: "-1px", overflow: "hidden", padding: "0px", position: "absolute", "white-space": "nowrap", width: "1px" } }, Vn = { role: "heading", "aria-level": "2" }, [Rn, In] = T("RangeCalendarRoot"), En = Wt$1.defineComponent({ __name: "RangeCalendarRoot", props: { defaultPlaceholder: {}, defaultValue: { default: () => ({ start: void 0, end: void 0 }) }, modelValue: {}, placeholder: { default: void 0 }, allowNonContiguousRanges: { type: Boolean, default: false }, pagedNavigation: { type: Boolean, default: false }, preventDeselect: { type: Boolean, default: false }, maximumDays: { default: void 0 }, weekStartsOn: { default: 0 }, weekdayFormat: { default: "narrow" }, calendarLabel: {}, fixedWeeks: { type: Boolean, default: false }, maxValue: {}, minValue: {}, locale: {}, numberOfMonths: { default: 1 }, disabled: { type: Boolean, default: false }, readonly: { type: Boolean, default: false }, initialFocus: { type: Boolean, default: false }, isDateDisabled: { type: Function, default: void 0 }, isDateUnavailable: { type: Function, default: void 0 }, isDateHighlightable: { type: Function, default: void 0 }, dir: {}, nextPage: {}, prevPage: {}, disableDaysOutsideCurrentView: { type: Boolean, default: false }, fixedDate: {}, asChild: { type: Boolean }, as: { default: "div" } }, emits: ["update:modelValue", "update:placeholder", "update:startValue"], setup(a2, { emit: n2 }) {
  var _a2, _b;
  const r2 = a2, l2 = n2, { disabled: i2, readonly: u2, initialFocus: d2, pagedNavigation: c2, weekStartsOn: h2, weekdayFormat: m2, fixedWeeks: y2, numberOfMonths: g2, preventDeselect: b2, isDateUnavailable: w2, isDateHighlightable: C2, isDateDisabled: B2, calendarLabel: D2, maxValue: k2, minValue: P2, dir: x2, locale: S2, nextPage: O2, prevPage: M2, allowNonContiguousRanges: _2, disableDaysOutsideCurrentView: V2, fixedDate: R2, maximumDays: I2 } = Wt$1.toRefs(r2), { primitiveElement: E2, currentElement: A2 } = o(), F2 = n(x2), T2 = ba(S2), $2 = Wt$1.ref(), U2 = Wt$1.ref(), N2 = Wt$1.ref(false), W2 = C(r2, "modelValue", l2, { defaultValue: (_a2 = r2.defaultValue) != null ? _a2 : { start: void 0, end: void 0 }, passive: void 0 === r2.modelValue }), L2 = Wt$1.computed(() => n$1(W2.value) ? { start: void 0, end: void 0 } : W2.value), J2 = ua({ defaultPlaceholder: r2.placeholder, defaultValue: L2.value.start, locale: r2.locale }), K2 = Wt$1.ref(L2.value.start), Y2 = Wt$1.ref(L2.value.end), G2 = C(r2, "placeholder", l2, { defaultValue: (_b = r2.defaultPlaceholder) != null ? _b : J2.copy(), passive: void 0 === r2.placeholder });
  function z2(e2) {
    G2.value = e2.copy();
  }
  const { fullCalendarLabel: j2, headingValue: Q2, isDateDisabled: Z2, isDateUnavailable: q2, isNextButtonDisabled: X2, isPrevButtonDisabled: ee2, grid: te2, weekdays: ae2, isOutsideVisibleView: ne2, nextPage: oe2, prevPage: le2, formatter: ie2 } = ga({ locale: T2, placeholder: G2, weekStartsOn: h2, fixedWeeks: y2, numberOfMonths: g2, minValue: P2, maxValue: k2, disabled: i2, weekdayFormat: m2, pagedNavigation: c2, isDateDisabled: B2.value, isDateUnavailable: w2.value, calendarLabel: D2, nextPage: O2, prevPage: M2 }), { isInvalid: ue2, isSelected: se2, isDateHighlightable: de2, highlightedRange: ce2, isSelectionStart: fe2, isSelectionEnd: pe2, isHighlightedStart: he2, isHighlightedEnd: ve2, isDateDisabled: me2 } = Mn({ start: K2, end: Y2, isDateDisabled: Z2, isDateUnavailable: q2, isDateHighlightable: C2.value, focusedValue: U2, allowNonContiguousRanges: _2, fixedDate: R2, maximumDays: I2 });
  Wt$1.watch(W2, (e2, t2) => {
    var a3, n3, o2, r3;
    (!(null == t2 ? void 0 : t2.start) && (null == e2 ? void 0 : e2.start) || !e2 || !e2.start || K2.value && !re(e2.start, K2.value)) && (K2.value = null == (n3 = null == (a3 = null == e2 ? void 0 : e2.start) ? void 0 : a3.copy) ? void 0 : n3.call(a3)), (!(null == t2 ? void 0 : t2.end) && e2.end || !e2 || !e2.end || Y2.value && !re(e2.end, Y2.value)) && (Y2.value = null == (r3 = null == (o2 = null == e2 ? void 0 : e2.end) ? void 0 : o2.copy) ? void 0 : r3.call(o2));
  }), Wt$1.watch(K2, (e2) => {
    e2 && !re(e2, G2.value) && z2(e2), l2("update:startValue", e2);
  }), Wt$1.watch([K2, Y2], ([e2, t2]) => {
    const a3 = L2.value;
  ...
  return j$1("keydown", (e2) => {
    var t2, a3;
    e2.key === ye2.ESCAPE && N2.value && (K2.value = null == (t2 = W2.value.start) ? void 0 : t2.copy(), Y2.value = null == (a3 = W2.value.end) ? void 0 : a3.copy());
  }), In({ isDateUnavailable: q2, isDateHighlightable: de2, startValue: K2, endValue: Y2, formatter: ie2, modelValue: W2, placeholder: G2, disabled: i2, initialFocus: d2, pagedNavigation: c2, grid: te2, weekDays: ae2, weekStartsOn: h2, weekdayFormat: m2, fixedWeeks: y2, numberOfMonths: g2, readonly: u2, preventDeselect: b2, fullCalendarLabel: j2, headingValue: Q2, isInvalid: ue2, isDateDisabled: me2, allowNonContiguousRanges: _2, highlightedRange: ce2, focusedValue: U2, lastPressedDateValue: $2, isSelected: se2, isSelectionEnd: pe2, isSelectionStart: fe2, isNextButtonDisabled: X2, isPrevButtonDisabled: ee2, isOutsideVisibleView: ne2, nextPage: oe2, prevPage: le2, parentElement: A2, onPlaceholderChange: z2, locale: T2, dir: F2, isHighlightedStart: he2, isHighlightedEnd: ve2, disableDaysOutsideCurrentView: V2, fixedDate: R2, maximumDays: I2 }), (a3, n3) => (Wt$1.openBlock(), Wt$1.createBlock(Wt$1.unref(_m), { ref_key: "primitiveElement", ref: E2, as: a3.as, "as-child": a3.asChild, role: "application", "aria-label": Wt$1.unref(j2), "data-readonly": Wt$1.unref(u2) ? "" : void 0, "data-disabled": Wt$1.unref(i2) ? "" : void 0, "data-invalid": Wt$1.unref(ue2) ? "" : void 0, dir: Wt$1.unref(F2) }, { default: Wt$1.withCtx(() => [Wt$1.createElementVNode("div", _n, [Wt$1.createElementVNode("div", Vn, Wt$1.toDisplayString(Wt$1.unref(j2)), 1)]), Wt$1.renderSlot(a3.$slots, "default", { date: Wt$1.unref(G2), grid: Wt$1.unref(te2), weekDays: Wt$1.unref(ae2), weekStartsOn: Wt$1.unref(h2), locale: Wt$1.unref(T2), fixedWeeks: Wt$1.unref(y2), modelValue: Wt$1.unref(W2) })]), _: 3 }, 8, ["as", "as-child", "aria-label", "data-readonly", "data-disabled", "data-invalid", "dir"]));
} }), An = Wt$1.defineComponent({ __name: "RangeCalendarCell", props: { date: {}, asChild: { type: Boolean }, as: { default: "td" } }, setup(a2) {
  const n2 = Rn();
  return (a3, o2) => {
    var r2, l2;
    return Wt$1.openBlock(), Wt$1.createBlock(Wt$1.unref(_m), { as: a3.as, "as-child": a3.asChild, role: "gridcell", "aria-selected": !!Wt$1.unref(n2).isSelected(a3.date) || void 0, "aria-disabled": Wt$1.unref(n2).isDateDisabled(a3.date) || (null == (l2 = (r2 = Wt$1.unref(n2)).isDateUnavailable) ? void 0 : l2.call(r2, a3.date)) || Wt$1.unref(n2).disableDaysOutsideCurrentView.value, "data-disabled": Wt$1.unref(n2).isDateDisabled(a3.date) || Wt$1.unref(n2).disableDaysOutsideCurrentView.value ? "" : void 0 }, { default: Wt$1.withCtx(() => [Wt$1.renderSlot(a3.$slots, "default")]), _: 3 }, 8, ["as", "as-child", "aria-selected", "aria-disabled", "data-disabled"]);
  };
  ...
  const n2 = a2, o2 = Rn(), r2 = F$1(), { primitiveElement: l2, currentElement: i2 } = o(), u2 = Wt$1.computed(() => o2.formatter.custom(sa(n2.day), { weekday: "long", month: "long", day: "numeric", year: "numeric" })), s2 = Wt$1.computed(() => {
  ...
  }), d2 = Wt$1.computed(() => o2.isSelected(n2.day)), c2 = Wt$1.computed(() => o2.isSelectionStart(n2.day)), p2 = Wt$1.computed(() => o2.isSelectionEnd(n2.day)), h2 = Wt$1.computed(() => o2.isHighlightedStart(n2.day)), m2 = Wt$1.computed(() => o2.isHighlightedEnd(n2.day)), y2 = Wt$1.computed(() => {
    ...
    var e2, t2, a3, r3;
  }), g2 = Wt$1.computed(() => o2.allowNonContiguousRanges.value), b2 = Wt$1.computed(() => ue(n2.day, he())), w2 = Wt$1.computed(() => !oe(n2.day, n2.month)), C2 = Wt$1.computed(() => o2.isOutsideVisibleView(n2.day)), B2 = Wt$1.computed(() => o2.isDateDisabled(n2.day) || o2.disableDaysOutsideCurrentView.value && w2.value), D2 = Wt$1.computed(() => n2.day.day.toLocaleString(o2.locale.value)), k2 = Wt$1.computed(() => !o2.disabled.value && ne(n2.day, o2.placeholder.value));
  function P2(e2, t2) {
    var a3;
  ...
  return (a3, o3) => (Wt$1.openBlock(), Wt$1.createBlock(Wt$1.unref(_m), Wt$1.mergeProps({ ref_key: "primitiveElement", ref: l2 }, n2, { role: "button", "aria-label": u2.value, "data-reka-calendar-cell-trigger": "", "aria-selected": !(!d2.value || !g2.value && s2.value) || void 0, "aria-disabled": !(!B2.value && !s2.value) || void 0, "data-highlighted": !y2.value || !g2.value && s2.value ? void 0 : "", "data-selection-start": !!c2.value || void 0, "data-selection-end": !!p2.value || void 0, "data-highlighted-start": !!h2.value || void 0, "data-highlighted-end": !!m2.value || void 0, "data-selected": !(!d2.value || !g2.value && s2.value) || void 0, "data-outside-visible-view": C2.value ? "" : void 0, "data-value": a3.day.toString(), "data-disabled": B2.value ? "" : void 0, "data-unavailable": s2.value ? "" : void 0, "data-today": b2.value ? "" : void 0, "data-outside-view": w2.value ? "" : void 0, "data-focused": k2.value ? "" : void 0, tabindex: k2.value ? 0 : w2.value || B2.value ? void 0 : -1, onClick: x2, onFocusin: S2, onMouseenter: S2, onKeydown: Wt$1.withKeys(O2, ["up", "down", "left", "right", "enter", "space"]) }), { default: Wt$1.withCtx(() => [Wt$1.renderSlot(a3.$slots, "default", { dayValue: D2.value, disabled: B2.value, today: b2.value, selected: d2.value, outsideView: w2.value, outsideVisibleView: C2.value, unavailable: s2.value, highlighted: y2.value && (g2.value || !s2.value), highlightedStart: h2.value, highlightedEnd: m2.value, selectionStart: c2.value, selectionEnd: p2.value }, () => [Wt$1.createTextVNode(Wt$1.toDisplayString(D2.value), 1)])]), _: 3 }, 16, ["aria-label", "aria-selected", "aria-disabled", "data-highlighted", "data-selection-start", "data-selection-end", "data-highlighted-start", "data-highlighted-end", "data-selected", "data-outside-visible-view", "data-value", "data-disabled", "data-unavailable", "data-today", "data-outside-view", "data-focused", "tabindex"]));
  ...
  return (a3, l2) => (Wt$1.openBlock(), Wt$1.createBlock(Wt$1.unref(_m), Wt$1.mergeProps(n2, { "aria-label": "Next page", type: "button" === a3.as ? "button" : void 0, "aria-disabled": o2.value || void 0, "data-disabled": o2.value || void 0, disabled: o2.value, onClick: l2[0] || (l2[0] = (t2) => Wt$1.unref(r2).nextPage(n2.nextPage)) }), { default: Wt$1.withCtx(() => [Wt$1.renderSlot(a3.$slots, "default", { disabled: o2.value }, () => [l2[1] || (l2[1] = Wt$1.createTextVNode(" Next page "))])]), _: 3 }, 16, ["type", "aria-disabled", "data-disabled", "disabled"]));
} }), Yn = Wt$1.defineComponent({ __name: "RangeCalendarPrev", props: { prevPage: {}, asChild: { type: Boolean }, as: { default: "button" } }, setup(a2) {
  const n2 = a2, o2 = Wt$1.computed(() => r2.disabled.value || r2.isPrevButtonDisabled(n2.prevPage)), r2 = Rn();
  return (a3, l2) => (Wt$1.openBlock(), Wt$1.createBlock(Wt$1.unref(_m), Wt$1.mergeProps(n2, { "aria-label": "Previous page", type: "button" === a3.as ? "button" : void 0, "aria-disabled": o2.value || void 0, "data-disabled": o2.value || void 0, disabled: o2.value, onClick: l2[0] || (l2[0] = (t2) => Wt$1.unref(r2).prevPage(n2.prevPage)) }), { default: Wt$1.withCtx(() => [Wt$1.renderSlot(a3.$slots, "default", { disabled: o2.value }, () => [l2[1] || (l2[1] = Wt$1.createTextVNode(" Prev page "))])]), _: 3 }, 16, ["type", "aria-disabled", "data-disabled", "disabled"]));
} }), Gn = Wt$1.defineComponent({ __name: "DropdownMenuArrow", props: { width: { default: 10 }, height: { default: 5 }, rounded: { type: Boolean }, asChild: { type: Boolean }, as: { default: "svg" } }, setup(t2) {
  const a2 = t2;
...
} }), [zn, jn] = T("DropdownMenuRoot"), Qn = Wt$1.defineComponent({ __name: "DropdownMenuRoot", props: { defaultOpen: { type: Boolean }, open: { type: Boolean, default: void 0 }, dir: {}, modal: { type: Boolean, default: true } }, emits: ["update:open"], setup(t2, { emit: a2 }) {
  const n2 = t2, r2 = a2;
  N();
  ...
  return jn({ open: i2, onOpenChange: (e2) => {
    i2.value = e2;
  }, onOpenToggle: () => {
    i2.value = !i2.value;
...
} }), Zn = Wt$1.defineComponent({ __name: "DropdownMenuContent", props: { forceMount: { type: Boolean }, loop: { type: Boolean }, side: {}, sideOffset: {}, align: {}, alignOffset: {}, avoidCollisions: { type: Boolean }, collisionBoundary: {}, collisionPadding: {}, arrowPadding: {}, sticky: {}, hideWhenDetached: { type: Boolean }, positionStrategy: {}, updatePositionStrategy: {}, disableUpdateOnLayoutShift: { type: Boolean }, prioritizePosition: { type: Boolean }, reference: {}, asChild: { type: Boolean }, as: {} }, emits: ["escapeKeyDown", "pointerDownOutside", "focusOutside", "interactOutside", "closeAutoFocus"], setup(t2, { emit: a2 }) {
  const n2 = F(t2, a2);
  N();
  ...
  const a2 = t2;
  return N(), (t3, n2) => (Wt$1.openBlock(), Wt$1.createBlock(Wt$1.unref(Za), Wt$1.normalizeProps(Wt$1.guardReactiveProps(a2)), { default: Wt$1.withCtx(() => [Wt$1.renderSlot(t3.$slots, "default")]), _: 3 }, 16));
  ...
  const n2 = F(t2, a2);
  return N(), (t3, a3) => (Wt$1.openBlock(), Wt$1.createBlock(Wt$1.unref(hn), Wt$1.mergeProps(Wt$1.unref(n2), { style: { "--reka-dropdown-menu-content-transform-origin": "var(--reka-popper-transform-origin)", "--reka-dropdown-menu-content-available-width": "var(--reka-popper-available-width)", "--reka-dropdown-menu-content-available-height": "var(--reka-popper-available-height)", "--reka-dropdown-menu-trigger-width": "var(--reka-popper-anchor-width)", "--reka-dropdown-menu-trigger-height": "var(--reka-popper-anchor-height)" } }), { default: Wt$1.withCtx(() => [Wt$1.renderSlot(t3.$slots, "default")]), _: 3 }, 16));
...
const [po, ho] = T("HoverCardRoot"), vo = Wt$1.defineComponent({ __name: "HoverCardRoot", props: { defaultOpen: { type: Boolean, default: false }, open: { type: Boolean, default: void 0 }, openDelay: { default: 700 }, closeDelay: { default: 300 } }, emits: ["update:open"], setup(t2, { emit: a2 }) {
  const n2 = t2, r2 = a2, { openDelay: i2, closeDelay: u2 } = Wt$1.toRefs(n2);
  N();
  const s2 = C(n2, "open", r2, { defaultValue: n2.defaultOpen, passive: void 0 === n2.open }), d2 = Wt$1.ref(0), c2 = Wt$1.ref(0), f2 = Wt$1.ref(false), p2 = Wt$1.ref(false), h2 = Wt$1.ref(false), v2 = Wt$1.ref();
  return ho({ open: s2, onOpenChange(e2) {
    s2.value = e2;
  }, onOpen: function() {
    ...
    s2.value = false;
  }, hasSelectionRef: f2, isPointerDownOnContentRef: p2, isPointerInTransitRef: h2, triggerElement: v2 }), (t3, a3) => (Wt$1.openBlock(), Wt$1.createBlock(Wt$1.unref($e$1), null, { default: Wt$1.withCtx(() => [Wt$1.renderSlot(t3.$slots, "default", { open: Wt$1.unref(s2) })]), _: 3 }));
  ...
  const o2 = n2, r2 = Tm(t2), { forwardRef: i2, currentElement: u2 } = N(), s2 = po(), { isPointerInTransit: d2, onPointerExit: f2 } = r(s2.triggerElement, u2);
  ...
  const a2 = t2;
  return (t3, n2) => (Wt$1.openBlock(), Wt$1.createBlock(Wt$1.unref(h), Wt$1.normalizeProps(Wt$1.guardReactiveProps(a2)), { default: Wt$1.withCtx(() => [Wt$1.renderSlot(t3.$slots, "default")]), _: 3 }, 16));
} }), bo = { Root: ka, Header: Ia, Heading: Ea, Grid: Oa, Cell: Pa, HeadCell: Ra, Next: Aa, Prev: Fa, GridHead: _a, GridBody: Ma, GridRow: Va, CellTrigger: Sa }, wo = { Root: Qn, Trigger: so, Portal: ao, Content: Zn, Arrow: Gn, Item: Xn, Group: qn, Separator: ro, CheckboxItem: Hn, ItemIndicator: eo, Label: to, RadioGroup: no, RadioItem: oo, Sub: lo, SubContent: io, SubTrigger: uo }, Co = { Root: vo, Trigger: Wt$1.defineComponent({ __name: "HoverCardTrigger", props: { reference: {}, asChild: { type: Boolean }, as: { default: "a" } }, setup(a2) {
  ...
  return r2.triggerElement = o2, (a3, o3) => (Wt$1.openBlock(), Wt$1.createBlock(Wt$1.unref(He$1), { "as-child": "", reference: a3.reference }, { default: Wt$1.withCtx(() => [Wt$1.createVNode(Wt$1.unref(_m), { ref: Wt$1.unref(n2), "as-child": a3.asChild, as: a3.as, "data-state": Wt$1.unref(r2).open.value ? "open" : "closed", "data-grace-area-trigger": "", onPointerenter: o3[0] || (o3[0] = (t2) => Wt$1.unref(fo)(Wt$1.unref(r2).onOpen)(t2)), onPointerleave: o3[1] || (o3[1] = (t2) => Wt$1.unref(fo)(i2)(t2)), onFocus: o3[2] || (o3[2] = (t2) => Wt$1.unref(r2).onOpen()), onBlur: o3[3] || (o3[3] = (t2) => Wt$1.unref(r2).onClose()) }, { default: Wt$1.withCtx(() => [Wt$1.renderSlot(a3.$slots, "default")]), _: 3 }, 8, ["as-child", "as", "data-state"])]), _: 3 }, 8, ["reference"]));
} }), Portal: go, Content: yo, Arrow: co }, Bo = { Root: bn, Trigger: On, Portal: Dn, Content: Sn, Arrow: Cn, Close: Bn, Anchor: wn }, Do = { Root: En, Header: Ln, Heading: Jn, Grid: Tn, Cell: An, HeadCell: Wn, Next: Kn, Prev: Yn, GridHead: Un, GridBody: $n, GridRow: Nn, CellTrigger: Fn };

export { Bo as B, Co as C, Do as D, Gn as G, Oe as O, Qn as Q, bo as b, de as d, he as h, so as s, wo as w };
//# sourceMappingURL=index-BJFOiOgd.mjs.map
