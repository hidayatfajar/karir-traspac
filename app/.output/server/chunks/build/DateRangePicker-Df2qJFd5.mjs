...
import { h as he, O as Oe, d as de } from './index-BJFOiOgd.mjs';
import '../_/nitro.mjs';
import 'crypto-es';
import 'node:http';
import 'node:https';
...
const d = Wt.defineComponent({ __name: "DateRangePicker", __ssrInlineRender: true, props: { modelValue: {}, placeholder: {}, label: {} }, emits: ["update:modelValue"], setup(d2, { emit: i2 }) {
  const m = [{ label: "Last 7 days", days: 7 }, { label: "Last 14 days", days: 14 }, { label: "Last 30 days", days: 30 }, { label: "Last 3 months", months: 3 }, { label: "Last 6 months", months: 6 }, { label: "Last year", years: 1 }], u = Wt.ref(false), p = d2, c$1 = i2, x = (e2) => {
    ...
    c$1("update:modelValue", { start: e2.start ? x(e2.start.toDate(he())) : null, end: e2.end ? x(e2.end.toDate(he())) : null });
  } }), y = (e2) => {
    if (!e2) return "";
    ...
    const t2 = de(he());
    let a2 = t2.copy();
    e2.days ? a2 = a2.subtract({ days: e2.days }) : e2.months ? a2 = a2.subtract({ months: e2.months }) : e2.years && (a2 = a2.subtract({ years: e2.years })), c$1("update:modelValue", { start: x(a2.toDate(he())), end: x(t2.toDate(he())) });
  }, b = (e2) => {
    ...
    const o2 = p.modelValue.start ? x(new Date(p.modelValue.start)) : null, l2 = p.modelValue.end ? x(new Date(p.modelValue.end)) : null, s2 = x(a2.toDate(he())), d3 = x(t2.toDate(he()));
    return o2 === s2 && l2 === d3;
  }, v = () => {
    c$1("update:modelValue", { start: null, end: null }), u.value = false;
  };
  return (r2, s2, n2, d3) => {
    const i3 = i$1, c2 = Rb, x2 = c;
    s2(pm.ssrRenderComponent(i3, Wt.mergeProps({ open: Wt.unref(u), "onUpdate:open": (e2) => Wt.isRef(u) ? u.value = e2 : null }, d3), { content: Wt.withCtx((e2, o2, l2, r3) => {
      if (!o2) return [Wt.createVNode("div", { class: "sm:divide-y divide-default" }, [Wt.createVNode("div", { class: "flex items-stretch sm:divide-x divide-default" }, [Wt.createVNode("div", { class: "hidden sm:flex flex-col justify-center" }, [(Wt.openBlock(), Wt.createBlock(Wt.Fragment, null, Wt.renderList(m, (e3, a2) => Wt.createVNode(c2, { key: a2, label: e3.label, color: "neutral", variant: "ghost", class: ["rounded-none px-4", [b(e3) ? "bg-accented" : "hover:bg-accented/50"]], truncate: "", onClick: (t2) => h(e3) }, null, 8, ["label", "class", "onClick"])), 64))]), Wt.createVNode(x2, { modelValue: Wt.unref(f), "onUpdate:modelValue": (e3) => Wt.isRef(f) ? f.value = e3 : null, class: "p-2", "number-of-months": 2, range: "" }, null, 8, ["modelValue", "onUpdate:modelValue"])]), Wt.createVNode("div", { class: "flex items-center justify-center p-2 gap-4" }, [Wt.createVNode(c2, { color: "neutral", variant: "subtle", class: "px-4", label: "Reset", onClick: v }), Wt.createVNode(c2, { onClick: (e3) => u.value = false, label: "Simpan" }, null, 8, ["onClick"])])])];
      o2(`<div class="sm:divide-y divide-default"${r3}><div class="flex items-stretch sm:divide-x divide-default"${r3}><div class="hidden sm:flex flex-col justify-center"${r3}><!--[-->`), pm.ssrRenderList(m, (e3, t2) => {
        o2(pm.ssrRenderComponent(c2, { key: t2, label: e3.label, color: "neutral", variant: "ghost", class: ["rounded-none px-4", [b(e3) ? "bg-accented" : "hover:bg-accented/50"]], truncate: "", onClick: (t3) => h(e3) }, null, l2, r3));
      }), o2("<!--]--></div>"), o2(pm.ssrRenderComponent(x2, { modelValue: Wt.unref(f), "onUpdate:modelValue": (e3) => Wt.isRef(f) ? f.value = e3 : null, class: "p-2", "number-of-months": 2, range: "" }, null, l2, r3)), o2(`</div><div class="flex items-center justify-center p-2 gap-4"${r3}>`), o2(pm.ssrRenderComponent(c2, { color: "neutral", variant: "subtle", class: "px-4", label: "Reset", onClick: v }, null, l2, r3)), o2(pm.ssrRenderComponent(c2, { onClick: (e3) => u.value = false, label: "Simpan" }, null, l2, r3)), o2("</div></div>");
      ...
      o2(pm.ssrRenderComponent(c2, { color: "neutral", variant: "subtle", icon: "i-lucide-calendar", class: "!bg-default" }, { default: Wt.withCtx((e3, o3, l3, s4) => {
        ...
        o3(`<span class="${pm.ssrRenderClass([!p.placeholder && !p.label || p.modelValue.end && p.modelValue.start ? "text-toned" : "text-dimmed", "truncate"])}"${s4}>`), r2.modelValue.start || r2.modelValue.end ? (o3(`<!--[-->${pm.ssrInterpolate(y(r2.modelValue.start))} `), r2.modelValue.end ? o3(`<!--[--> - ${pm.ssrInterpolate(y(r2.modelValue.end))}<!--]-->`) : o3("<!---->"), o3("<!--]-->")) : o3(`<!--[-->${pm.ssrInterpolate(p.placeholder || p.label || "Pilih Tanggal")}<!--]-->`), o3("</span>");
      }), _: 1 }, l2, s3));
    }), _: 1 }, n2));
  };
} }), i = d.setup;
...
export { d as default };
//# sourceMappingURL=DateRangePicker-Df2qJFd5.mjs.map
