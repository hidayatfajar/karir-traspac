...
import { v as Wt, s as pm, b as gb, _ as Ob, h as la } from './server.mjs';
...
const n = Wt.defineComponent({ __name: "register", __ssrInlineRender: true, setup(n2) {
  ...
  return (n3, c, x, f) => {
    const v = u, h = ee, w = gb, g = Ob, R = la;
    c(`<div${pm.ssrRenderAttrs(Wt.mergeProps({ class: "min-h-screen w-full relative bg-gray-50 flex items-center justify-center p-4" }, f))}><div class="absolute inset-0 z-0 cool-blue-glow"></div><div class="relative w-full max-w-5xl bg-white rounded-2xl h-fit shadow-xl grid grid-cols-1 lg:grid-cols-2 ring-[5px] ring-white/50 backdrop-blur-lg overflow-hidden"><div class="flex flex-col justify-center p-8 sm:p-12"><div class="mb-6 text-center lg:text-left"><h1 class="text-slate-800 text-3xl font-bold leading-tight"> Buat Akun Baru </h1><p class="text-neutral-500 text-base font-medium mt-2"> Silakan isi data diri Anda untuk mendaftar. </p></div><div class="w-full flex flex-col gap-4"><div class="w-full h-10">`), p.value.show ? c(pm.ssrRenderComponent(v, { title: p.value.message, class: ["px-4 py-2 font-medium text-xs leading-4 h-auto text-center transition-all duration-500 ease-out", [p.value.error ? "bg-red-50 text-red-600" : "bg-green-50 text-green-600"]] }, null, x)) : c("<!---->"), c("</div>"), c(pm.ssrRenderComponent(h, { class: "w-full", label: "Nama Lengkap", variant: "soft", placeholder: "Masukkan Nama Lengkap", size: "xl", modelValue: d2.value.fullName, "onUpdate:modelValue": (e2) => d2.value.fullName = e2 }, { leading: Wt.withCtx((e2, s2, r2, o2) => {
      if (!s2) return [Wt.createVNode(w, { name: "i-mdi-account", class: "text-PRIMARY size-5" })];
      s2(pm.ssrRenderComponent(w, { name: "i-mdi-account", class: "text-PRIMARY size-5" }, null, r2, o2));
    }), _: 1 }, x)), c(pm.ssrRenderComponent(h, { class: "w-full", label: "Email", variant: "soft", placeholder: "Masukkan Email", size: "xl", modelValue: d2.value.email, "onUpdate:modelValue": (e2) => d2.value.email = e2 }, { leading: Wt.withCtx((e2, s2, r2, o2) => {
      if (!s2) return [Wt.createVNode(w, { name: "i-mdi-email", class: "text-PRIMARY size-5" })];
      s2(pm.ssrRenderComponent(w, { name: "i-mdi-email", class: "text-PRIMARY size-5" }, null, r2, o2));
    }), _: 1 }, x)), c(pm.ssrRenderComponent(h, { label: "Password", class: "w-full", variant: "soft", type: "password", size: "xl", placeholder: "Masukkan Password", modelValue: d2.value.password, "onUpdate:modelValue": (e2) => d2.value.password = e2 }, { leading: Wt.withCtx((e2, s2, r2, o2) => {
      if (!s2) return [Wt.createVNode(w, { name: "i-mdi-password", class: "text-PRIMARY size-5" })];
      s2(pm.ssrRenderComponent(w, { name: "i-mdi-password", class: "text-PRIMARY size-5" }, null, r2, o2));
    }), _: 1 }, x)), c(pm.ssrRenderComponent(h, { label: "Konfirmasi Password", class: "w-full", variant: "soft", type: "password", size: "xl", placeholder: "Ulangi Password Anda", modelValue: d2.value.password_confirmation, "onUpdate:modelValue": (e2) => d2.value.password_confirmation = e2, onKeyup: u$1 }, { leading: Wt.withCtx((e2, s2, r2, o2) => {
      if (!s2) return [Wt.createVNode(w, { name: "i-mdi-check-decagram", class: "text-PRIMARY size-5" })];
      s2(pm.ssrRenderComponent(w, { name: "i-mdi-check-decagram", class: "text-PRIMARY size-5" }, null, r2, o2));
    }), _: 1 }, x)), c('</div><div class="w-full space-y-3 mt-6">'), c(pm.ssrRenderComponent(g, { class: "rounded-xl font-semibold text-base", color: "primary", variant: "solid", size: "xl", block: "", loading: m.value.simpan, disabled: m.value.simpan, onClick: (e2) => u$1() }, { default: Wt.withCtx((e2, s2, a2, r2) => {
...
export { n as default };
//# sourceMappingURL=register-B_zgBQsi.mjs.map
