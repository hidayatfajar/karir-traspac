      ...
      <div class="mb-6 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <UCard>
          <div class="flex items-center justify-between">
            ...
            <div
              class="rounded-lg bg-blue-100 p-3 text-blue-600 dark:bg-blue-900/50 dark:text-blue-400"
            >
        ...
        <UCard>
          <div class="flex items-center justify-between">
            ...
            <div
              class="rounded-lg bg-green-100 p-3 text-green-600 dark:bg-green-900/50 dark:text-green-400"
            >
        ...
        <UCard>
          <div class="flex items-center justify-between">
            ...
            <div
              class="rounded-lg bg-yellow-100 p-3 text-yellow-600 dark:bg-yellow-900/50 dark:text-yellow-400"
            >
        ...
        <UCard>
          <div class="flex items-center justify-between">
            ...
            <div
              class="rounded-lg bg-purple-100 p-3 text-purple-600 dark:bg-purple-900/50 dark:text-purple-400"
            >
                ...
                <div class="p-4">
                  <div class="space-y-4">
                    <div>
                      ...
                      >
                      <USelect
                        :options="['All Positions', 'Frontend Developer']"
                      />
                    </div>
                    <div>
                      <label
          ...
          <UCard>
              ...
              <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2">
                  <UButton
                    ...
                    :variant="activeView === 'card' ? 'solid' : 'outline'"
            ...
            >
              ...
              <div
                ...
                :key="stage.name"
                class="min-h-[400px] rounded-lg bg-gray-50 p-3 dark:bg-gray-800/50"
              >
                ...
                <div class="space-y-3">
                  <UCard
                    ...
                    :ui="{
                      body: { padding: 'p-3' },
                      ring: `ring-1 ring-inset ring-${stage.color}-400`,
                    }"
                  >
                    ...
                    <div class="mt-2 flex items-center justify-between">
                      <UBadge :color="candidate.statusColor" variant="soft">{{
                        candidate.status
                      }}</UBadge>
                      <UButton
            ...
            <div v-if="activeView === 'table'">
              <UTable :rows="tableCandidates" :columns="tableColumns">
                ...
                <template #stage-data="{ row }">
                  <UBadge :color="row.stageColor" variant="soft">{{
                    row.stage
                  }}</UBadge>
                </template>
            ...
            <div class="space-y-3">
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p class="text-xs text-gray-500 dark:text-gray-400">
                    Engineering • 5 applicants
                  </p>
                </div>
                <UBadge color="green" variant="subtle">Active</UBadge>
              </div>
              <UButton
                @click="isCreatePositionModalVisible = true"
